---
id: foilboard-ultra-fasteners
family_id: FOILBOARD_ULTRA_FASTENERS
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Ultra Fasteners
material: Accessory
...
This is the canonical internal description for the Foilboard Ultra Fasteners family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Ultra Fasteners family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Foilboard Ultra Fasteners family
...
| Requirement | Status for Foilboard Ultra Fasteners | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Ultra Fasteners is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Position 40mm
or 50mm Foilboard panel firmly against timber framing studs or ceiling joists.
2. Place Ultra Fastener against the panel surface at specified fixing points.
3. Drive fastener through the thick board into the timber until the broad washer
rests flat against the foil.
4. Do not overdrive to avoid crushing the thick EPS
core.
5. Fix at maximum 600mm centers along perimeter edges and down central
studs.
6. In ceiling applications, support panels while driving fasteners to
ensure tight structural contact.
7. Tape over all fastener heads with
Foilboard 72mm reinforced foil tape for airtightness.

**Manufacturer-stated limitations**

- Designed for timber framing; for steel
framing use Ultra Tek Screws.
- Ensure fastener length is sufficient to
penetrate solid timber behind 50mm boards.
- Non-structural; does not replace
primary cladding fixings.
...
| --- | --- | --- |
| Fastener Type | Extended galvanized nail or screw with
oversized load-spreading washer plate |  |
| Lengths | 70 mm, 80 mm, 90 mm, 100 mm (tailored for 40mm and 50mm
boards) |  |
| Washer Plate Diameter | 40
mm - 50 mm |  |
