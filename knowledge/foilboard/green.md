...
category: Board
canonical_name: Foilboard Green
material: EPS
...
| R1.0 | thermal_r_value | 40 | 2400 x 1200 | 1 |
| R1.2 | thermal_r_value | 50 | 2400 x 1200 | 1 |
...
### Within the Foilboard Green family
...
| Requirement | Status for Foilboard Green | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Green is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure
structural framing or substrate is level, clean, and dry.
2. Measure and cut
panels using a sharp utility knife or hand saw.
3. Maintain a minimum 20mm sealed
airspace adjacent to reflective foil faces to generate full thermal R-value.
4. For walls, fix horizontally or vertically across framing with mechanical
fasteners and blank plates.
5. For underfloors, install between joists supported
on Foilboard Floor Saddles or Retrofit Clips.
6. Butt sheet joints tightly and
tape with Foilboard 72mm reinforced aluminum tape.
7. Seal all edges around
windows, doors, and service penetrations to maintain airtightness.
8. Ensure
anti-glare green face faces the installer during roof and sunny external
installations.

**Manufacturer-stated limitations**

- Requires an adjacent sealed airspace of at
least 20mm to deliver rated Total R-value.
- Avoid contact with organic
solvents, petroleum fuels, and solvent-based adhesives which dissolve EPS.
- Do
not leave permanently exposed to direct outdoor UV weather without cladding.
...
| --- | --- | --- |
| Material Composition | Fire-retardant expanded polystyrene (EPS) core laminated with pure
aluminum foil facings |  |
| Material R-values | 10mm (R0.3), 15mm (R0.4), 20mm (R0.5), 25mm (R0.7), 40mm (R1.1), 50mm
(R1.3) | ASTM C518 |
| Total System R-values | R1.6 to R4.0+ (depending on installation application and airspace
width) | AS/NZS 4859.1 |
| Thickness Options | 10 mm, 15 mm, 20 mm, 25 mm, 40 mm, 50 mm |  |
| Sheet Dimensions | 2440 mm x 1200 mm; 2700 mm x 1200
mm; 3000 mm x 1200 mm |  |
| Emittance (Reflective
Silver Face) | 0.03 (reflects up to 97% of radiant heat) | AS/NZS 4201.5 |
