---
id: foilboard-flexifast-fasteners
family_id: FOILBOARD_FLEXIFAST_FASTENERS
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Flexifast Fasteners
material: Accessory
...
This is the canonical internal description for the Foilboard Flexifast Fasteners family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Flexifast Fasteners family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Foilboard Flexifast Fasteners family
...
| Requirement | Status for Foilboard Flexifast Fasteners | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Flexifast Fasteners is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Position Foilboard panel flat against masonry,
concrete, or timber substrate.
2. Drill an 8mm hole through the Foilboard panel
into the masonry substrate to minimum 35mm depth.
3. Insert the Flexifast
fastener through the panel into the drilled hole.
4. Tap gently with a hammer or
press firmly until the broad head seats flush against the foil.
5. Ensure anchor
head clamps the panel firmly without over-driving into the EPS core.
6. Space
fasteners at 600mm centers around the perimeter and across the board face.
7. Tape over fastener heads with Foilboard 72mm reinforced foil tape if an
airtight vapor seal is required.

**Manufacturer-stated limitations**

- Requires pre-drilling into concrete and masonry.
- Not
designed for hollow plasterboard or soft substrates without structural backing.
...
| Head Diameter | 35 mm - 45 mm wide
clamping washer head |  |
| Anchor Lengths | 45 mm (for 10-15mm board), 70 mm (for 20-25mm board), 95 mm
(for 40-50mm board) |  |
| Drill Hole Diameter | 8 mm masonry drill bit |  |
| Thermal
Bridging | Zero thermal bridging (non-metallic) |  |
