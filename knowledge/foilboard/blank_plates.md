---
id: foilboard-blank-plates
family_id: FOILBOARD_BLANK_PLATES
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Blank Plates
material: Accessory
...
This is the canonical internal description for the Foilboard Blank Plates family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Blank Plates family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Foilboard Blank Plates family
...
| Requirement | Status for Foilboard Blank Plates | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Blank Plates is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Position Foilboard panel in place against framing or
masonry substrate.
2. Insert screw, nail, or anchor through the center hole of
the Foilboard Blank Plate.
3. Drive fastener through the Foilboard panel into
timber, steel, or masonry framing.
4. Tighten until the Blank Plate rests snug
and flat against the aluminum foil facing.
5. Do not over-torque to avoid
compressing the underlying EPS core.
6. Place Blank Plates at recommended spacing
(typically 600mm centers along edges and center).
7. Cover plate and fastener
head with Foilboard 72mm reinforced foil tape if an airtight vapor seal is
required.

**Manufacturer-stated limitations**

- Do not over-tighten fasteners as excessive torque
will deform the panel core.
- Blank Plates do not provide thermal break values
on their own.
- Not designed to support heavy structural cladding loads
independently.
...
| --- | --- | --- |
| Plate
Dimensions | 40 mm x 40 mm (or 50 mm diameter) |  |
| Center Hole Diameter | 5 mm (suits 8G-10G screws) |  |
| Material | High-impact rigid polymer
/ galvanized steel |  |
