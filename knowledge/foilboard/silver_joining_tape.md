---
id: foilboard-silver-joining-tape
family_id: FOILBOARD_SILVER_JOINING_TAPE
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Silver Joining Tape
material: EPS
...
### Within the Foilboard Silver Joining Tape family
...
| Requirement | Status for Foilboard Silver Joining Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Silver Joining Tape is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure panel surfaces are dry, clean, and free of dust, grease,
and oil.
2. Align Foilboard panels with edges tightly butted together.
3. Center 72mm Silver Joining Tape over the joint on the silver reflective side of
the board.
4. Peel paper release liner progressively while smoothing tape down
along the seam.
5. Press down firmly along the entire tape length using a plastic
squeegee or roller to activate adhesive.
6. Smooth out all wrinkles and air
pockets to achieve a permanent, airtight seal.

**Manufacturer-stated limitations**

- Substrates must be dry and free of sawdust or grease before application.
- Requires firm mechanical pressure with a squeegee to achieve complete adhesive
activation.
...
| --- | --- | --- |
| Backing Material | Reinforced aluminum foil with pure
silver reflective facing |  |
| Adhesive Type | Pressure-sensitive solvent acrylic adhesive |  |
| Roll Width | 72 mm (also available in 48 mm) |  |
| Roll Length | 50 m |  |
| Operating Temperature Range | -20°C to +80°C |  |
| Vapor Permeance | Class 1 Vapor
Barrier (< 0.002 µg/N·s) | ASTM E96 |
| Flammability
