---
id: foilboard-green-joining-tape
family_id: FOILBOARD_GREEN_JOINING_TAPE
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Green Joining Tape
material: EPS
...
This is the canonical internal description for the Foilboard Green Joining Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Green Joining Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Foilboard Green Joining Tape family
...
| Requirement | Status for Foilboard Green Joining Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Green Joining Tape is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure Foilboard panel faces are
completely dry, clean, and free of dust, grease, and moisture.
2. Align Foilboard
panels with tightly butted joints.
3. Center the 72mm Green Joining Tape squarely
over the seam with green face outward.
4. Peel back release liner gradually while
applying tape along the joint.
5. Press down firmly along the entire tape length
using a plastic squeegee or roller to activate pressure-sensitive adhesive.
6. Smooth out all wrinkles and air bubbles to guarantee an airtight, vapor-proof
seal.

**Manufacturer-stated limitations**

- Surfaces must be completely clean and
dry before taping.
- Requires firm squeegee pressure to activate permanent
adhesive bond.
...
| --- | --- | --- |
| Backing Material | Reinforced aluminum
foil with anti-glare green lacquer coating |  |
| Adhesive Type | Pressure-sensitive solvent acrylic adhesive |  |
| Roll Width | 72 mm (also available
in 48 mm) |  |
| Roll Length | 50 m |  |
| Operating Temperature Range | -20°C
to +80°C |  |
| Vapor Permeance | Class 1
Vapor Barrier (< 0.002 µg/N·s) | ASTM E96 |
