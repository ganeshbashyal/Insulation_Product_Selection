---
id: foilboard-spacer-blocks
family_id: FOILBOARD_SPACER_BLOCKS
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Spacer Blocks
material: EPS
...
This is the canonical internal description for the Foilboard Spacer Blocks family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Spacer Blocks family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Foilboard Spacer Blocks family
...
| Requirement | Status for Foilboard Spacer Blocks | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Spacer Blocks is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Determine required airspace depth
(20mm or 25mm) from system architectural specification.
2. Position Foilboard
Spacer Blocks onto wall studs, battens, or the back of Foilboard panels.
3. Adhere blocks using approved construction adhesive or tack in place with
fasteners.
4. Place approximately one spacer block per square meter or at 600mm
to 900mm intervals along framing.
5. Install Foilboard panel firmly against
spacer blocks.
6. Fasten panel to structural framing ensuring spacer blocks
maintain the designed airspace.
7. Verify panels remain planar without bowing
into the adjacent cladding cavity.

**Manufacturer-stated limitations**

- Do not use
solvent-based adhesives which dissolve expanded polystyrene.
- Spacer blocks are
non-structural and do not replace primary mechanical framing fasteners.
- Do not
expose to continuous service temperatures above 80°C.
...
| --- | --- | --- |
| Material | Fire-retardant expanded
polystyrene (EPS) |  |
| Block Thickness (Airspace
Depth) | 20 mm, 25 mm |  |
| Block
Dimensions | Approx. 50 mm x 50 mm x 20/25 mm (or 100 mm x 50 mm) |  |
