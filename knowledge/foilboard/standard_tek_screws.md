---
id: foilboard-standard-tek-screws
family_id: FOILBOARD_STANDARD_TEK_SCREWS
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Standard Tek Screws
material: Accessory
...
This is the canonical internal description for the Foilboard Standard Tek Screws family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Foilboard Standard Tek Screws family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Manufacturer-published features and benefits include: Premium insulation product designed for Australian building conditions This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Foilboard Standard Tek Screws family
...
| Requirement | Status for Foilboard Standard Tek Screws | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Standard Tek Screws is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Hold
Foilboard panel firmly against steel studs or purlins.
2. Fit Foilboard Standard
Tek Screw into screw gun or drill driver with matching bit.
3. Drive screw
perpendicular through the panel and into the steel framing member.
4. Allow drill
tip to penetrate steel stud before applying driving torque.
5. Stop driving when
the broad washer head seats flush and firm against the aluminum foil facing.
6. Do not overtighten to avoid dishing the washer into the EPS core.
7. Space
screws at maximum 600mm centers along perimeter and internal framing members.
8. Seal over screw heads with Foilboard 72mm reinforced foil tape if an airtight
vapor seal is required.

**Manufacturer-stated limitations**

- Not suitable for heavy structural steel thicker
than 2.5mm without pre-drilling.
- Do not overtighten; excessive torque will
strip light-gauge steel or crush board.
- For thick boards (40mm to 50mm), use
Foilboard Ultra Tek Screws.
...
| --- | --- | --- |
| Fastener Type | Self-drilling steel tek
screw with integrated broad washer plate |  |
| Steel Gauge Capacity | 0.75 mm to 2.5 mm steel stud / girt
thickness |  |
| Washer Diameter | Approx. 35 mm - 40 mm |  |
| Lengths | 35
mm, 45 mm, 55 mm (to suit 10mm, 15mm, 20mm, 25mm boards) |  |
