---
id: foilboard-accessory
family_id: FOILBOARD_ACCESSORY
manufacturer: Foilboard
category: Accessory
canonical_name: Foilboard Accessory
material: Accessory
...
| Requirement | Status for Foilboard Accessory | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard Accessory is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Select
appropriate accessory based on application (Floor Saddles for subfloor;
Flexifast for concrete/timber; Tape for joins).
2. Position panels with
required 20mm+ air space to substrate.
3. Fix panels mechanically using Flexifast
pins or Floor Saddles at maximum 600mm centers.
4. Tape all panel butt joins,
corners, and penetrations with Foilboard 72mm reinforced foil tape.
5. Firmly
squeegee tape to ensure permanent pressure-sensitive adhesion and airtight seal.

**Manufacturer-stated limitations**

- Tape must be applied to clean, dry,
and dust-free surfaces.
- Do not substitute non-approved duct tapes that degrade
under heat.
- Saddles and fasteners are non-structural; do not support
...
| Floor Saddle Depths | 100 mm, 130 mm (for 10-25mm
and 20-50mm boards) |  |
| Flexifast Pin Lengths | 45 mm, 70 mm, 95 mm |  |
| Tape
Flammability | Low Flammability Index (≤ 5) | AS 1530.2 |
