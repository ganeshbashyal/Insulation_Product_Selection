---
id: foilboard-diy-fast-trade-pack
family_id: FOILBOARD_DIY_FAST_TRADE_PACK
manufacturer: Foilboard
category: Board
canonical_name: Foilboard DIY/Fast Trade Pack
material: EPS
...
### Within the Foilboard DIY/Fast Trade Pack family
...
| Requirement | Status for Foilboard DIY/Fast Trade Pack | Enquiry-bot action |
| --- | --- | --- |
...
> Foilboard DIY/Fast Trade Pack is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
2. Measure gap between floor
joists, wall studs, or shed framing.
3. Trim panels to width allowing for a snug
friction-fit or saddle support.
4. Fit into cavity maintaining a minimum 20mm air
space adjacent to reflective foil.
5. Secure with Foilboard Floor Saddles
(underfloor) or screws with Blank Plates (walls).
6. Tape all adjoining sheet
seams with Foilboard 72mm reinforced foil tape.

**Manufacturer-stated limitations**

- Requires an adjacent sealed air
space of at least 20mm to achieve rated Total R-value.
- Do not use in direct
contact with organic solvents or petroleum products.
- Keep away from continuous
heat sources above 80°C.
...
| Thickness Options | 15 mm, 20 mm, 25
mm |  |
| Sheet Dimensions | 1200 mm x 600
mm or 1200 mm x 800 mm |  |
| Emittance (Reflective
Face) | 0.03 (97% heat reflection) | AS/NZS 4201.5 |
| Combustibility | Fire-retardant EPS core; Group 1 /
Group 2 | AS 5637.1 |
