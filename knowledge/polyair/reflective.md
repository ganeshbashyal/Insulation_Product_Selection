---
id: polyair-reflective
family_id: POLYAIR_REFLECTIVE
manufacturer: Polyair
category: Reflective
canonical_name: Polyair Reflective
...
official_datasheet_url: https://www.polyair.com.au/
official_sds_url: https://www.polyair.com.au/
product_count: 2
...
This is the canonical internal description for the Polyair Reflective family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Polyair Reflective family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Reflects up to 97% of radiant heat, reducing summer cooling costs. Manufacturer-published features and benefits include: High-purity aluminium reflective facing; reflects up to 97% of radiant heat; lightweight and easy to install; provides vapour barrier when properly sealed; excellent thermal performance for roof/ceiling applications This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Reflective insulation product from Polyair.
- Material: Reflective Composite.
...
### Within the Polyair Reflective family

- Metal Roof / Shed | External Wall

### Separate product families

Do not transfer claims from this family to other Polyair product families without their own current technical evidence. Where Polyair sells multiple product families within the Reflective category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Polyair Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Polyair Reflective is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.polyair.com.au/

Safety Data Sheet: https://www.polyair.com.au/


> Datasheet link audited 2026-09-05: repointed to the verified manufacturer site. Exact product TDS deep link still to be sourced; legacy reference: https://hmrsupplies.com.au/wp-content/uploads/2024/05/Bradford™-Poly-Air-Perfroma™-XHD-Data.pdf
...
```json
{
  ...
  "source_url": "https://hmrsupplies.com.au/wp-content/uploads/2024/05/Bradford\u2122-Poly-Air-Perfroma\u2122-XHD-Data.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://www.polyair.com.au/ |
| Material composition | Manufacturer-claimed | https://www.polyair.com.au/ |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://www.polyair.com.au/ |
...
1. Roll out Polyair over roof
purlins or wall framing with anti-glare face oriented outward toward the
installer.
2. Ensure roll edges overlap by a minimum of 50mm (or butt join if
fully taped with 72mm foil tape).
3. Secure mechanically to steel or timber
framing using wafer-head self-drilling screws with washers.
4. Maintain a
minimum 20mm still air cavity adjacent to the reflective face to achieve rated
Total R-values.
5. Tape all seams, joins, and penetrations with 72mm reinforced
aluminium foil tape to form a continuous vapour barrier.
6. At roof eaves, allow
membrane to drain freely into gutters without ponding.

**Manufacturer-stated limitations**

- Requires a
minimum 20mm sealed airspace adjacent to foil face to achieve rated Total
R-value.
- Do not allow direct contact with wet concrete or alkaline mortar to
prevent foil corrosion.
- Not designed as a permanent foot-traffic surface or
exposed outdoor weather membrane.
...
| --- | --- | --- |
| Material | Cross-linked closed-cell polyethylene foam core laminated with pure
aluminium foil |  |
| Thickness Options | 4 mm, 7 mm, 8 mm |  |
| Reflectance | 97%
radiant heat reflection (emittance 0.03) | AS/NZS 4201.5 |
| Vapour Barrier Classification | Class 1 / Class 2 Vapour
Barrier (< 0.02 µg/N·s) | ASTM E96 |
| Water
Control | Water Barrier | AS/NZS 4201.4 |
| Thermal Break Performance | Achieves R0.20+ thermal break on steel
framing | NCC 2022 |
