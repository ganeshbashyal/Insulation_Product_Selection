---
id: trade-select-nc-thermal-break-strips
family_id: TRADE_SELECT_NC_THERMAL_BREAK_STRIPS
manufacturer: Trade Select
category: Reflective
canonical_name: Trade Select NC Thermal Break Strips
...
# Trade Select NC Thermal Break Strips

## Purpose of this file

This is the canonical internal description for the Trade Select NC Thermal Break Strips family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Trade Select NC Thermal Break Strips family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Trade Select NC Thermal Break Strips family
...
| Requirement | Status for Trade Select NC Thermal Break Strips | Enquiry-bot action |
| --- | --- | --- |
...
> Trade Select NC Thermal Break Strips is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
