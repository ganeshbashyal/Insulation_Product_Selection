---
id: trade-select-easyseal-insulation-flashing-tape
family_id: TRADE_SELECT_EASYSEAL_INSULATION_FLASHING_TAPE
manufacturer: Trade Select
category: Reflective
canonical_name: Trade Select EasySeal Insulation Flashing Tape
...
# Trade Select EasySeal Insulation Flashing Tape

## Purpose of this file

This is the canonical internal description for the Trade Select EasySeal Insulation Flashing Tape family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Trade Select EasySeal Insulation Flashing Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Trade Select EasySeal Insulation Flashing Tape family
...
| Requirement | Status for Trade Select EasySeal Insulation Flashing Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Trade Select EasySeal Insulation Flashing Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
