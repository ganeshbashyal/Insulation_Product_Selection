---
id: trade-select-wrap
family_id: TRADE_SELECT_WRAP
manufacturer: Trade Select
category: Wrap
canonical_name: Trade Select Wrap
material: Membrane
...
This is the canonical internal description for the Trade Select Wrap family (Wrap category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Trade Select Wrap family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet the demanding requirements of Australian building conditions. Manufacturer-published features and benefits include: High-performance membrane technology; provides effective vapour and moisture management; compatible with a wide range of substrates This family covers 8 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Wrap insulation product from Trade Select.
- Material: Membrane.
...
| --- | --- | ---: | --- | ---: |
| R1.5 | thermal_r_value | Varies | 30000 x 1500 | 2 |
| R1.5 | thermal_r_value | Varies | 30000 x 1350 | 1 |
| R1.5 | thermal_r_value | Varies | 60000 x 1350 | 1 |
| R1.5 | thermal_r_value | Varies | 60000 x 1500 | 1 |
| R1.5 | thermal_r_value | Varies | 30000 x 1370 | 1 |
...
### Within the Trade Select Wrap family

- Wall Wrap / Sarking

### Separate product families

Do not transfer claims from this family to other Trade Select product families without their own current technical evidence. Where Trade Select sells multiple product families within the Wrap category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Trade Select Wrap | Enquiry-bot action |
| --- | --- | --- |
...
> Trade Select Wrap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
