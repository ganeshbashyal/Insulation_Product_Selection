---
id: trade-select-nc-thermal-break-strips-adhesive-backed
family_id: TRADE_SELECT_NC_THERMAL_BREAK_STRIPS_ADHESIVE_BACKED
manufacturer: Trade Select
category: Reflective
canonical_name: Trade Select NC Thermal Break Strips Adhesive backed
...
### Within the Trade Select NC Thermal Break Strips Adhesive backed family
...
| Requirement | Status for Trade Select NC Thermal Break Strips Adhesive backed | Enquiry-bot action |
| --- | --- | --- |
...
> Trade Select NC Thermal Break Strips Adhesive backed is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
