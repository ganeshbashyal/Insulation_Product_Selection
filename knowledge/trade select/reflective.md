---
id: trade-select-reflective
family_id: TRADE_SELECT_REFLECTIVE
manufacturer: Trade Select
category: Reflective
canonical_name: Trade Select Reflective
...
official_datasheet_url: https://tradeselect.com.au/
...
- The catalogue includes 33 unique SKU variant(s) in this family.
...
| --- | --- | ---: | --- | ---: |
| R1.5 | thermal_r_value | Varies | 30000 x 1500 | 8 |
| R1.5 | thermal_r_value | Varies | 30000 x 1350 | 4 |
| R1.5 | thermal_r_value | Varies | 60000 x 1350 | 3 |
| R1.5 | thermal_r_value | Varies | Varies | 3 |
| R1.5 | thermal_r_value | Varies | 60000 x 1500 | 2 |
| R1.5 | thermal_r_value | Varies | 60000 x 1200 | 1 |
| R1.5 | thermal_r_value | Varies | 30000 x 3050 | 1 |
| R1.5 | thermal_r_value | Varies | 22250 x 1350 | 1 |
| R1.05 | thermal_r_value | 25 | Varies | 1 |
| R1.25 | thermal_r_value | 30 | Varies | 1 |
| R1.7 | thermal_r_value | 40 | Varies | 1 |
| R2.15 | thermal_r_value | 50 | Varies | 1 |
| R2.55 | thermal_r_value | 60 | Varies | 1 |
| R3 | thermal_r_value | 70 | Varies | 1 |
| R3.2 | thermal_r_value | 75 | Varies | 1 |
| R3.4 | thermal_r_value | 80 | Varies | 1 |
...
### Within the Trade Select Reflective family
...
Do not transfer claims from this family to other Trade Select product families without their own current technical evidence. Where Trade Select sells multiple product families within the Reflective category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Trade Select Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Trade Select Reflective is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://tradeselect.com.au/
...
The master product catalogue provides current commercial records for 33 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
...
```json
{
  ...
  "source_url": "https://tradeselect.com.au/"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://tradeselect.com.au/ |
| Material composition | Manufacturer-claimed | https://tradeselect.com.au/ |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://tradeselect.com.au/ |
...
Source currently recorded: https://tradeselect.com.au/
