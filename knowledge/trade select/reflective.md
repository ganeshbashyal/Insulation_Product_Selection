...
This is the canonical internal description for the Trade Select Reflective family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.
...
- The catalogue includes 51 unique SKU variant(s) in this family.
...
| R1.5 | thermal_r_value | Varies | 25000 x 150 | 2 |
| R1.5 | thermal_r_value | Varies | 1200 x 45 | 2 |
...
| R1.5 | thermal_r_value | Varies | 2750 x 43 | 1 |
...
Do not transfer claims from this family to other Trade Select product families without their own current technical evidence. Where Trade Select sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
...
The master product catalogue provides current commercial records for 51 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
