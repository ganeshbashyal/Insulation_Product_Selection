---
id: martini-commercial-polyester-martini-mab
family_id: MARTINI_COMMERCIAL_POLYESTER_MARTINI_MAB
manufacturer: Martini
category: Batt
canonical_name: Martini Commercial Polyester / Martini MAB
material: Polyester
...
official_datasheet_url: https://martini.com.au/
official_sds_url: https://martini.com.au/
product_count: 4
rating_basis: thermal
---

# Martini Commercial Polyester / Martini MAB

## Purpose of this file

This is the canonical internal description for the Martini Commercial Polyester / Martini MAB family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Martini Commercial Polyester / Martini MAB family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Safe to handle without gloves or masks. Made from recycled plastic bottles for sustainability. Perfect for maximum thermal performance in roof/ceiling applications. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet; excellent thermal performance for roof/ceiling applications This family covers 4 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Batt insulation product from Martini.
- Material: Polyester.
...
### Within the Martini Commercial Polyester / Martini MAB family

- Internal Wall | Ceiling | General Acoustic

### Separate product families

Do not transfer claims from this family to other Martini product families without their own current technical evidence. Where Martini sells multiple product families within the Batt category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Martini Commercial Polyester / Martini MAB | Enquiry-bot action |
| --- | --- | --- |
...
> Martini Commercial Polyester / Martini MAB is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://martini.com.au/

Safety Data Sheet: https://martini.com.au/
...
```json
{
  ...
  "source_url": "https://martini.com.au/"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://martini.com.au/ |
| Material composition | Manufacturer-claimed | https://martini.com.au/ |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://martini.com.au/ |
...
1. Ensure cavity
framing, ceiling space, or duct substrate is clean, dry, and free of debris.
2. Select density and thickness specified by the acoustic consultant (e.g. MAB 32
for sound absorption).
3. Friction-fit sheets into wall framing bays or lay flat
above suspended ceiling tiles.
4. For perforated paneling or slotted timber,
install black MAB directly against the rear of panels to conceal framing.
5. Cut
neatly around mechanical services and electrical boxes using a utility knife or
electric cutter.
6. Overlap or butt adjoining batts tightly together to eliminate
acoustic flanking gaps.
7. In HVAC acoustic silencers or attenuators, install
with protective perforated facing to prevent airstream erosion.

**Manufacturer-stated limitations**

- Internal use only; not suitable for
direct exterior weather exposure.
- Maximum continuous service temperature
is 150°C.
- In high-velocity HVAC ducts, requires perforated metal or scrim
facing to prevent fiber displacement.
...
| --- | --- | --- |
| Density Options | 11 kg/m³, 14 kg/m³, 20 kg/m³, 24 kg/m³, 30 kg/m³, 32 kg/m³, 48
kg/m³, 60 kg/m³ |  |
| Thickness Options | 25 mm, 30 mm, 50 mm, 75 mm, 100 mm |  |
| Standard
Sheet Dimensions | 1200 mm x 2400 mm (custom sizes and rolls
available) |  |
| Acoustic Performance | NRC 0.65 to 1.10 depending on density and thickness (e.g. 50mm 32kg/m³:
NRC 0.85-0.90; 75mm 32kg/m³: NRC 1.00; 100mm: NRC 1.05+) | ISO 354
/ AS 1045 |
| Fire Hazard Indices | Ignitability: 0,
Spread of Flame: 0, Heat Evolved: 0, Smoke Developed: 0-1 | AS/NZS 1530.3 |
| Thermal Conductivity | 0.032 - 0.040
W/m·K (depending on density) | ASTM C518 |
| Maximum
