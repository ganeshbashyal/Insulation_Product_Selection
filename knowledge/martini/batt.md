---
id: martini-batt
family_id: MARTINI_BATT
manufacturer: Martini
category: Batt
canonical_name: Martini Batt
material: Polyester
...
This is the canonical internal description for the Martini Batt family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Martini Batt family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
Do not transfer claims from this family to other Martini product families without their own current technical evidence. Where Martini sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Martini Batt | Enquiry-bot action |
| --- | --- | --- |
...
> Martini Batt is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
