# Rockwool product-family knowledge base

Bot-facing knowledge for Rockwool products. Each file represents a technical family, not an individual stock SKU.

## Family index

| Family ID | Product family | Evidence status |
| --- | --- | --- |
| `ROCKWOOL_REFLECTIVE` | Rockwool Reflective | Initial documentation |
