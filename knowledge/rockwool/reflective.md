---
id: rockwool-reflective
family_id: ROCKWOOL_REFLECTIVE
manufacturer: Rockwool
category: Reflective
canonical_name: Rockwool Reflective
material: Stonewool / Foil Composite
...
official_datasheet_url: https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf
official_sds_url: https://www.ais-group.com.au/wp-content/uploads/2023/04/AIS_Rockwool_SDS_1823-1-V2.pdf
product_count: 71
...
- The catalogue includes 71 unique SKU variant(s) in this family.
...
| R1.1 | thermal_r_value | 40 | Varies | 1 |
| R1.4 | thermal_r_value | 50 | Varies | 1 |
| R1.8 | thermal_r_value | 63 | Varies | 1 |
| R0.7 | thermal_r_value | 25 | Varies | 1 |
| R1.1 | thermal_r_value | 40 | Varies | 1 |
| R1.4 | thermal_r_value | 50 | Varies | 1 |
| R1.8 | thermal_r_value | 63 | Varies | 1 |
...
| R1.8 | thermal_r_value | 63 | Varies | 1 |
| R1.8 | thermal_r_value | 63 | Varies | 1 |
| R2.1 | thermal_r_value | 75 | Varies | 1 |
| R2.1 | thermal_r_value | 75 | Varies | 1 |
| R1.1 | thermal_r_value | 40 | Varies | 1 |
| R0.7 | thermal_r_value | 25 | Varies | 1 |
...
### Within the Rockwool Reflective family

- Pipe

### Separate product families

Do not transfer claims from this family to other Rockwool product families without their own current technical evidence. Where Rockwool sells multiple product families within the Reflective category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Rockwool Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Rockwool Reflective is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf

Safety Data Sheet: https://www.ais-group.com.au/wp-content/uploads/2023/04/AIS_Rockwool_SDS_1823-1-V2.pdf
...
The master product catalogue provides current commercial records for 71 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
...
```json
{
  ...
  "source_url": "https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf |
| Material composition | Manufacturer-claimed | https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf |
...
Source currently recorded: https://www.rockwool.com/syssiteassets/rw-sa/technical-resources/thermalrock-s---technical-datasheet-au---2023.pdf
