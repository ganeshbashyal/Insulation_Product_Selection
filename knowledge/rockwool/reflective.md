...
This is the canonical internal description for the Rockwool Reflective family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.
...
Do not transfer claims from this family to other Rockwool product families without their own current technical evidence. Where Rockwool sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
