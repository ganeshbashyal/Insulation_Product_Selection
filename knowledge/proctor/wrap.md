---
id: proctor-wrap
family_id: PROCTOR_WRAP
manufacturer: Proctor
category: Wrap
canonical_name: Proctor Wrap
...
This is the canonical internal description for the Proctor Wrap family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Wrap family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| Requirement | Status for Proctor Wrap | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Wrap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
