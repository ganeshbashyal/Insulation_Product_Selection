...
canonical_name: ProctorGeo IRMA
...
This is the canonical internal description for the ProctorGeo IRMA family (Drainage / Ventilation category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **ProctorGeo IRMA family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet Australian building requirements. Manufacturer-published features and benefits include: High-performance membrane technology; provides effective vapour and moisture management; compatible with a wide range of substrates This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the ProctorGeo IRMA family
...
| Requirement | Status for ProctorGeo IRMA | Enquiry-bot action |
| --- | --- | --- |
...
> ProctorGeo IRMA is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Complete primary roof waterproofing
membrane and ensure watertightness testing is verified.
2. Lay extruded
polystyrene (XPS) rigid insulation boards tightly butted over the
waterproofing.
3. Roll out ProctorGeo IRMA geotextile loose directly over the top
of the XPS insulation.
4. Ensure all adjoining geotextile runs overlap by a
minimum of 300mm.
5. Turn geotextile up all parapets, upstands, and penetrations
to the height of the ballast finish.
6. Place rounded gravel ballast
(minimum 50mm depth) or paving slabs on pedestals directly over the fabric.
7. Ensure ballast is placed progressively to prevent wind uplift of the geotextile
during installation.

**Manufacturer-stated limitations**

- Not a waterproofing membrane; designed strictly as
a filtration, water-deflecting, and separation geotextile.
- Must be weighed
down with ballast or pavers to prevent wind uplift.
- Do not use crushed, sharp
aggregate ballast that could pierce the fabric.
...
| --- | --- | --- |
| Material | 100% UV-stabilised virgin polypropylene
non-woven geotextile |  |
| Nominal Mass per Unit
Area | 130 g/m² - 140 g/m² | EN ISO 9864 / AS 3706.1 |
| CBR Puncture Resistance | > 1500 N - 1800 N | EN ISO 12236 / AS 3706.4 |
| Tensile Strength
(MD/CD) | > 8.0 kN/m / > 8.0 kN/m | EN ISO 10319 /
AS 3706.2 |
| Water Vapour Permeability | Class 4
Vapour Permeable (Sd < 0.05 m) | EN ISO 12572 |
...
| Roll Dimensions | 2.0 m or 3.0 m width x 50 m / 100 m
length |  |
