---
id: proctor-passive-wraptite-sa-tape
family_id: PROCTOR_PASSIVE_WRAPTITE_SA_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor Passive Wraptite SA Tape
...
### Within the Proctor Passive Wraptite SA Tape family
...
| Requirement | Status for Proctor Passive Wraptite SA Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Passive Wraptite SA Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure substrate (timber,
concrete, steel, or sheathing) is clean, dry, and dust-free.
2. Apply compatible
primer to porous concrete or masonry if required.
3. Measure and cut Wraptite SA
tape to length.
4. Peel back the initial section of the split release liner.
5. Position tape along the joint, corner, or window reveal.
6. Gradually peel
remaining liner while smoothing tape firmly onto the substrate.
7. Consolidate
bond across the entire tape surface with a firm hand roller or squeegee.
8. Overlap adjoining tape pieces by minimum 50mm.

**Manufacturer-stated limitations**

- Do not apply to wet,
frosty, or contaminated surfaces.
- Requires firm rolling pressure to activate
full pressure-sensitive bond.
- Must not remain exposed to permanent UV beyond
rated exposure window.
...
| --- | --- | --- |
| Material | Triple-layer polypropylene with microporous film and full-surface PSA
backing |  |
| Duty Classification | Light
Duty | AS/NZS 4200.1:2017 |
