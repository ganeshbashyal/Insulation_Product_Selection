---
id: proctor-acoustic-membrane
family_id: PROCTOR_ACOUSTIC_MEMBRANE
manufacturer: Proctor
category: Acoustic Membrane
canonical_name: Proctor Acoustic Membrane
...
# Proctor Acoustic Membrane

## Purpose of this file

This is the canonical internal description for the Proctor Acoustic Membrane family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Acoustic Membrane family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Acoustic Membrane family
...
| Requirement | Status for Proctor Acoustic Membrane | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Acoustic Membrane is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
