---
id: proctor-q-silence-p
family_id: PROCTOR_Q_SILENCE_P
manufacturer: Proctor
category: Acoustic Membrane
canonical_name: Proctor Q-Silence P
material: Acoustic Membrane
...
This is the canonical internal description for the Proctor Q-Silence P family (Acoustic Membrane category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Q-Silence P family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Acoustic Membrane insulation product from Proctor.
- Material: Acoustic Membrane.
...
### Within the Proctor Q-Silence P family

- Acoustic Treatment

### Separate product families

Do not transfer claims from this family to other Proctor product families without their own current technical evidence. Where Proctor sells multiple product families within the Acoustic Membrane category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Proctor Q-Silence P | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Q-Silence P is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure
structural concrete slab or timber subfloor is level, clean, and dry.
2. Repair
subfloor cracks and remove protrusions before laying underlay.
3. Roll out
Q-Silence P membrane across the floor area, butting edges tightly.
4. Run
acoustic isolation strips up the perimeter walls to isolate the floor finish
from skirting.
5. Tape all adjoining underlay seams with waterproof tape to
prevent screed slurry bridging.
6. Pour screed or install floor overlay directly
over the membrane according to flooring specification.
7. Trim excess perimeter
isolation strips flush after flooring is completed.

**Manufacturer-stated limitations**

- Subfloor must be
within allowable flatness tolerances prior to installation.
- Do not
mechanically fix through the membrane as screws create acoustic bridges.
- Must
be isolated from perimeter walls and skirtings.
...
| Application | Impact sound isolation
underlay |  |
