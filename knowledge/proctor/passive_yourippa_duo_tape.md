---
id: proctor-passive-yourippa-duo-tape
family_id: PROCTOR_PASSIVE_YOURIPPA_DUO_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: ProctorPassive YouRippa Duo Tape
...
# ProctorPassive YouRippa Duo Tape

## Purpose of this file

This is the canonical internal description for the ProctorPassive YouRippa Duo Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **ProctorPassive YouRippa Duo Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the ProctorPassive YouRippa Duo Tape family
...
| Requirement | Status for ProctorPassive YouRippa Duo Tape | Enquiry-bot action |
| --- | --- | --- |
...
> ProctorPassive YouRippa Duo Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
