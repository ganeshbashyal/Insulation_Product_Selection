...
# Proctor Drainage / Ventilation

## Purpose of this file

This is the canonical internal description for the Proctor Drainage / Ventilation family (Drainage / Ventilation category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Drainage / Ventilation family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Proctor Drainage / Ventilation family
...
| Requirement | Status for Proctor Drainage / Ventilation | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Drainage / Ventilation is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. For roofs, install sarking
over purlins with minimum drape to prevent ponding.
2. Lay ProctorPassive DB-FR
running the full length of each roof batten or beneath concealed-fix clips.
3. Fix roof sheeting through battens into structural framing, ensuring torque does
not crush the batten profile.
4. For walls, fix DB-FR or VB10/VB20 vertically or
horizontally aligned with studs, noggings, and window perimeters.
5. Use the
integrated adhesive backing on vented battens to hold them in place prior to
mechanical fastening.
6. Fix external wall cladding through the drainage battens
directly into framing studs as normal.
7. Combine with Over-Fascia Vents
(FV10/FV25) and Ridge Vents (RV10) to complete the continuous passive airflow
loop.

**Manufacturer-stated limitations**

- Non-structural cavity spacer; claddings and roof sheets must
fix through the batten into structural framing.
- Do not over-torque fasteners
to avoid crushing the ventilation openings.
...
extrusion / polypropylene |  |
| Batten Dimensions
(DB-FR) | 10.5 mm thickness x 40 mm width x 2500 mm length (folds
to 21mm) |  |
| Vented Batten Thicknesses (VB10 /
VB20) | VB10: 10 mm; VB20: 20 mm |  |
...
| Maximum Service Temperature | 90°C (melting
point 160°C) | ASTM D3418 |
