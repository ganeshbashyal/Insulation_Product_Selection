---
id: proctor-yourippa-cyclone
family_id: PROCTOR_YOURIPPA_CYCLONE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor YouRippa Cyclone
...
# Proctor YouRippa Cyclone

## Purpose of this file

This is the canonical internal description for the Proctor YouRippa Cyclone family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor YouRippa Cyclone family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Proctor YouRippa Cyclone family
...
| Requirement | Status for Proctor YouRippa Cyclone | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor YouRippa Cyclone is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
