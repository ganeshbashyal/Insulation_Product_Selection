---
id: proctor-yourippa-easy
family_id: PROCTOR_YOURIPPA_EASY
manufacturer: Proctor
category: Accessory
canonical_name: Proctor YouRippa Easy
...
# Proctor YouRippa Easy

## Purpose of this file

This is the canonical internal description for the Proctor YouRippa Easy family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor YouRippa Easy family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | 50 | 50000 x 50 | 1 |
| R0.1 | thermal_r_value | 60 | 50000 x 60 | 1 |
| R0.1 | thermal_r_value | 75 | 50000 x 75 | 1 |
...
### Within the Proctor YouRippa Easy family
...
| Requirement | Status for Proctor YouRippa Easy | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor YouRippa Easy is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
