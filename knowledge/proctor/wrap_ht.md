...
This is the canonical internal description for the ProctorWrap HT family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **ProctorWrap HT family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Reflective insulation product from Proctor.
- Material: Reflective Composite.
...
### Within the ProctorWrap HT family
...
| Requirement | Status for ProctorWrap HT | Enquiry-bot action |
| --- | --- | --- |
...
> ProctorWrap HT is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Roll out ProctorWrap HTR horizontally across rafters or trusses
starting from the eaves with printed face upward.
2. Ensure lower edge drains
freely into the roof gutter without creating a reverse lap or water trap.
3. Allow a nominal 40mm drape between framing members to facilitate drainage and
ventilation beneath battens.
4. Overlap consecutive upper sheets over lower
sheets by at least 150mm.
5. Secure temporarily with broad-headed galvanised
clouts, staples, or PlastiGrip washers before fixing battens.
6. Tape all laps
and penetrations with ProctorWrap HighTack PLUS Tape for enhanced airtightness
and weather sealing.
7. Provide a ventilated and drained cavity between the outer
membrane face and the underside of roof cladding.
8. Ensure compliant metal ember
guard mesh is installed at ridges, valleys, and eaves in BAL zones.

**Manufacturer-stated limitations**

- Does not
provide a reflective air-space R-value (non-reflective membrane).
- Must not be
laid in direct continuous contact with the underside of unvented metal roof
sheeting.
- Must not be left exposed to direct sunlight beyond manufacturer UV
limits prior to roof covering.
...
| --- | --- | --- |
| Material Structure | 3-ply spunbonded polyolefin membrane
with reinforcement scrim |  |
| Duty
Classification | Medium Duty | AS/NZS 4200.1:2017 |
...
| Roll Dimensions | 1500
mm width x 50 m length (75 m²) |  |
| Weight per
Roll | 18.5 kg |  |
