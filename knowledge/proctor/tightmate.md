---
id: proctor-tightmate
family_id: PROCTOR_TIGHTMATE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor TightMate
material: Accessory
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | Varies | Varies | 6 |
...
### Within the Proctor TightMate family
...
| Requirement | Status for Proctor TightMate | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor TightMate is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
