---
id: proctor-accessory
family_id: PROCTOR_ACCESSORY
manufacturer: Proctor
category: Accessory
canonical_name: Proctor Accessory
...
### Within the Proctor Accessory family
...
| Requirement | Status for Proctor Accessory | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Accessory is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure membrane and substrate surfaces are completely
dry, clean, and free of oil, grease, and dust.
2. Centre tape squarely over the
membrane overlap, corner seam, or penetration interface.
3. Apply tape without
tension, ensuring no wrinkles or air bubbles remain.
4. Press firmly along the
entire tape length using a hand-held squeegee or pressure roller to activate
adhesive.
5. For pipe and duct penetrations, cut overlapping collar strips to
form a continuous watertight seal.
6. Ensure materials are supported from behind
when applying pressure.

**Manufacturer-stated limitations**

- Pressure-sensitive tape requires firm
mechanical squeegee pressure for full adhesive bonding.
- Not a substitute for
mechanical fasteners; all structural loads must be carried by framing fixings.
...
| Adhesive Type | Vapour-open acrylic or aggressive
butyl pressure-sensitive adhesive |  |
| Peel
Adhesion | ≥ 45 N / 25mm (HighTack PLUS), ≥ 25 N / 25mm (UV Tape) | EN 1939 |
| Roll Widths | 50 mm, 60 mm, 75
mm, 100 mm, 150 mm |  |
| Roll Lengths | 25 m, 30 m, 50 m |  |
| Application Temperature | +5°C to +40°C |  |
| Operating
Temperature | -40°C to +80°C (up to +100°C) |  |
| Vapour Permeance | Available in Vapour Permeable
(DriFlash/Wraptite) and Vapour Barrier (AB Tape) | ASTM E96 |
