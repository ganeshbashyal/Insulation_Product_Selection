---
id: proctor-gable-vent
family_id: PROCTOR_GABLE_VENT
manufacturer: Proctor
category: Accessory
canonical_name: Proctor Gable Vent
material: Ventilation Accessory
...
This is the canonical internal description for the Proctor Gable Vent family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Gable Vent family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | 550 | 580 x 550 | 1 |
| R0.1 | thermal_r_value | 450 | 620 x 450 | 1 |
...
### Within the Proctor Gable Vent family
...
| Requirement | Status for Proctor Gable Vent | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Gable Vent is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
