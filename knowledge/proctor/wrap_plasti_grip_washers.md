---
id: proctor-wrap-plasti-grip-washers
family_id: PROCTOR_WRAP_PLASTI_GRIP_WASHERS
manufacturer: Proctor
category: Wrap
canonical_name: ProctorWrap Plasti-Grip Washers
material: Accessory
...
This is the canonical internal description for the ProctorWrap Plasti-Grip Washers family (Wrap category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **ProctorWrap Plasti-Grip Washers family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet the demanding requirements of Australian building conditions. Manufacturer-published features and benefits include: Purpose-designed accessory for insulation systems; compatible with specified insulation products; maintains system integrity and performance This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Wrap insulation product from Proctor.
- Material: Accessory.
...
### Within the ProctorWrap Plasti-Grip Washers family

- Wall Wrap / Sarking

### Separate product families

Do not transfer claims from this family to other Proctor product families without their own current technical evidence. Where Proctor sells multiple product families within the Wrap category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for ProctorWrap Plasti-Grip Washers | Enquiry-bot action |
| --- | --- | --- |
...
> ProctorWrap Plasti-Grip Washers is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Position
building wrap or rigid insulation board flat against timber or steel wall
framing.
2. Insert 8g-10g countersunk screw (for steel) or flat-head clout nail
(for timber) through the PlastiGrip washer center.
3. Fasten through the membrane
into the structural stud at recommended 600mm horizontal by 750mm vertical
spacing.
4. Tighten screws only sufficiently to apply clamping force around the
perimeter of the washer.
5. Do not over-tighten to avoid distorting the washer,
membrane, or substrate.
6. If a washer is damaged or cracked as a result of
over-tightening, replace it prior to project completion.
7. Use
corrosion-resistant screws or galvanised nails.

**Manufacturer-stated limitations**

- Do not
over-tighten fasteners; excessive torque can crack the washer or distort the
substrate.
- Not recommended for permanent exposure to direct sunlight after
installation.
- Cladding must be installed within the UV exposure window of the
underlying membrane.
...
| Fastener Compatibility | 8g - 10g countersunk screws
(steel) or flat head galvanised clouts (timber) |  |
| Recommended Spacing | 600 mm horizontal x 750 mm vertical
(approx. 4 washers per m²) |  |
| Insulation
Compatibility | Rigid foam boards, semi-rigid insulation, pliable
building wraps |  |
