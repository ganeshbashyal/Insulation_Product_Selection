---
id: proctor-yourippa-curing-tape
family_id: PROCTOR_YOURIPPA_CURING_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor YouRippa Curing Tape
...
This is the canonical internal description for the Proctor YouRippa Curing Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor YouRippa Curing Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Proctor YouRippa Curing Tape family
...
| Requirement | Status for Proctor YouRippa Curing Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor YouRippa Curing Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure floor protection sheets, concrete, or
surfaces are clean, dry, and free of dust.
2. Lay out floor protection boards or
curing covers with butted edges.
3. Tear YouRippa tape by hand across the roll to
desired length.
4. Center tape over the seam between protection sheets.
5. Press
down firmly along the tape line to activate adhesive.
6. Smooth down edges to
prevent tripping hazards during foot traffic.
7. Peel tape cleanly away upon
project handover without leaving adhesive residue.

**Manufacturer-stated limitations**

- Temporary protection
tape; not designed for permanent building envelope weather-sealing.
- Do not
leave on sensitive timber finishes beyond recommended removal period.
- Not an
air-barrier or vapour-permeable membrane joining tape.
...
| --- | --- | --- |
| Carrier | Embossed polyethylene
cloth backing |  |
| Adhesive Type | Natural rubber based adhesive |  |
| Roll Width | 48 mm / 50 mm |  |
| Roll Length | 25 m |  |
| Hand Tearable | Yes
(straight tear by hand) |  |
| Residue Free
Removal | Leaves no residue upon removal on approved substrates |  |
