---
id: proctor-passive-driflash-tape
family_id: PROCTOR_PASSIVE_DRIFLASH_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor Passive DriFlash Tape
...
# Proctor Passive DriFlash Tape

## Purpose of this file

This is the canonical internal description for the Proctor Passive DriFlash Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Passive DriFlash Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Proctor Passive DriFlash Tape family
...
| Requirement | Status for Proctor Passive DriFlash Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Passive DriFlash Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure substrate is dry, clean, dust-free, and free of oil, grease, or loose
particles.
2. Measure and cut tape to required length allowing for overlaps at
corners.
...
5. Remove the remaining split release liner while smoothing the tape onto the
adjacent surface.
6. Press firmly along the entire tape length using a hand
roller or squeegee to achieve 100% adhesion.
7. Ensure corner joins overlap by a
minimum of 50mm.
8. Apply in dry weather within the temperature range of -10°C to
+40°C.

**Manufacturer-stated limitations**

- Do not apply over wet, frozen, or
heavily contaminated surfaces.
- Pressure-sensitive adhesive requires firm
rolling for complete mechanical bond.
- Must not be permanently exposed to UV
weather beyond manufacturer limits.
...
| --- | --- | --- |
| Carrier | Vapour
permeable polyolefin fleece |  |
| Adhesive | Solvent-free polyacrylic |  |
| Roll
Dimensions | 75 mm x 25 m, 100 mm x 25 m, 150 mm x 25 m |  |
