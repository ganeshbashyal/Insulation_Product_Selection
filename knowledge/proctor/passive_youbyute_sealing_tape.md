---
id: proctor-passive-youbyute-sealing-tape
family_id: PROCTOR_PASSIVE_YOUBYUTE_SEALING_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: ProctorPassive YouByute Sealing Tape
...
# ProctorPassive YouByute Sealing Tape

## Purpose of this file

This is the canonical internal description for the ProctorPassive YouByute Sealing Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **ProctorPassive YouByute Sealing Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | 50 | 20000 (width varies) | 1 |
...
### Within the ProctorPassive YouByute Sealing Tape family
...
| Requirement | Status for ProctorPassive YouByute Sealing Tape | Enquiry-bot action |
| --- | --- | --- |
...
> ProctorPassive YouByute Sealing Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
