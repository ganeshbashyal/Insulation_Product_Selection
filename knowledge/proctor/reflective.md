---
id: proctor-reflective
family_id: PROCTOR_REFLECTIVE
manufacturer: Proctor
category: Reflective
canonical_name: Proctor Reflective
...
| Rw 35 | acoustic_rw | Varies | 30000 x 3000 | 1 |
...
| Requirement | Status for Proctor Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Reflective is a manufacturer-supported product family used for both thermal insulation (R-value) and acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
