---
id: proctor-passive-smartvap
family_id: PROCTOR_PASSIVE_SMARTVAP
manufacturer: Proctor
category: Membrane
canonical_name: Proctor Passive SmartVap
material: Membrane
...
This is the canonical internal description for the Proctor Passive SmartVap family (Membrane category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Passive SmartVap family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Membrane insulation product from Proctor.
- Material: Membrane.
...
### Within the Proctor Passive SmartVap family

- Passive House Membrane

### Separate product families

Do not transfer claims from this family to other Proctor product families without their own current technical evidence. Where Proctor sells multiple product families within the Membrane category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Proctor Passive SmartVap | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Passive SmartVap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install on the warm
interior side of wall framing or ceiling joists over bulk insulation.
2. Fix
tautly across studs or rafters with staples or clouts at 150mm centres.
3. Ensure
printed side faces inward toward the interior living space.
4. Overlap
consecutive sheets by a minimum of 100mm.
5. Tape all overlaps with an airtight
tape such as Wraptite Tape or DriFlash Tape.
6. Seal membrane securely to
adjoining concrete floors, window frames, and ceilings with compatible
adhesives.
7. Seal all pipe, duct, and electrical cable penetrations with
flexible airtight grommets or tape.
8. Install interior plasterboard or timber
lining over the membrane using battened service cavities.

**Manufacturer-stated limitations**

- Internal application only; not for
external weather-facing envelope installation.
- Do not leave exposed to
interior UV sunlight for longer than 60 days before lining.
- Must not be
punctured without subsequent airtight taping.
...
| --- | --- | --- |
| Material | Spunbonded polyolefin with
functional moisture-variable polymer coating |  |
| Duty Classification | Medium Duty | AS/NZS 4200.1:2017 |
| Vapour Permeance (Smart Range) | 0.26 µg/N·s to 1.70
µg/N·s (Variable Sd 0.2 m to 50 m+) | EN 12572 / ASTM E96 |
| Air Control | Air Barrier | AS/NZS 4200.1:2017 |
| Water Control | Non-Water
Barrier (Internal use only) | AS/NZS 4201.4 |
