---
id: proctor-yourippa-protect-tape
family_id: PROCTOR_YOURIPPA_PROTECT_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor YouRippa Protect Tape
...
### Within the Proctor YouRippa Protect Tape family
...
| Requirement | Status for Proctor YouRippa Protect Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor YouRippa Protect Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure floor protection sheets, concrete, or finishes are dry and free of
loose grit and dust.
2. Lay out floor protection boards, hardboard, or concrete
curing blankets with tightly butted edges.
3. Tear YouRippa tape cleanly by hand
across the roll to the required length.
4. Centre the tape directly over the seam
between adjacent protection sheets.
5. Press down firmly along the tape line
using hand pressure or a squeegee.
6. Ensure all edges are flat to eliminate
tripping hazards from foot traffic.
7. Peel tape cleanly away upon project
handover without leaving sticky residue.

**Manufacturer-stated limitations**

- Temporary protection tape; not designed for permanent building
envelope weather-sealing.
- Do not leave on sensitive porous timber finishes
beyond recommended removal period.
- Not a vapour-permeable building wrap
joining tape.
...
| Adhesive Type | Natural rubber based
adhesive |  |
| Roll Width | 48 mm / 50
mm |  |
| Roll Length | 25 m |  |
| Hand Tearable | Yes (bi-directional straight hand
tear) |  |
| Residue Removal | Clean
residue-free removal on recommended surfaces |  |
