---
id: proctor-membrane
family_id: PROCTOR_MEMBRANE
manufacturer: Proctor
category: Membrane
canonical_name: Proctor Membrane
material: Membrane
...
This is the canonical internal description for the Proctor Membrane family (Membrane category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Membrane family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | Varies | 50000 x 1500 | 2 |
...
### Within the Proctor Membrane family
...
| Requirement | Status for Proctor Membrane | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Membrane is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
