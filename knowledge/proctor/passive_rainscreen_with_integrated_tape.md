---
id: proctor-passive-rainscreen-with-integrated-tape
family_id: PROCTOR_PASSIVE_RAINSCREEN_WITH_INTEGRATED_TAPE
manufacturer: Proctor
category: Accessory
canonical_name: Proctor Passive Rainscreen with Integrated Tape
...
# Proctor Passive Rainscreen with Integrated Tape

## Purpose of this file

This is the canonical internal description for the Proctor Passive Rainscreen with Integrated Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Proctor Passive Rainscreen with Integrated Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Accessory insulation product from Proctor.
- Material: Tape / Sealant.
...
### Within the Proctor Passive Rainscreen with Integrated Tape family

- Passive House Membrane

### Separate product families

Do not transfer claims from this family to other Proctor product families without their own current technical evidence. Where Proctor sells multiple product families within the Accessory category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Proctor Passive Rainscreen with Integrated Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Proctor Passive Rainscreen with Integrated Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install horizontally over wall framing or
external rigid sheathing with black face outward.
2. Fix mechanically using
broad-head screws with washers or cap nails at maximum 300mm centres.
3. Ensure
horizontal runs overlap by a minimum of 150mm.
4. Peel back release liner from
the integrated adhesive tape on the overlapping edges.
5. Press the two
integrated tape strips firmly together using a squeegee to form an airtight
bond.
6. Stagger vertical joints by minimum 150mm over a stud and seal with
compatible black rainscreen tape.
7. Seal all window, door, and service
penetrations to complete the continuous weather envelope.
8. Ensure facade
cladding open gaps do not exceed 50mm width or 40% open area.

**Manufacturer-stated limitations**

- Do not exceed maximum 50mm gap
width or 40% open area in facade cladding.
- Must be separated from cladding by
an unblocked drainage cavity.
- Not designed for roof sarking or horizontal
applications.
...
| Air Control | Air
Barrier | AS/NZS 4200.1:2017 |
| Flammability
Index | ≤ 5 | AS 1530.2 |
| UV
Resistance | Permanent exposure behind open joints up to 50 mm wide
/ 40% open area |  |
