---
id: thermotec-nuwave-fence-mlv
family_id: THERMOTEC_NUWAVE_FENCE_MLV
manufacturer: Thermotec Australia
product_family: NuWave UV-treated Fence MLV
category: Outdoor acoustic barrier
validation_status: secondary_owned_source_only
last_validated: 2026-09-03
---

# NuWave UV-treated Fence MLV

## Bot-ready summary

An owned-site legacy page describes a UV-treated NuWave mass loaded vinyl configuration for acoustic fence and outdoor barrier applications. A current Thermotec manufacturer page and current availability have not yet been confirmed, so the bot may identify this as a possible family but must route it to a person before selection or quotation.

An acoustic fence works as a complete barrier: height, continuity, gaps, line of sight, structure, wind loading and the position of the source and receiver all matter. The sheet's three fence records must not inherit the base indoor NuWave grade table without product-specific evidence.

## Required questions

- What is the noise source and where are the source and receiver?
- What fence height, length, support and wind exposure are proposed?
- Will the material remain continuously exposed to sun and weather?
- Is current stock or a made-to-order supply route confirmed?

## Human review gates

- Confirm the current Thermotec product identity, technical data and availability.
- Review the complete fence/barrier design and structural support.
- Do not make BAL, fire or installed acoustic-performance claims without project evidence.
- Do not advise treating ordinary indoor MLV as an outdoor equivalent.
