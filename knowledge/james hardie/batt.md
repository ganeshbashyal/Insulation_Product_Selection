---
id: james-hardie-batt
family_id: JAMES_HARDIE_BATT
manufacturer: James Hardie
category: Batt
canonical_name: James Hardie Batt
material: Stonewool
...
This is the canonical internal description for the James Hardie Batt family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **James Hardie Batt family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
Do not transfer claims from this family to other James Hardie product families without their own current technical evidence. Where James Hardie sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for James Hardie Batt | Enquiry-bot action |
| --- | --- | --- |
...
> James Hardie Batt is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
