---
id: james-hardie-fire-rockwool
family_id: JAMES_HARDIE_FIRE_ROCKWOOL
manufacturer: James Hardie
category: Batt
canonical_name: JAMES HARDIEFIRE ROCKWOOl
material: Stonewool
...
priority_energy_efficiency_score: 2
...
official_datasheet_url: https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf
official_sds_url: https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf
product_count: 5
rating_basis: unspecified
---

# JAMES HARDIEFIRE ROCKWOOl

## Purpose of this file

This is the canonical internal description for the JAMES HARDIEFIRE ROCKWOOl family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **JAMES HARDIEFIRE ROCKWOOl family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Made from natural volcanic rock, delivering superior fire resistance and acoustic performance that lasts the lifetime of the building. Specialised widths suit narrow party wall cavities in modular construction. Non-combustible construction meets fire-rating requirements for separating walls. Manufacturer-published features and benefits include: Non-combustible stonewool made from natural volcanic rock; superior fire resistance up to 1000°C; excellent acoustic absorption properties; fully recyclable at end of life; helps achieve NCC acoustic separation requirements; available in specialised widths for modular construction; fire-rated construction for FRL requirements; BCA compliant fire ratings This family covers 5 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Batt insulation product from James Hardie.
- Material: Stonewool.
- Rating basis: thermal and/or acoustic performance (rating not yet confirmed per SKU).
...
### Within the JAMES HARDIEFIRE ROCKWOOl family

- Party Wall Fire

### Separate product families

Do not transfer claims from this family to other James Hardie product families without their own current technical evidence. Where James Hardie sells multiple product families within the Batt category or in other categories, each is a distinct family with its own grade table and evidence.
...
- for fire-rated applications, install per tested system specification.
...
| Energy efficiency | 2/5 | Medium | Based on thermal and/or acoustic performance (rating not yet confirmed per SKU); confirm per-SKU rating before quoting a thermal target. |
...
| Requirement | Status for JAMES HARDIEFIRE ROCKWOOl | Enquiry-bot action |
| --- | --- | --- |
...
> JAMES HARDIEFIRE ROCKWOOl is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf

Safety Data Sheet: https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf
...
```json
{
  ...
  "recommendation_allowed": true,
  "recommendation_scope": "manufacturer_supported_family_only",
  "primary_function": "thermal and/or acoustic performance (rating not yet confirmed per SKU)",
  "material": "Stonewool",
  "applications": [
    "Party Wall Fire"
  ],
  ...
  "source_url": "https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf |
| Material composition | Manufacturer-claimed | https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://www.jameshardie.com.au/ContentfulCMS/Installation-Guide/Hardie_Wrap_Weather_Barrier_Installation_Guide.pdf |
...
1. Store
HardieFire insulation in an internal dry area protected from weather and
moisture prior to installation.
2. Frame wall with timber or steel studs at 450mm
or 600mm centers.
3. Cut batts outdoors or in ventilated areas using a mechanical
hand saw or reciprocating saw.
4. Add 5mm to measured dimensions when cutting to
maintain the mandatory 5mm compression.
5. Friction-fit batts firmly into stud
bays ensuring minimum 5mm compression vertically and horizontally.
6. Ensure
there are no gaps, folds, or voids at junctions, corners, or behind noggings.
7. Wear protective glasses, gloves, and P1/P2 dust mask during handling.

**Manufacturer-stated limitations**

- Must not be exposed to weather or installed
while wet; not designed for prolonged exterior exposure.
- Must be installed
with 5mm compression in both directions to maintain certified FRL.
- Must be
used as part of complete HardieSmart tested systems to achieve warranty and
...
| --- | --- | --- |
| Material | Mineral wool (rock
wool >95%, cured binder 1-5%) |  |
| Nominal
Density | 80 kg/m³ |  |
| Thicknesses | 60 mm, 85 mm |  |
| Dimensions | 420 mm x 1160 mm (for 450mm stud centres), 560 mm x 1160 mm (for 600mm stud
centres) |  |
| Thermal Resistance (R-value) | R1.7 (60mm), R2.5 (85mm) | AS/NZS 4859.1 |
| Fire Resistance Level (FRL) | Up to 60/60/60 (Boundary
Wall / ZeroLot) and -/60/60 | AS 1530.4 |
| Acoustic
Performance | Rw 47 to 50+ (system rating) | AS/NZS
ISO 717.1 |
| Bushfire Rating | Suitable up to BAL-FZ
(Flame Zone) | AS 3959 |
| Installation
Compression | Minimum 5 mm compression along all sides (5mm wider and
longer than stud bay) |  |
