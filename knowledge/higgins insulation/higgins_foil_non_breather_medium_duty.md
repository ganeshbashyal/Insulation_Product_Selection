---
id: higgins-insulation-higgins-foil-non-breather-medium-duty
family_id: HIGGINS_INSULATION_HIGGINS_FOIL_NON_BREATHER_MEDIUM_DUTY
manufacturer: Higgins Insulation
category: Reflective
canonical_name: Higgins Insulation Higgins Foil Non Breather Medium Duty
material: Foil
...
# Higgins Insulation Higgins Foil Non Breather Medium Duty

## Purpose of this file

This is the canonical internal description for the Higgins Insulation Higgins Foil Non Breather Medium Duty family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Higgins Insulation Higgins Foil Non Breather Medium Duty family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Reflects up to 97% of radiant heat, reducing summer cooling costs. Manufacturer-published features and benefits include: High-purity aluminium reflective facing; reflects up to 97% of radiant heat; lightweight and easy to install; provides vapour barrier when properly sealed This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Reflective insulation product from Higgins Insulation.
- Material: Foil.
...
### Within the Higgins Insulation Higgins Foil Non Breather Medium Duty family

- Non-Breather Wall Wrap / Sarking

### Separate product families

Do not transfer claims from this family to other Higgins Insulation product families without their own current technical evidence. Where Higgins Insulation sells multiple product families within the Reflective category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Higgins Insulation Higgins Foil Non Breather Medium Duty | Enquiry-bot action |
| --- | --- | --- |
...
> Higgins Insulation Higgins Foil Non Breather Medium Duty is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf

Safety Data Sheet: https://db4dv8bb88ruo.cloudfront.net/media/ListingAdditions/Document/5/0/2/0/7/5/aexx9wdzrze9.pdf
...
```json
{
  ...
  "source_url": "https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf |
| Material composition | Manufacturer-claimed | https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf |
...
1. Fix horizontally across the outside face of
wall framing studs starting from the bottom plate.
2. Fasten with galvanized
clouts or staples at maximum 300mm centers to studs and plates.
3. Overlap
successive upper sheets over lower sheets by at least 150mm to shed water
downward.
4. Ensure a sealed still airspace of at least 20mm exists adjacent to
the foil surface.
5. Tape all horizontal and vertical laps with reinforced
aluminum foil tape to form a continuous vapor seal.
6. Seal tightly around all
wall penetrations, window frames, and doors.
7. Cover with external cladding
within manufacturer-specified UV exposure limits.

**Manufacturer-stated limitations**

- Do not use on external
walls in cold climate zones (Zones 6-8) where internal moisture must escape
through breathable wraps.
- Not designed as primary roof sarking.
- Must not be
left exposed to continuous outdoor weather without cladding.
...
| --- | --- | --- |
| Material Structure | Five-layer solid
laminate of UV-stabilized woven polypropylene and pure aluminum foil |  |
| Duty Classification | Medium Duty | AS/NZS 4200.1 |
| Vapor Barrier Classification | Class 1 or 2 Vapor Barrier (impermeable) | AS/NZS 4200.1 |
| Reflectivity | 97% radiant heat reflectivity
(emittance 0.03) | AS/NZS 4201.5 |
| Roll
Dimensions | 1350 mm width x 60 m length (81 m² per roll) |  |
| Water Control | Water Barrier | AS/NZS 4201.4 |
| Flammability | Complies
with Australian Fire Standard AS 1530 | AS 1530 |
