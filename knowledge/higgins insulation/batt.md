---
id: higgins-insulation-batt
family_id: HIGGINS_INSULATION_BATT
manufacturer: Higgins Insulation
category: Batt
canonical_name: Higgins Insulation Batt
material: Polyester
...
| Requirement | Status for Higgins Insulation Batt | Enquiry-bot action |
| --- | --- | --- |
...
> Higgins Insulation Batt is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Isolate electrical power at the main switchboard before
entering ceiling or working in wall cavities.
2. Select batt width (430mm
or 580mm) to suit timber or steel framing spacing (450mm or 600mm).
3. In
ceilings, lay batts flat between ceiling joists ensuring complete coverage over
plasterboard without gaps.
4. In walls, friction-fit batts firmly between studs
ensuring batts butt tightly against top and bottom plates.
5. Do not compress
batts into cavities narrower than nominal thickness.
6. Maintain minimum 50mm
clearance around non-IC rated recessed downlights and heat sources as per
AS 3999.
7. At roof eaves, ensure insulation does not block natural roof
ventilation pathways.
8. Tear batts across the width by hand or cut with a sharp
serrated knife if custom sizing is needed.

**Manufacturer-stated limitations**

- Do not compress batts
significantly as this degrades thermal R-value.
- Not designed for exposed
decorative finishes; must be enclosed behind plasterboard or internal linings.
...
| --- | --- | --- |
| Material Composition | 100% thermally bonded polyester fiber (up
to 85% recycled PET) |  |
| Ceiling R-Values | R2.5, R3.0, R3.5, R4.0, R4.5, R5.0 | AS/NZS 4859.1 |
| Wall R-Values | R1.5, R2.0, R2.5 | AS/NZS 4859.1 |
| Ceiling Thicknesses | R2.5 (140mm),
R3.0 (165mm), R3.5 (185mm), R4.0 (200mm), R5.0 (230mm) |  |
| Wall Thicknesses | R1.5 (75mm), R2.0 (90mm), R2.5
(90mm) |  |
| Standard Dimensions | 1160
mm length x 430 mm or 580 mm width |  |
| Combustibility | Complies with AS 1530.3 fire indices
(0, 0, 0, 0-1) | AS 1530.3 |
| Moisture Absorption | < 0.2% by volume |  |
| Corrosion
Resistance | Non-corrosive, chemically inert | AS/NZS 4859.1 |
