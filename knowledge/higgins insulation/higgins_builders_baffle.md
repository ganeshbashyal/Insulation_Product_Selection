---
id: higgins-insulation-higgins-builders-baffle
family_id: HIGGINS_INSULATION_HIGGINS_BUILDERS_BAFFLE
manufacturer: Higgins Insulation
category: Batt
canonical_name: Higgins Insulation Higgins Builders Baffle
material: Polyester
...
This is the canonical internal description for the Higgins Insulation Higgins Builders Baffle family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Higgins Insulation Higgins Builders Baffle family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Safe to handle without gloves or masks. Made from recycled plastic bottles for sustainability. Perfect for maximum thermal performance in roof/ceiling applications. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet; excellent thermal performance for roof/ceiling applications This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Higgins Insulation Higgins Builders Baffle family
...
| Requirement | Status for Higgins Insulation Higgins Builders Baffle | Enquiry-bot action |
| --- | --- | --- |
...
> Higgins Insulation Higgins Builders Baffle is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
cavity void above the fire-rated party wall or inter-tenancy partition.
2. Position Builders Acoustic Baffle directly above the wall line spanning from
the top plate to the underside of roof cladding.
3. Ensure the baffle compresses
snugly against rafters, purlins, and ceiling linings without gaps.
4. Overlap or
butt adjoining baffle blocks tightly together to eliminate acoustic flanking
paths.
5. Secure in place using friction-fit pressure or mechanical
fasteners/strapping where required.
6. Ensure baffle does not obstruct mandatory
roof space ventilation pathways.

**Manufacturer-stated limitations**

- Indoor ceiling space use only;
not for direct external weather exposure.
- Does not substitute for fire-rated
stonewool where a specific FRL is required by structural engineers.
- Ensure
proper clearances around non-IC rated light fittings and hot flues.
...
| --- | --- | --- |
| Material | 100%
thermally bonded polyester fiber (up to 85% recycled PET) |  |
| Nominal Density | High-density acoustic polyester
formulation |  |
| Dimensions | Pre-cut
baffle blocks or continuous rolls to suit cavity widths |  |
| Fire Hazard Indices | Ignitability: 0, Spread of
Flame: 0, Heat Evolved: 0, Smoke Developed: 0-1 | AS/NZS 1530.3 |
| Moisture Absorption | < 0.2% by volume |  |
| Corrosion Resistance | Zero chlorides,
non-corrosive |  |
| Ozone Depletion Potential | Zero ODP |  |
| Volatile Organic
Compounds | Low / negligible VOCs |  |
