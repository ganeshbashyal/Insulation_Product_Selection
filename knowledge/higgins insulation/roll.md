---
id: higgins-insulation-roll
family_id: HIGGINS_INSULATION_ROLL
manufacturer: Higgins Insulation
category: Roll
canonical_name: Higgins Insulation Roll
material: Polyester
...
| Requirement | Status for Higgins Insulation Roll | Enquiry-bot action |
| --- | --- | --- |
...
> Higgins Insulation Roll is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Measure stud or joist bay
width (450mm or 610mm).
2. Unroll the polyester sound blanket vertically or
horizontally along framing bays.
3. Friction-fit between timber or steel studs,
or secure to floor joists from below.
4. Cut roll to length using a sharp utility
knife or heavy-duty scissors.
5. Ensure continuous coverage with tightly butted
ends and no gaps.
6. Enclose behind wall, ceiling, or floor linings promptly
after installation.

**Manufacturer-stated limitations**

- Indoor use only; not for
direct external weather exposure.
- Avoid excessive compression beyond cavity
depth.
...
| --- | --- | --- |
| Material Composition | 100% thermally bonded polyester
fiber (80% recycled PET) |  |
| Thickness Options | 50 mm, 65 mm, 75 mm, 85 mm, 100 mm |  |
| Width Options | 450 mm, 610 mm |  |
| Roll Coverage (50mm) | 20.25 m² (450mm width) / 18.30 m² (610mm
width) |  |
| Roll Length (50mm) | 15 m
(15000 mm) |  |
