---
id: higgins-insulation-acoustic-sheet
family_id: HIGGINS_INSULATION_ACOUSTIC_SHEET
manufacturer: Higgins Insulation
category: Acoustic Sheet
canonical_name: Higgins Insulation Acoustic Sheet
material: Polyester
...
# Higgins Insulation Acoustic Sheet

## Purpose of this file

This is the canonical internal description for the Higgins Insulation Acoustic Sheet family (Acoustic Sheet category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Higgins Insulation Acoustic Sheet family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Safe to handle without gloves or masks. Made from recycled plastic bottles for sustainability. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet This family covers 11 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Acoustic Sheet insulation product from Higgins Insulation.
- Material: Polyester.
...
| --- | --- | ---: | --- | ---: |
| R1.5 | thermal_r_value | 50 | Varies | 3 |
| R1.5 | thermal_r_value | 100 | Varies | 3 |
...
### Within the Higgins Insulation Acoustic Sheet family

- Cut to Size Acoustic Treatment

### Separate product families

Do not transfer claims from this family to other Higgins Insulation product families without their own current technical evidence. Where Higgins Insulation sells multiple product families within the Acoustic Sheet category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Higgins Insulation Acoustic Sheet | Enquiry-bot action |
| --- | --- | --- |
...
> Higgins Insulation Acoustic Sheet is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://higginsinsulation.com.au/wp-content/uploads/2019/10/FI96-HDEI-Insulation-Technical-Data-Sheet.pdf
