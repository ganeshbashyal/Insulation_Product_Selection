---
id: sonata-acoustic-panels-panel
family_id: SONATA_ACOUSTIC_PANELS_PANEL
manufacturer: Sonata Acoustic Panels
category: Panel
canonical_name: Sonata Acoustic Panels Panel
...
# Sonata Acoustic Panels Panel

## Purpose of this file

This is the canonical internal description for the Sonata Acoustic Panels Panel family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Sonata Acoustic Panels Panel family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
Do not transfer claims from this family to other Sonata Acoustic Panels product families without their own current technical evidence. Where Sonata Acoustic Panels sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Sonata Acoustic Panels Panel | Enquiry-bot action |
| --- | --- | --- |
...
> Sonata Acoustic Panels Panel is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
