---
id: sonata-acoustic-panels-sonata-recital-core
family_id: SONATA_ACOUSTIC_PANELS_SONATA_RECITAL_CORE
manufacturer: Sonata Acoustic Panels
category: Panel
canonical_name: Sonata Acoustic Panels Sonata Recital Core
...
official_datasheet_url: https://sonataacousticpanels.com.au/
official_sds_url: https://sonataacousticpanels.com.au/
product_count: 48
rating_basis: thermal
---

# Sonata Acoustic Panels Sonata Recital Core

## Purpose of this file

This is the canonical internal description for the Sonata Acoustic Panels Sonata Recital Core family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Sonata Acoustic Panels Sonata Recital Core family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered for noise control, delivering acoustic separation for NCC compliance. Manufacturer-published features and benefits include: Engineered specifically for acoustic performance; high NRC/Rw ratings for effective sound control; suitable for commercial and residential applications This family covers 48 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Panel insulation product from Sonata Acoustic Panels.
- Material: Acoustic Panel.
...
- The catalogue includes 48 unique SKU variant(s) in this family.
...
### Within the Sonata Acoustic Panels Sonata Recital Core family

- Acoustic Treatment

### Separate product families

Do not transfer claims from this family to other Sonata Acoustic Panels product families without their own current technical evidence. Where Sonata Acoustic Panels sells multiple product families within the Panel category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Energy efficiency | 2/5 | Medium | Based on thermal insulation (R-value); confirm per-SKU rating before quoting a thermal target. |
| Acoustic comfort | 5/5 | Medium | Based on product category norms and any Rw/NRC ratings present in this family. |
...
| Requirement | Status for Sonata Acoustic Panels Sonata Recital Core | Enquiry-bot action |
| --- | --- | --- |
...
> Sonata Acoustic Panels Sonata Recital Core is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://sonataacousticpanels.com.au/

Safety Data Sheet: https://sonataacousticpanels.com.au/


> Datasheet link audited 2026-09-05: repointed to the verified manufacturer site. Exact product TDS deep link still to be sourced; legacy reference: https://www.acransoundcontrol.com.au/media/website_pages/noise-control-products/acoustic-panels/sonata_acoustic_panels.pdf
...
The master product catalogue provides current commercial records for 48 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
...
```json
{
  ...
  "source_url": "https://sonataacousticpanels.com.au/"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://sonataacousticpanels.com.au/ |
| Material composition | Manufacturer-claimed | https://sonataacousticpanels.com.au/ |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://sonataacousticpanels.com.au/ |
...
1. Ensure wall framing, ceiling grid, or structural substrate is
clean, dry, and structurally sound.
2. Select colour (black is standard behind
perforated panels to conceal framing; white or grey for light-reflecting
cavities).
3. Cut panels accurately to size using a sharp utility knife or
heavy-duty insulation shears.
4. Friction-fit panels into framing bays or
mechanically fix behind perforated ceiling/wall panels using insulation pins or
clips.
5. Butt panel edges tightly together to eliminate acoustic flanking gaps.
6. Install perforated timber slats, metal ceiling tiles, or acoustic panelling
directly in front of the Recital Core panels.
7. Ensure panels are not compressed
beyond specified cavity thickness.

**Manufacturer-stated limitations**

- Designed for semi-exposed applications only; not
suitable for decorative fully exposed wall finishes.
- Not suitable for external
applications exposed to UV radiation, moisture, or wind pressure.
- Do not
compress panels excessively as this degrades low-frequency acoustic absorption.
...
| --- | --- | --- |
| Material
Composition | Thermally bonded polyester fibre (recycled PET
content) |  |
| Density Options | 20
kg/m³, 32 kg/m³, 48 kg/m³, 60 kg/m³ |  |
| Thickness Options | 25 mm, 50 mm, 75 mm, 100 mm |  |
| Panel Dimensions | 1200 mm x 2400 mm |  |
| Colours | Black, White, Grey |  |
| Acoustic Performance | High sound absorption across low,
mid, and high frequencies (NRC up to 1.00+) | ISO 354 / AS ISO 354 |
| Fire Hazard Properties | Compliant with
AS/NZS 1530.3 fire indices | AS/NZS 1530.3 |
