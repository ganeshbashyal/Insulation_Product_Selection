---
id: misc-accessory
family_id: MISC_ACCESSORY
manufacturer: Misc
category: Accessory
canonical_name: Misc Accessory
...
| --- | --- | ---: | --- | ---: |
| R1.3 | thermal_r_value | 50 | Varies | 2 |
...
### Within the Misc Accessory family
...
| Requirement | Status for Misc Accessory | Enquiry-bot action |
| --- | --- | --- |
...
> Misc Accessory is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
