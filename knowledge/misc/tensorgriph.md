---
id: misc-tensorgriph
family_id: MISC_TENSORGRIPH
manufacturer: Misc
category: Accessory
canonical_name: Misc TensorgripH
...
This is the canonical internal description for the Misc TensorgripH family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Misc TensorgripH family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Accessory insulation product from Misc.
- Material: Tape / Sealant.
...
### Within the Misc TensorgripH family

- General Installation

### Separate product families

Do not transfer claims from this family to other Misc product families without their own current technical evidence. Where Misc sells multiple product families within the Accessory category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Energy efficiency | 1/5 | Medium | Based on thermal and/or acoustic performance (rating not yet confirmed per SKU); confirm per-SKU rating before quoting a thermal target. |
...
| Requirement | Status for Misc TensorgripH | Enquiry-bot action |
| --- | --- | --- |
...
> Misc TensorgripH is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Safety Data Sheet: https://pricewiseinsulation.com.au/wp-content/uploads/2022/12/Polyester-Solutions-Product-Data-Sheet-All-batts.pdf
...
1. Ensure sheet metal duct surface is
thoroughly clean, dry, and free of oil or grease.
2. Connect hose and spray gun
to the canister and fully open the valve.
3. Spray adhesive evenly over both the
sheet metal and the insulation backing.
4. Allow 1 to 3 minutes for adhesive to
become touch-dry with no transfer.
5. Position insulation carefully and press
into place on the duct surface.
6. Consolidate bond by rolling firmly with a hand
pressure roller across the entire surface.

**Manufacturer-stated limitations**

- Not recommended for standard EPS foam without verifying
compatibility.
- Ensure working area is well ventilated.
- Canisters must not be
stored below 10°C.
...
| --- | --- | --- |
| Adhesive
System | Pressurized canister contact spray adhesive |  |
| Packaging Formats | 500 ml aerosol, 22 L canister
(17 kg), 108 L canister |  |
| Drying Time | 1 - 3 minutes |  |
| Temperature
Resistance | Up to 105°C - 115°C |  |
