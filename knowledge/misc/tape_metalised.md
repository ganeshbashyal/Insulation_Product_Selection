---
id: misc-tape-metalised
family_id: MISC_TAPE_METALISED
manufacturer: Misc
category: Accessory
canonical_name: Misc Tape Metalised
...
This is the canonical internal description for the Misc Tape Metalised family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Misc Tape Metalised family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R1.2 | thermal_r_value | 48 | 50000 x 48 | 1 |
...
### Within the Misc Tape Metalised family
...
| Requirement | Status for Misc Tape Metalised | Enquiry-bot action |
| --- | --- | --- |
...
> Misc Tape Metalised is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://pricewiseinsulation.com.au/wp-content/uploads/2022/12/Polyester-Solutions-Product-Data-Sheet-All-batts.pdf
