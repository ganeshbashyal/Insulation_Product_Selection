...
manufacturer: Misc
category: Accessory
canonical_name: Misc Tensorgrip
...
This is the canonical internal description for the Misc Tensorgrip family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Misc Tensorgrip family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Misc Tensorgrip family
...
| Requirement | Status for Misc Tensorgrip | Enquiry-bot action |
| --- | --- | --- |
...
> Misc Tensorgrip is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure both
bonding surfaces are clean, dry, and free of grease, dust, and contaminants.
...
4. Apply an even,
uniform coat of adhesive achieving 80% to 100% surface coverage on both
substrates.
5. Allow adhesive to tack off for 1 to 3 minutes until dry to touch
with no transfer to knuckles.
6. Align materials accurately and press firmly
together.
7. Apply uniform pressure across the entire bond area using a hand-held
pressure roller.
...
- Do not
apply to wet, greasy, or frozen surfaces.
- Requires adequate ventilation during
application.
...
| --- | --- | --- |
| Adhesive Type | Synthetic polymer contact adhesive in
pressurized canister / aerosol |  |
| Packaging
Formats | 500 ml aerosol, 22 L canister (17 kg), 108 L canister |  |
| Flash-Off Time | 1 - 3 minutes
(depending on temperature and humidity) |  |
| Open
Time | Up to 30 - 60 minutes |  |
| Temperature Resistance | Up to 105°C - 120°C (depending on
formulation) |  |
| Coverage | Approx. 150
m² - 230 m² per 22L canister |  |
