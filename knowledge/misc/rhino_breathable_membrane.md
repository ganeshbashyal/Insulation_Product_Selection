---
id: misc-rhino-breathable-membrane
family_id: MISC_RHINO_BREATHABLE_MEMBRANE
manufacturer: Misc
category: Wrap
canonical_name: Misc Rhino Breathable Membrane
material: Membrane
...
# Misc Rhino Breathable Membrane

## Purpose of this file

This is the canonical internal description for the Misc Rhino Breathable Membrane family (Wrap category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Misc Rhino Breathable Membrane family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Wrap insulation product from Misc.
- Material: Membrane.
...
### Within the Misc Rhino Breathable Membrane family
...
| Requirement | Status for Misc Rhino Breathable Membrane | Enquiry-bot action |
| --- | --- | --- |
...
> Misc Rhino Breathable Membrane is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install horizontally on the outer face of timber or
steel wall studs starting from the bottom plate.
2. Fasten with broad-headed
galvanised clouts or staples at maximum 300mm centres.
3. Ensure upper runs
overlap lower runs by at least 150mm to shed water downward.
4. Overlap vertical
joins by minimum 150mm over a stud line.
5. Tape all horizontal and vertical
joins using approved vapour-permeable acrylic cloth tape.
6. Seal around window
and door openings and all service penetrations.
7. Provide a ventilated drainage
cavity between the membrane and exterior cladding.

**Manufacturer-stated limitations**

- Not designed for roof
sarking applications.
- Must not be left exposed to direct sunlight beyond
manufacturer UV limits.
- Ensure cladding provides an unobstructed drainage
cavity.
...
| Vapour
Control | Class 4 Vapour Permeable | AS/NZS 4200.1:2017 |
