---
id: misc-tensorgrip-h
family_id: MISC_TENSORGRIP_H
manufacturer: Misc
category: Accessory
canonical_name: Misc Tensorgrip H
...
This is the canonical internal description for the Misc Tensorgrip H family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Misc Tensorgrip H family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Misc Tensorgrip H family
...
| Requirement | Status for Misc Tensorgrip H | Enquiry-bot action |
| --- | --- | --- |
...
> Misc Tensorgrip H is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Clean sheet metal or substrate ensuring
it is free of oils, dust, and moisture.
2. Attach hose and spray gun to the
H-Series canister and open valve fully.
3. Hold spray gun 150mm to 200mm from the
surface.
4. Apply an even coat of adhesive to both the metal duct and insulation
backing.
5. Wait 1 to 3 minutes for adhesive to tack off until touch-dry.
6. Press
insulation firmly onto the metal duct surface within open time.
7. Apply pressure
across the entire surface using a hand roller to ensure complete bonding.

**Manufacturer-stated limitations**

- Not suitable for polystyrene foams unless specifically
formulated for EPS.
- Must be applied in well-ventilated areas.
- Do not store
or use below 10°C without warming canister.
...
rubber / polymer contact adhesive (canister spray) |  |
| Packaging Formats | 500 ml aerosol, 22 L canister (17
kg), 108 L canister |  |
| Drying Time | 1
- 3 minutes |  |
