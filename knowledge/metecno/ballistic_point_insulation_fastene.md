---
id: metecno-ballistic-point-insulation-fastene
family_id: METECNO_BALLISTIC_POINT_INSULATION_FASTENE
manufacturer: Metecno
category: Accessory
canonical_name: Metecno Ballistic Point Insulation Fastene
material: Accessory
...
# Metecno Ballistic Point Insulation Fastene

## Purpose of this file

This is the canonical internal description for the Metecno Ballistic Point Insulation Fastene family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Metecno Ballistic Point Insulation Fastene family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Accessory insulation product from Metecno.
- Material: Accessory.
...
| --- | --- | ---: | --- | ---: |
| R2.5 | thermal_r_value | 25 | Varies | 1 |
| R2.5 | thermal_r_value | 30 | Varies | 1 |
| R2.5 | thermal_r_value | 40 | Varies | 1 |
| R2.5 | thermal_r_value | 45 | Varies | 1 |
| R2.5 | thermal_r_value | 50 | Varies | 1 |
| R2.5 | thermal_r_value | 60 | Varies | 1 |
| R2.5 | thermal_r_value | 75 | Varies | 1 |
| R2.5 | thermal_r_value | 80 | Varies | 1 |
| R2.5 | thermal_r_value | 90 | Varies | 1 |
| R2.5 | thermal_r_value | 100 | Varies | 1 |
...
### Within the Metecno Ballistic Point Insulation Fastene family

- General Installation

### Separate product families

Do not transfer claims from this family to other Metecno product families without their own current technical evidence. Where Metecno sells multiple product families within the Accessory category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Metecno Ballistic Point Insulation Fastene | Enquiry-bot action |
| --- | --- | --- |
...
> Metecno Ballistic Point Insulation Fastene is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
