...
This is the canonical internal description for the Metecno Board family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.
...
Do not transfer claims from this family to other Metecno product families without their own current technical evidence. Where Metecno sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
