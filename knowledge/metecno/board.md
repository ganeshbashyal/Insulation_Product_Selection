---
id: metecno-board
family_id: METECNO_BOARD
manufacturer: Metecno
category: Board
canonical_name: Metecno Board
material: PIR
...
This is the canonical internal description for the Metecno Board family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Metecno Board family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Highest R-value per millimetre means more thermal performance in thinner profiles. Perfect when wall depth is limited. Rigid design makes installation fast and efficient - no sagging or falling out. Essential for achieving NCC compliance in floor applications. Manufacturer-published features and benefits include: Premium PIR rigid foam with excellent thermal efficiency; highest R-value per unit thickness in the market; fire-modified polyisocyanurate core; zero ODP, low GWP blowing agents; rigid design prevents sagging between joists; reduces drafts and cold floors; excellent thermal performance for roof/ceiling applications; helps meet NCC energy efficiency requirements This family covers 10 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Board insulation product from Metecno.
- Material: PIR.
- Rating basis: thermal insulation (R-value).
- Premium PIR rigid foam with excellent thermal efficiency.
- highest R-value per unit thickness in the market.
- fire-modified polyisocyanurate core.
- zero ODP, low GWP blowing agents.
...
| --- | --- | ---: | --- | ---: |
| R1.05 | thermal_r_value | 25 | 1200 (width varies) | 1 |
| R1.30 | thermal_r_value | 30 | 1200 (width varies) | 1 |
| R1.70 | thermal_r_value | 40 | 1200 (width varies) | 1 |
| R2.15 | thermal_r_value | 50 | 1200 (width varies) | 1 |
| R2.55 | thermal_r_value | 60 | 1200 (width varies) | 1 |
| R3.00 | thermal_r_value | 70 | 1200 (width varies) | 1 |
| R3.20 | thermal_r_value | 75 | 1200 (width varies) | 1 |
| R3.40 | thermal_r_value | 80 | 1200 (width varies) | 1 |
...
### Within the Metecno Board family

- Ceiling | Underfloor

### Separate product families

Do not transfer claims from this family to other Metecno product families without their own current technical evidence. Where Metecno sells multiple product families within the Board category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Metecno Board | Enquiry-bot action |
| --- | --- | --- |
...
> Metecno Board is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://metecno.com/
