---
id: metecno-accessory
family_id: METECNO_ACCESSORY
manufacturer: Metecno
category: Accessory
canonical_name: Metecno Accessory
material: Accessory
...
This is the canonical internal description for the Metecno Accessory family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Metecno Accessory family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet the demanding requirements of Australian building conditions. Manufacturer-published features and benefits include: Purpose-designed accessory for insulation systems; compatible with specified insulation products; maintains system integrity and performance This family covers 12 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
| Requirement | Status for Metecno Accessory | Enquiry-bot action |
| --- | --- | --- |
...
> Metecno Accessory is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
