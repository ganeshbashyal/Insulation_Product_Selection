---
id: metecno-aluminium-glass-foil-tape
family_id: METECNO_ALUMINIUM_GLASS_FOIL_TAPE
manufacturer: Metecno
category: Accessory
canonical_name: Metecno Aluminium Glass Foil Tape
...
# Metecno Aluminium Glass Foil Tape

## Purpose of this file

This is the canonical internal description for the Metecno Aluminium Glass Foil Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Metecno Aluminium Glass Foil Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| R2.5 | thermal_r_value | Varies | 50000 x 100 | 1 |
...
### Within the Metecno Aluminium Glass Foil Tape family
...
| Requirement | Status for Metecno Aluminium Glass Foil Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Metecno Aluminium Glass Foil Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
