---
id: stinger-ht
family_id: STINGER_HT
manufacturer: Stinger
category: Accessory
canonical_name: Stinger Ht
material: Accessory
...
This is the canonical internal description for the Stinger Ht family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Stinger Ht family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| Requirement | Status for Stinger Ht | Enquiry-bot action |
| --- | --- | --- |
...
> Stinger Ht is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
