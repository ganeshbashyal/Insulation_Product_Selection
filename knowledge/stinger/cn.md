...
priority_acoustic_comfort_score: 1
priority_acoustic_comfort_confidence: medium
priority_installation_practicality_score: 5
...
official_datasheet_url: https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf
official_sds_url: https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf
product_count: 1
...
This is the canonical internal description for the Stinger Cn family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Stinger Cn family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet the demanding requirements of Australian building conditions. Manufacturer-published features and benefits include: Quality insulation product for Australian building conditions; designed to meet NCC energy efficiency requirements This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Accessory insulation product from Stinger.
- Material: Accessory.
...
### Within the Stinger Cn family

- General Installation

### Separate product families

Do not transfer claims from this family to other Stinger product families without their own current technical evidence. Where Stinger sells multiple product families within the Accessory category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Energy efficiency | 1/5 | Medium | Based on thermal insulation (R-value); confirm per-SKU rating before quoting a thermal target. |
| Acoustic comfort | 1/5 | Medium | Based on product category norms and any Rw/NRC ratings present in this family. |
| Installation practicality | 5/5 | Medium | Based on manufacturer install notes above; confirm access and handling requirements per project. |

## Mandatory human-review gates

| Requirement | Status for Stinger Cn | Enquiry-bot action |
| --- | --- | --- |
...
> Stinger Cn is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf

Safety Data Sheet: https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf
...
```json
{
  ...
  "source_url": "https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf |
| Material composition | Manufacturer-claimed | https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://insulation.com.au/wp-content/uploads/2024/Brochure-Sisalation-Wrap-Selection-Guide-Consumer-Rev6-120825-web-1.pdf |
...
1. Connect CN100B tool to a clean, dry, regulated compressed air
supply set between 70 and 100 psi.
2. Open the nail canister and load a 200-nail
coil of STINGER 25mm ring-shank nails.
3. Open the cap basket, load a 200-cap
reel of 25mm collated plastic caps, and feed into the guide track.
4. Close and
latch both magazines securely.
5. Select desired firing mode: bumpfire for high
production speed or sequential for single-shot precision.
6. Position the
nosepiece perpendicular against the roof underlayment or housewrap over timber
substrate.
7. Depress safety contact and actuate trigger to drive the cap nail
flush against the membrane.
8. Adjust the tool-free depth-of-drive wheel so caps
seat firmly without overdriving or crushing.

**Manufacturer-stated limitations**

- Requires an air compressor and pneumatic hose on site.
- Must
only be operated with genuine STINGER 25mm NailPac fasteners.
- For timber
substrates only; not designed for steel framing or solid concrete.
...
| --- | --- | --- |
| Tool Weight | 2.3 kg (4.9
lbs) |  |
| Speed | Up to 5 cap nails per
second |  |
| Fastener Capacity | 200 caps
/ 200 nails |  |
| Cap Specification | 25
mm (1 in) full round plastic collated caps |  |
| Nail Specification | 25 mm (1 in) length x 2.1 mm (0.083 in) shank,
full round head, ring-shank | ASTM F1667 |
| Operating Air Pressure | 70 - 100 psi (4.8 - 6.9 bar) |  |
| Compatible Fasteners | STINGER 25mm NailPac
(#0136260 / #136262) | ASTM F1667 |
