...
This is the canonical internal description for the Stinger Ch family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Stinger Ch family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| Requirement | Status for Stinger Ch | Enquiry-bot action |
| --- | --- | --- |
...
> Stinger Ch is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Open the staple magazine at the base and insert a strip of STINGER 10mm
staples.
2. Open the cap gate, place a reel of 168 collated plastic caps into the
basket, and feed the lead cap into the guide.
3. Close and latch both magazines
securely before operation.
4. Hold the hammer handle firmly and pull the trigger
to advance a cap into the strike zone.
5. Strike the target building wrap or roof
underlayment firmly against the timber substrate with a standard hammer motion.
6. Ensure the staple drives fully through the center of the plastic cap flush
against the membrane.
7. Repeat across the wall or roof at the spacing
recommended by the membrane manufacturer (typically 300mm to 600mm centers).

**Manufacturer-stated limitations**

- Designed for
timber framing and wood substrates only; cannot penetrate steel framing or
masonry.
- Must be loaded exclusively with genuine STINGER 10mm StaplePac
fasteners.
- Not recommended where local high-wind codes mandate ring-shank
nails (use CN100B).
...
| Fastener
Capacity | 168 caps / 168 staples |  |
| Cap Specification | 25 mm (1 inch) full plastic collated caps |  |
| Staple Specification | 10 mm (3/8
inch) crown staples / A-11 style |  |
| Compatible
Fasteners | 10 mm STINGER StaplePac only (Part # 136420) | ASTM F1667 |
| Operation Type | Manual strike with
trigger cap feed (CH38-2) or automatic feed (CH38A) |  |
