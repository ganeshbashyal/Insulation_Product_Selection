---
id: bradford-anticon-roofing-blanket-heavy-duty-foil
family_id: BRADFORD_ANTICON_ROOFING_BLANKET_HEAVY_DUTY_FOIL
manufacturer: Bradford
category: Batt
canonical_name: Bradford Anticon Roofing Blanket - Heavy Duty Foil
...
### Within the Bradford Anticon Roofing Blanket - Heavy Duty Foil family
...
| Requirement | Status for Bradford Anticon Roofing Blanket - Heavy Duty Foil | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Anticon Roofing Blanket - Heavy Duty Foil is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure purlins
or rafters are clean and dry prior to blanket rollout.
2. Roll out Anticon Heavy
Duty over framing with the heavy-duty foil facing down toward the building
interior.
3. Allow a uniform sag of 25-40mm between purlins (up to 1200mm
centres) to ensure thermal recovery.
4. Lap adjacent blanket rolls by 150mm using
the pre-extended foil flap.
5. Tape all foil seams with Bradford 493 Reinforced
Aluminium Foil Tape using a plastic squeegee for an airtight seal.
6. Install
roof spacer systems (e.g. Ashgrid or SpacerX) over purlins if required to
prevent insulation pinch.
7. Fasten metal roof cladding immediately over the
blanket or spacer bars.

**Manufacturer-stated limitations**

- Do not install in wet weather; glasswool must
remain completely dry.
- Must be installed with foil facing downwards into the
roof space.
...
| Material R-values | Anticon 60 HD: R1.3 (60mm); Anticon 80 HD: R1.8
(80mm); Anticon 100 HD: R2.3 (100mm); Anticon 130 HD: R3.0 (130mm); Anticon 145
HD: R3.6 (145mm) | AS/NZS 4859.1:2018 |
| Blanket
Width | 1200 mm (plus 150 mm foil overlap extension) |  |
| Roll Lengths | 10 m, 12 m, 15 m, 20 m (custom
lengths available) |  |
...
| Bushfire
Rating | BAL 12.5 - BAL FZ | AS 3959 |
...
| Maximum Span Between Supports | Up to 1200 mm
centres without safety mesh support |  |
