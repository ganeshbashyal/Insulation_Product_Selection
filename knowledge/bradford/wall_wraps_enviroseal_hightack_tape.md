---
id: bradford-wall-wraps-enviroseal-hightack-tape
family_id: BRADFORD_WALL_WRAPS_ENVIROSEAL_HIGHTACK_TAPE
manufacturer: Bradford
category: Wrap
canonical_name: Bradford Wall Wraps - Enviroseal Hightack Tape
...
# Bradford Wall Wraps - Enviroseal Hightack Tape

## Purpose of this file

This is the canonical internal description for the Bradford Wall Wraps - Enviroseal Hightack Tape family (Wrap category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Wall Wraps - Enviroseal Hightack Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Wall Wraps - Enviroseal Hightack Tape family
...
| Requirement | Status for Bradford Wall Wraps - Enviroseal Hightack Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Wall Wraps - Enviroseal Hightack Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure surfaces to be taped are clean, dry, and free
of dust, grease, oil, and frost.
2. Position membrane overlap with a
minimum 150mm lap (or 50mm if taped per AS 4200.2).
3. Centre the 60mm HighTack
Tape squarely over the seam or penetration edge.
4. Apply tape smoothly avoiding
tension wrinkles and air bubbles.
5. Press down firmly along the entire tape
length using a plastic squeegee or pressure roller.
6. Seal around pipe and duct
penetrations by cutting overlapping collar strips.

**Manufacturer-stated limitations**

- Pressure-sensitive adhesive requires firm
squeegee pressure to activate bond.
- Must not be applied to wet, greasy, or
dusty substrates.
- Not intended for permanent outdoor UV exposure exceeding
membrane exposure limits.
...
| --- | --- | --- |
| Carrier Material | Reinforced
polyethylene / polyolefin film |  |
| Adhesive
Type | Solvent-free polyacrylic pressure-sensitive adhesive |  |
| Roll Dimensions | 60 mm width x 25 m
length |  |
