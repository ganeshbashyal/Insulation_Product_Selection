---
id: bradford-multitel-foil-faced
family_id: BRADFORD_MULTITEL_FOIL_FACED
manufacturer: Bradford
category: Batt
canonical_name: Bradford Multitel - Foil - Faced
...
### Within the Bradford Multitel - Foil - Faced family
...
| Requirement | Status for Bradford Multitel - Foil - Faced | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Multitel - Foil - Faced is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
2. Cut
Multitel blanket allowing sufficient length to wrap around duct perimeter
plus 50mm foil overlap.
3. Wrap blanket snugly around the duct with the foil
facing outward.
4. Seal all longitudinal and transverse foil seams with 75mm
Bradford reinforced aluminium foil tape.
5. Squeegee tape down firmly to ensure a
complete, airtight vapour seal.
6. Secure blanket with outward-clench staples,
tape, or plastic/metal strapping at 300-400mm centres.
7. Avoid compressing the
blanket significantly across corners to maintain rated thermal resistance.

**Manufacturer-stated limitations**

- For external duct wrap
only; not suitable as internal duct acoustic liner exposed to high-velocity
airflow (use Supertel/Flexitel).
- Operating temperature of foil facing must not
exceed 120°C.
- Must not be left exposed to direct sunlight (UV) or outdoor
weather without protective cladding.
...
| --- | --- | --- |
| Material | Bio-soluble glasswool (FBS-1)
with reinforced aluminium foil facing |  |
| Blanket
R-Values | R0.7 (25mm), R1.0 (38mm), R1.3 (50mm), R2.0 (75mm) | AS/NZS 4859.1 |
| Thickness Options | 25
mm, 38 mm, 50 mm, 75 mm |  |
| Roll Dimensions
(HVAC) | 1200 mm width x 7.5 m, 10 m, or 15 m length |  |
| Roll Dimensions (BAL 12.5-40) | 300 mm width x 20 m
length x 25 mm thickness |  |
| Nominal Density | Approx. 12-18 kg/m³ |  |
| Combustibility
(Core) | Non-combustible | AS 1530.1 |
| Early Fire Hazard Indices | Ignitability: 0, Spread of Flame: 0, Heat
