---
id: bradford-gold-hi-performance-batts
family_id: BRADFORD_GOLD_HI_PERFORMANCE_BATTS
manufacturer: Bradford
category: Batt
canonical_name: Bradford Gold Hi-Performance Batts
material: Glasswool
...
### Within the Bradford Gold Hi-Performance Batts family
...
| Requirement | Status for Bradford Gold Hi-Performance Batts | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Gold Hi-Performance Batts is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Isolate power at the main
switchboard before entering ceiling or working in wall cavities.
2. Fit HP batts
friction-tight between studs or ceiling joists with zero gaps.
3. Ensure
high-density wall batts remain flat without bulging plasterboard or breaching
outer cavity space.
4. Use R3.0 low-profile Gold Perimeter Batts around roof
eaves to avoid compression within 450mm of external walls.
5. Maintain required
clearances from non-IC downlights and flues per AS 3999.

**Manufacturer-stated limitations**

- Do not force thicker batts into shallower stud
cavities as plasterboard will bulge.
- Must be kept dry during transport,
...
| Wall HP R-Values | R2.0
HP (75mm), R2.2 HP (75mm), R2.5 HP (90mm), R2.7 HP (90mm) | AS/NZS 4859.1 |
| Perimeter HP R-Value | R3.0 (100mm
thickness, 400mm length) | AS/NZS 4859.1 |
| Ceiling
HP Thicknesses | R4.1 HP: 195 mm; R5.0 HP: 215 mm; R6.0 HP: 250 mm;
R7.0 HP: 290 mm |  |
| Wall HP Thicknesses | R2.0 HP: 75 mm; R2.2 HP: 75 mm; R2.5 HP: 90 mm; R2.7 HP: 90 mm |  |
| Standard Dimensions | 1160 mm length
x 430 mm or 580 mm width (perimeter: 400 x 430/580 mm) |  |
