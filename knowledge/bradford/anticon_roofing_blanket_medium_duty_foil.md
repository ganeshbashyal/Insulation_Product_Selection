---
id: bradford-anticon-roofing-blanket-medium-duty-foil
family_id: BRADFORD_ANTICON_ROOFING_BLANKET_MEDIUM_DUTY_FOIL
manufacturer: Bradford
category: Batt
canonical_name: Bradford Anticon Roofing Blanket - Medium Duty Foil
...
This is the canonical internal description for the Bradford Anticon Roofing Blanket - Medium Duty Foil family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Anticon Roofing Blanket - Medium Duty Foil family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. The firm friction fit design means batts stay in place permanently - no sagging or settling. Low itch formula makes installation more comfortable than ever. Manufacturer-published features and benefits include: FBS-1 Glasswool Bio-Soluble Insulation - safe to use and non-hazardous; manufactured from up to 80% recycled glass content; CodeMark Certificate of Conformity CM 30006; non-combustible to AS 1530.1; low itch soft next-gen formula for comfortable handling; excellent thermal performance for roof/ceiling applications; helps meet NCC energy efficiency requirements; 50 Year Warranty backed by CSR; ACCC certified and tested to Australian Standards This family covers 7 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Bradford Anticon Roofing Blanket - Medium Duty Foil family
...
| Requirement | Status for Bradford Anticon Roofing Blanket - Medium Duty Foil | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Anticon Roofing Blanket - Medium Duty Foil is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Confirm
roof batten spacing is 900mm centres or less.
2. Roll out Anticon Medium Duty
over rafters or battens with the foil facing downwards into the roof space.
3. Allow a nominal 25-40mm sag between battens to prevent compression against the
roof sheet.
4. Overlap adjacent rolls by 150mm using the pre-extended foil edge.
5. Tape all foil joins with Bradford 493 Reinforced Aluminium Foil Tape using a
squeegee to achieve an airtight vapour barrier.
6. Fasten metal roofing sheets
directly over the blanket using recommended screws with neoprene washers.
7. Ensure installation is covered before rain occurs.

**Manufacturer-stated limitations**

- Do not span greater than 900mm centres without wire mesh
(specify Heavy Duty for spans up to 1200mm).
- Must be kept dry prior to and
during installation.
...
| Material R-values | Anticon 60 MD:
R1.3 (60mm); Anticon 80 MD: R1.8 (80mm); Anticon 100 MD: R2.3 (100mm);
Anticon 110 MD: R2.5 (110mm); Anticon 130 MD: R3.0 (130mm) | AS/NZS 4859.1:2018 |
| Blanket Width | 1200 mm
(plus 150 mm foil overlap extension) |  |
| Roll
Lengths | 10 m, 15 m, 20 m |  |
...
| Foil Emittance | 0.05 (reflective
face); 0.90 (antiglare face) | AS/NZS 4201.5 |
| Vapour Barrier Classification | Class 2 Vapour Barrier (< 0.020
µg/N.s) | AS/NZS 4200.1 |
| Maximum Span Between
Supports | Up to 900 mm centres without wire mesh |  |
