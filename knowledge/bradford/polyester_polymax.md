---
id: bradford-polyester-polymax
family_id: BRADFORD_POLYESTER_POLYMAX
manufacturer: Bradford
category: Batt
canonical_name: Bradford Polyester - Polymax
material: Polyester
...
This is the canonical internal description for the Bradford Polyester - Polymax family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Polyester - Polymax family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Safe to handle without gloves or masks. Made from recycled plastic bottles for sustainability. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet; 50 Year Warranty backed by CSR; ACCC certified This family covers 4 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Bradford Polyester - Polymax family
...
| Requirement | Status for Bradford Polyester - Polymax | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Polyester - Polymax is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure stud cavity is clean and electrical services are roughed in prior to
installing insulation.
2. Friction-fit Polymax batts snugly between timber or
steel wall framing studs.
3. Ensure batts fit tightly against studs, top plates,
and bottom plates without gaps or sagging.
4. Avoid excessive compression of
batts to preserve rated thermal thickness.
5. Cut or slit neatly around
electrical wiring, nogging, and plumbing using a sharp utility knife or shears.
6. Install external wall wraps or internal plasterboard linings over framed batts.

**Manufacturer-stated limitations**

- Not non-combustible under AS 1530.1; do
not use where non-combustible insulation is required by NCC.
- Do not compress
into stud cavities shallower than the nominal thickness.
- Indoor/enclosed wall
application only; protect from weather and wet conditions.
...
| Batt
Dimensions | 1160 mm x 430 mm (450 mm stud centres); 1160 mm x 580 mm
(600 mm stud centres) |  |
