---
id: bradford-supertel-faced-heavy-duty-foil
family_id: BRADFORD_SUPERTEL_FACED_HEAVY_DUTY_FOIL
manufacturer: Bradford
category: Batt
canonical_name: Bradford Supertel Faced - Heavy Duty Foil
material: Glasswool
...
### Within the Bradford Supertel Faced - Heavy Duty Foil family
...
| Requirement | Status for Bradford Supertel Faced - Heavy Duty Foil | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Supertel Faced - Heavy Duty Foil is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Clean sheet metal duct or
concrete slab surface to ensure it is free from dust, oil, and moisture.
2. Weld
or adhere insulation stick pins to duct or substrate at 300mm to 400mm centres.
3. Impale Supertel Heavy Duty Foil blanket or board over the pins with the foil
facing outward.
4. Secure in place with speed clips / retaining washers pushed
firmly over pins.
5. Butt all insulation seams tightly together.
6. Seal all
joints, seams, and pin penetrations using matching Bradford 493 Reinforced
Aluminium Foil Tape.
7. Use a plastic squeegee to firmly press tape down,
ensuring an airtight, continuous vapour seal.

**Manufacturer-stated limitations**

- Maximum continuous service temperature of facing is 150°C.
- Protect from
exterior weather and rain until metal cladding or outer jacketing is installed.
- Tape all penetrations to prevent vapor ingress and condensation formation
behind the foil.
...
| Density | 32 kg/m3 |  |
| Thickness | 25 mm, 40 mm, 50 mm, 75
mm, 100 mm |  |
| Dimensions (Rolls) | 15
m x 1200/1500 mm (25mm); 10 m x 1200/1500 mm (40/50mm); 5 m x 1380/1500 mm
(100mm) |  |
| Dimensions (Boards) | 2400
mm x 1200 mm |  |
| Facing | Thermofoil
Heavy Duty (HD) reinforced reflective aluminium foil | AS/NZS 4200.1 |
| Combustibility (Core) | Non-Combustible | AS 1530.1 |
| Fire Hazard
Properties | Ignitability: 0, Spread of Flame: 0, Heat Evolved: 0,
Smoke Developed: 0-1 | AS/NZS 1530.3 |
| Maximum
Service Temperature | 150°C (faced) |  |
