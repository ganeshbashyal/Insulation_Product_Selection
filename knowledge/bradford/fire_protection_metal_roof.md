---
id: bradford-fire-protection-metal-roof
family_id: BRADFORD_FIRE_PROTECTION_METAL_ROOF
manufacturer: Bradford
category: Batt
canonical_name: Bradford Fire Protection - Metal Roof
material: Stonewool
...
# Bradford Fire Protection - Metal Roof

## Purpose of this file

This is the canonical internal description for the Bradford Fire Protection - Metal Roof family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Fire Protection - Metal Roof family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Fire Protection - Metal Roof family
...
| Requirement | Status for Bradford Fire Protection - Metal Roof | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Fire Protection - Metal Roof is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Lay Fireseal 75mm Party Wall Sealer along the full length of the
top of the fire-rated wall.
2. Ensure blanket overhangs the wall thickness
symmetrically (300mm or 360mm width).
3. Fix metal roofing sheets down over the
blanket ensuring at least 10-15% compression across all roof ribs and pans.
4. Where joints in blanket occur, butt tightly together with a minimum 50mm
overlap or Vee cut.
5. Inspect from ceiling space to confirm all corrugations and
crests are fully packed and sealed.

**Manufacturer-stated limitations**

- Must be compressed
minimum 10-15% by roof sheets to ensure smoke/flame barrier.
- Not suitable as
exposed roof sarking membrane.
- Must be protected from pooling water or
...
| Dimensions (FZ Batt option) | 1200 mm
length x 90 mm width x 75 mm thickness |  |
...
| Installation Compression | Minimum 10% to 15%
compression under metal roof profile |  |
| Thermal
Performance | R1.8 (uncompressed 75mm) | AS/NZS 4859.1 |
