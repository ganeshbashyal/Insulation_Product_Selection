---
id: bradford-supertel-plain
family_id: BRADFORD_SUPERTEL_PLAIN
manufacturer: Bradford
category: Batt
canonical_name: Bradford Supertel Plain
material: Glasswool
...
This is the canonical internal description for the Bradford Supertel Plain family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Supertel Plain family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Supertel Plain family
...
| Requirement | Status for Bradford Supertel Plain | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Supertel Plain is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure installation substrate (duct, framing cavity, or enclosure)
is clean and dry.
2. Cut Supertel Plain blanket or board to required size using a
sharp insulation knife.
3. Impale over welded insulation pins on sheet metal, or
friction-fit into framed cavities.
4. Secure with speed clips or retaining
washers.
5. Butt edges tightly to eliminate acoustic and thermal leaks.
6. If
installed behind perforated panels, ensure face is covered or contained to
prevent air-stream fibre loss.

**Manufacturer-stated limitations**

- Unfaced format does not provide vapour barrier
protection against condensation.
- Not for direct exposure to high-velocity air
streams without facing or scrim.
- Keep dry during storage and installation.
...
| --- | --- | --- |
| Material R-values | 13mm: R0.4; 25mm: R0.8; 40mm:
R1.2; 50mm: R1.5; 75mm: R2.2; 100mm: R3.0 | AS/NZS 4859.1 |
| Density | 32 kg/m3 |  |
| Thickness | 13 mm, 25 mm, 40 mm, 50 mm, 75 mm, 100 mm |  |
| Dimensions (Rolls) | 15 m x 1200/1500 mm
(25mm); 10 m x 1200/1500 mm (50mm) |  |
| Dimensions
(Boards) | 2400 mm x 1200 mm |  |
| Sound
Absorption (NRC) | 25mm: NRC 0.75 - 0.85; 50mm: NRC 0.95 - 1.05; 75mm:
NRC 1.05 - 1.10 | AS ISO 354 |
