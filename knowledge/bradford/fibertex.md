---
id: bradford-fibertex
family_id: BRADFORD_FIBERTEX
manufacturer: Bradford
category: Board
canonical_name: Bradford Fibertex
material: Stonewool
...
This is the canonical internal description for the Bradford Fibertex family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Fibertex family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Made from natural volcanic rock, delivering superior fire resistance and acoustic performance that lasts the lifetime of the building. Maintains system efficiency and prevents condensation issues. Manufacturer-published features and benefits include: Non-combustible stonewool made from natural volcanic rock; superior fire resistance up to 1000°C; excellent acoustic absorption properties; fully recyclable at end of life; prevents condensation on cold services; maintains system efficiency; 50 Year Warranty backed by CSR; ACCC certified and tested to Australian Standards This family covers 13 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Board insulation product from Bradford.
- Material: Stonewool.
...
- The catalogue includes 13 unique SKU variant(s) in this family.
...
### Within the Bradford Fibertex family

- Duct | General Acoustic

### Separate product families

Do not transfer claims from this family to other Bradford product families without their own current technical evidence. Where Bradford sells multiple product families within the Board category or in other categories, each is a distinct family with its own grade table and evidence.
...
- ensure all joints are sealed for condensation control.
...
| Requirement | Status for Bradford Fibertex | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Fibertex is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
The master product catalogue provides current commercial records for 13 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
...
1. Clean and inspect the hot vessel, duct, or framing surface to ensure it is free
from grease, loose scale, and water.
2. Weld insulation pins or studs to the
substrate surface at recommended centres (typically 300mm to 450mm).
3. Impale
the Fibertex boards or blankets firmly over the pins with the unfaced side
against the hot surface.
4. Secure boards in place using non-corrosive metal
speed clips / washers pushed over the pins.
5. Butt all board edges tightly
together to eliminate thermal bridging and acoustic leaks.
6. For piping or
curved vessels, secure using wire mesh, steel banding, or metal sheet cladding.
7. Trim neatly around flanges, nozzles, and structural penetrations using an
insulation saw or knife.

**Manufacturer-stated limitations**

- Do not exceed maximum continuous
service temperature rating for the selected grade (350°C, 450°C, 650°C,
or 820°C).
- Dense grades (Fibertex 820) are semi-rigid and do not conform
easily to tight curved surfaces without pre-cutting.
- Outdoor installations
must be clad with metal jacketing or weatherproofing cladding to prevent water
pooling.
...
| --- | --- | --- |
| Maximum
Service Temperatures | Fibertex 350: 350°C; Fibertex 450: 450°C;
Fibertex 650: 650°C; Fibertex 820: 820°C | ASTM C411 / ASTM C447 |
| Nominal Densities | Fibertex 350: 60 kg/m3;
Fibertex 450: 80 kg/m3; Fibertex 650: 100 kg/m3; Fibertex 820: 120-130 kg/m3 |  |
...
| Board Dimensions | 1200
mm x 600 mm (standard); custom lengths and strips available |  |
| Thickness Options | 25 mm, 38 mm, 50 mm, 75 mm, 100
mm |  |
| Thermal Conductivity | 0.034
- 0.038 W/m·K at 20°C (varies with temperature and grade) | ASTM
C177 / AS/NZS 4859.1 |
| Corrosion Tendency | Low
water-soluble chloride content (< 10 ppm), non-corrosive to stainless steel | ASTM C795 |
| Moisture Sorption | < 1% by
volume | ASTM C1104 |
