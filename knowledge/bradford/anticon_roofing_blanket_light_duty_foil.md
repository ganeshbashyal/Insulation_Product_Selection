---
id: bradford-anticon-roofing-blanket-light-duty-foil
family_id: BRADFORD_ANTICON_ROOFING_BLANKET_LIGHT_DUTY_FOIL
manufacturer: Bradford
category: Batt
canonical_name: Bradford Anticon Roofing Blanket - Light Duty Foil
...
This is the canonical internal description for the Bradford Anticon Roofing Blanket - Light Duty Foil family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Anticon Roofing Blanket - Light Duty Foil family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Anticon Roofing Blanket - Light Duty Foil family
...
| Requirement | Status for Bradford Anticon Roofing Blanket - Light Duty Foil | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Anticon Roofing Blanket - Light Duty Foil is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Confirm roof batten spacing does not exceed 600mm centres (or that safety wire
mesh is installed).
2. Roll out Anticon Light Duty over framing with the foil
facing down into the attic or room.
3. Ensure a gentle sag of 25mm to 40mm
between battens to prevent compression against sheeting.
4. Overlap adjoining
blanket runs by 150mm using the pre-extended foil edge.
5. Seal all overlaps and
edges with Bradford 493 Reinforced Foil Tape to create a continuous vapor seal.
6. Fix metal roof sheets over battens, taking care not to puncture or excessively
stretch the light-duty foil.
7. Complete installation prior to rainfall to keep
the glasswool dry.

**Manufacturer-stated limitations**

- Do not use
on framing spans exceeding 600mm without wire mesh support (foil may tear or
sag).
...
| Material R-values | Anticon 60 LD: R1.3 (60mm); Anticon 80 LD: R1.8 (80mm); Anticon 100 LD: R2.3
(100mm) | AS/NZS 4859.1:2018 |
...
| Maximum
Span Between Supports | Up to 600 mm centres without mesh (or
continuous mesh supported) |  |
