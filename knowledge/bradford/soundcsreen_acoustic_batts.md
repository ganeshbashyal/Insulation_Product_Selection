---
id: bradford-soundcsreen-acoustic-batts
family_id: BRADFORD_SOUNDCSREEN_ACOUSTIC_BATTS
manufacturer: Bradford
category: Batt
canonical_name: Bradford Soundcsreen Acoustic Batts
material: Glasswool
...
This is the canonical internal description for the Bradford Soundcsreen Acoustic Batts family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Soundcsreen Acoustic Batts family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Soundcsreen Acoustic Batts family
...
| Requirement | Status for Bradford Soundcsreen Acoustic Batts | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Soundcsreen Acoustic Batts is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Friction-fit SoundScreen batts tightly between timber or steel wall framing
studs.
2. Ensure batts completely fill the stud or joist cavity without gaps or
voids around edges.
3. Cut batts neatly around electrical conduits, plumbing
pipes, and junction boxes using an insulation knife.
4. For between-floor
applications, lay batts between mid-floor joists or hold in place before ceiling
lining installation.
5. In party walls or home theatres, pair with acoustic
plasterboard (e.g. Gyprock Soundchek) and resilient mounts for maximum Rw
performance.
6. Fasten internal wall linings directly over the insulated
framework.

**Manufacturer-stated limitations**

- Do
not compress batts into cavities narrower than the nominal batt thickness.
- Acoustic performance depends on airtight wall construction; seal all perimeter
gaps and penetrations.
- Indoor/enclosed cavity application only; protect from
weather.
...
| --- | --- | --- |
| Material R-values | R1.7 (60mm), R2.0
(70mm), R2.5 (88mm), R3.1 (110mm) | AS/NZS 4859.1 |
| Nominal Thickness | 60 mm, 70 mm, 88 mm, 110 mm |  |
| Batt Dimensions | 1160 mm x 430 mm; 1160 mm x 580
mm; 1200 mm x 600 mm |  |
| Acoustic Absorption
(NRC) | R1.7: 1.00; R2.0: 1.00; R2.5: 1.10; R3.1: 1.15 | ISO 354 |
