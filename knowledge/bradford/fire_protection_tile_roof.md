---
id: bradford-fire-protection-tile-roof
family_id: BRADFORD_FIRE_PROTECTION_TILE_ROOF
manufacturer: Bradford
category: Batt
canonical_name: Bradford Fire Protection - Tile Roof
material: Stonewool
...
This is the canonical internal description for the Bradford Fire Protection - Tile Roof family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Fire Protection - Tile Roof family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Made from natural volcanic rock with superior fire resistance and acoustic performance. Manufacturer-published features and benefits include: Non-combustible stonewool made from natural volcanic rock; superior fire resistance up to 1000°C; excellent acoustic absorption properties; fully recyclable at end of life; excellent thermal performance for roof/ceiling applications; 50 Year Warranty backed by CSR; ACCC certified This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Bradford Fire Protection - Tile Roof family
...
| Requirement | Status for Bradford Fire Protection - Tile Roof | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Fire Protection - Tile Roof is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Roll Fireseal 50mm Party Wall
Sealer along the top of the fire-rated party wall prior to roof tile
installation.
2. Ensure the blanket spans the full width of the wall and
timber/steel framing.
3. Lay roof tile battens and tiles over the sealer,
ensuring continuous 10-15% compression beneath tile profiles.
4. Butt joints in
blanket tightly together with no gaps.
5. Verify no void exists where tile
profiles create contours above the party wall line.

**Manufacturer-stated limitations**

- Must be compressed
minimum 10-15% by roof tiles to ensure fire and smoke seal.
- Not suitable for
deep-rib metal roofing where 75mm is required.
- Must not be left exposed to
pooling water or continuous outdoor weathering.
...
(blanket) or 100 mm (FZ tile batt) |  |
| Dimensions
(Blanket) | 4000 mm length x 300 mm or 360 mm width |  |
| Dimensions (FZ Tile Batt) | 1200 mm length x 115 mm
width x 100 mm thickness |  |
...
| Installation Compression | Minimum 10% to 15% compression beneath
roof tiles |  |
