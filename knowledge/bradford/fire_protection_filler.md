---
id: bradford-fire-protection-filler
family_id: BRADFORD_FIRE_PROTECTION_FILLER
manufacturer: Bradford
category: Batt
canonical_name: Bradford Fire Protection - Filler
material: Stonewool
...
# Bradford Fire Protection - Filler

## Purpose of this file

This is the canonical internal description for the Bradford Fire Protection - Filler family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Fire Protection - Filler family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Fire Protection - Filler family
...
| Requirement | Status for Bradford Fire Protection - Filler | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Fire Protection - Filler is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Locate metal roof or ceiling battens
crossing directly over the fire-rated party wall.
2. Insert a Fireseal Batten
Filler into the open cavity of each continuous steel batten.
3. Centre the filler
directly over the party wall line.
4. Ensure the filler compresses firmly against
the inner faces of the steel batten profile.
5. Check that no air gap or void
remains through the batten cross-section.

**Manufacturer-stated limitations**

- Designed specifically
for hollow metal batten cavities; not for wide masonry gaps.
- Must be protected
from direct weather exposure prior to roof cladding installation.
- Cannot
substitute for party wall blanket or vertical joint batts.
...
| Pack Quantity | 35 pieces per box
(3.5 lineal metres) |  |
| Product Code | 125418 |  |
