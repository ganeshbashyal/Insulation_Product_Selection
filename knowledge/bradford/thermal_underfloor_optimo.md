---
id: bradford-thermal-underfloor-optimo
family_id: BRADFORD_THERMAL_UNDERFLOOR_OPTIMO
manufacturer: Bradford
category: Batt
canonical_name: Bradford Thermal Underfloor / Optimo
material: Glasswool
...
### Within the Bradford Thermal Underfloor / Optimo family
...
| Requirement | Status for Bradford Thermal Underfloor / Optimo | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Thermal Underfloor / Optimo is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. In existing homes from beneath, push Optimo batts
firmly up between floor joists until hard against floorboards.
2. For 450mm joist
centres use 415mm wide batts; for 600mm centres use 565mm wide batts.
3. Fix
Optimo saddle clips to the side of timber joists (2 per batt side) to support
batts permanently.
4. Alternatively, in new builds prior to flooring
installation, fit Optimo saddle clips over top of joists and drop batts in from
above.
5. Butt ends tightly together to eliminate draught paths.
6. Cut neatly
around plumbing pipes and floor vents using an insulation knife.

**Manufacturer-stated limitations**

- Requires adequate crawl space clearance
(minimum 400mm) for retrofit underfloor installation.
- Must not be placed in
direct contact with wet soil or standing water.
- Protect from rodents or
continuous high dampness with proper subfloor ventilation.
...
| --- | --- | --- |
| Material R-values | R2.1 (75mm), R2.5
(90mm) | AS/NZS 4859.1 |
| Thickness | 75
mm (R2.1), 90 mm (R2.5) |  |
| Batt Dimensions | 1160 mm x 415 mm (for 450 mm joist centres); 1160 mm x 565 mm (for 600
mm joist centres) |  |
