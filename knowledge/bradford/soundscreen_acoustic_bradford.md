---
id: bradford-soundscreen-acoustic-bradford
family_id: BRADFORD_SOUNDSCREEN_ACOUSTIC_BRADFORD
manufacturer: Bradford
category: Batt
canonical_name: Bradford Soundscreen Acoustic - Bradford
material: Glasswool
...
| --- | --- | ---: | --- | ---: |
| Rw 40 | acoustic_rw | 70 | 1160 x 450 | 1 |
| Rw 45 | acoustic_rw | 88 | 1160 x 450 | 1 |
| Rw 45 | acoustic_rw | 88 | 1160 x 600 | 1 |
...
### Within the Bradford Soundscreen Acoustic - Bradford family
...
| Requirement | Status for Bradford Soundscreen Acoustic - Bradford | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Soundscreen Acoustic - Bradford is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
3. Ensure full contact with framing on all sides without gaps, gaps cause sound
leakage.
4. Trim neatly around electrical boxes, wiring, and pipes using an
insulation knife.
5. Ensure wall and ceiling joints are completely sealed with
acoustic sealant.
6. Hang internal wall plasterboard (or acoustic plasterboard)
and fasten per manufacturer instructions.

**Manufacturer-stated limitations**

- Do
not compress into stud cavities smaller than batt thickness.
- Acoustic
performance is significantly degraded if flanking paths and gaps are left
unsealed.
- Not for use in exposed exterior or wet environments without
protective lining.
...
| --- | --- | --- |
| Material R-values | R1.7 (60mm), R2.0 (70mm), R2.5 (88mm), R3.1
(110mm) | AS/NZS 4859.1 |
| Nominal Thickness | 60 mm, 70 mm, 88 mm, 110 mm |  |
| Batt
Dimensions | 1160 mm x 430 mm, 1160 mm x 580 mm, 1200 mm x 600 mm |  |
| Acoustic Absorption (NRC) | 1.00
(60mm & 70mm), 1.10 (88mm), 1.15 (110mm) | ISO 354 |
