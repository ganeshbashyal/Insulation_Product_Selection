---
id: bradford-reflective
family_id: BRADFORD_REFLECTIVE
manufacturer: Bradford
category: Reflective
canonical_name: Bradford Reflective
...
| --- | --- | ---: | --- | ---: |
| R1.5 | thermal_r_value | 40 | 30000 x 135040 | 4 |
| R1.5 | thermal_r_value | 81 | 60000 x 135081 | 3 |
...
| Requirement | Status for Bradford Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Reflective is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
