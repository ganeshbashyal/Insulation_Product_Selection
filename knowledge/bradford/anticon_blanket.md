---
id: bradford-anticon-blanket
family_id: BRADFORD_ANTICON_BLANKET
manufacturer: Bradford
category: Batt
canonical_name: Bradford Anticon Blanket
material: Glasswool / Foil Composite
...
This is the canonical internal description for the Bradford Anticon Blanket family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Anticon Blanket family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Firm friction fit design means batts stay in place permanently. Low itch formula for comfortable installation. Manufacturer-published features and benefits include: FBS-1 Glasswool Bio-Soluble Insulation - safe to use and non-hazardous; manufactured from up to 80% recycled glass content; CodeMark Certificate of Conformity CM 30006; non-combustible to AS 1530.1; low itch soft next-gen formula for comfortable handling; excellent thermal performance for roof/ceiling applications; 50 Year Warranty backed by CSR; ACCC certified This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Bradford Anticon Blanket family
...
- wear long sleeves, gloves and dust mask for comfort.
...
| Requirement | Status for Bradford Anticon Blanket | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Anticon Blanket is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install roof safety wire mesh over purlins if required for
commercial spans or fall safety.
2. Roll out Bradford Anticon blanket across or
down rafters/purlins with the foil facing down into the building and the
glasswool facing up.
3. Allow a slight sag (approx 25-40mm) between supports to
avoid crushing the blanket against roof sheeting.
4. Overlap consecutive runs of
Anticon by 150mm using the factory-provided foil overlap edge.
5. Seal all
longitudinal and end overlaps thoroughly with matching reinforced aluminium foil
tape to maintain vapor barrier integrity.
6. For roofs requiring roof spacers
(such as Ashgrid or SpacerX), install brackets and spacer bars over the
blanket.
7. Fix metal roofing sheets directly over the blanket or spacer bars
without over-compressing the blanket over purlins.

**Manufacturer-stated limitations**

- Must be installed dry; do not install during
rain or leave exposed to weather before cladding.
- Foil must face downward
toward the ceiling/attic cavity to function as a vapor barrier and control
condensation.
- Avoid over-compressing blanket directly under roof sheets unless
using roof spacer systems.
...
| --- | --- | --- |
| Material R-values | Anticon 60: R1.3 (60mm); Anticon 80: R1.8 (80mm);
Anticon 100: R2.3 (100mm); Anticon 110: R2.5 (110mm); Anticon 125: R2.8 (125mm);
Anticon 130: R3.0 (130mm); Anticon 145: R3.6 (145mm) | AS/NZS 4859.1:2018 |
| Blanket Width | 1200 mm
(plus 150 mm foil overlap extension) |  |
| Roll
Lengths | 10 m, 12 m, 15 m, 20 m (custom lengths available for
commercial projects) |  |
...
| Fire
Hazard Properties | Ignitability: 0, Spread of Flame: 0, Heat
Evolved: 0, Smoke Developed: 0-1 | AS/NZS 1530.3 |
| Bushfire Rating | BAL 12.5 - BAL FZ compliant | AS 3959 |
| Rain Noise Reduction | Damps rain sound power level
by over 7% (up to 7 dB reduction) |  |
| Reflective
Emittance (Foil) | 0.05 (reflective face); 0.90 (antiglare face) | AS/NZS 4201.5 |
