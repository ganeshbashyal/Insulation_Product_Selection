---
id: bradford-wall-wraps-enviroseal-ultra-tape
family_id: BRADFORD_WALL_WRAPS_ENVIROSEAL_ULTRA_TAPE
manufacturer: Bradford
category: Wrap
canonical_name: Bradford Wall Wraps - Enviroseal Ultra Tape
...
# Bradford Wall Wraps - Enviroseal Ultra Tape

## Purpose of this file

This is the canonical internal description for the Bradford Wall Wraps - Enviroseal Ultra Tape family (Wrap category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Wall Wraps - Enviroseal Ultra Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Wall Wraps - Enviroseal Ultra Tape family
...
| Requirement | Status for Bradford Wall Wraps - Enviroseal Ultra Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Wall Wraps - Enviroseal Ultra Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure membrane surfaces are clean, dry, and
dust-free.
2. Align membrane lap with minimum 150mm overlap (or 50mm if taped per
AS 4200.2).
3. Tear ULTRAtape to length by hand directly from the roll without
using cutting tools.
4. Apply tape centred evenly over the lap seam.
5. Smooth
firmly along the tape with hand pressure or a squeegee to activate the adhesive
bond.
6. Ensure no fishmouths or air channels remain along the tape line.

**Manufacturer-stated limitations**

- Must be applied with firm pressure to
activate adhesive.
- Not designed for structural mechanical holding.
- Should
not be left exposed to UV beyond maximum membrane exposure limits.
...
| --- | --- | --- |
| Backing Material | Woven polymer
fabric |  |
...
| Air and Water Tightness | Passes air barrier and water resistance
criteria | AS/NZS 4200.2 |
| Product Code | 471825 |  |
