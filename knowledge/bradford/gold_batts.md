---
id: bradford-gold-batts
family_id: BRADFORD_GOLD_BATTS
manufacturer: Bradford
category: Batt
canonical_name: Bradford Gold Batts
material: Glasswool
...
- The catalogue includes 16 unique SKU variant(s) in this family.
...
### Within the Bradford Gold Batts family
...
| Requirement | Status for Bradford Gold Batts | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Gold Batts is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
The master product catalogue provides current commercial records for 16 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
...
1. Turn off power
at the main switchboard before entering ceiling space or touching wall
cavities.
2. Fit batts snugly between timber or steel framing members without
gaps or compression.
3. For ceilings, lay batts flat between ceiling joists
covering the plasterboard completely.
4. At ceiling eaves, maintain a 20mm gap
between insulation and roof cladding/sarking.
5. Maintain minimum 50mm clearance
around non-IC rated downlights, exhaust fans, and flues as per AS 3999.
6. For
external walls, install water-repellent batts between studs and secure with wall
wrap before brickwork or cladding.

**Manufacturer-stated limitations**

- Do not compress batts into cavities narrower than nominal
thickness as this reduces thermal R-value.
- Must be protected from continuous
water exposure and prolonged outdoor weather.
- Maintain electrical safety
clearances around recessed electrical equipment.
...
| Ceiling Thicknesses | R2.5: 140 mm; R3.0: 165 mm;
R3.5: 185 mm; R4.1: 205 mm |  |
...
| Moisture Resistance | Less than 0.2% by volume after 4 days
at 50°C, 95% RH |  |
