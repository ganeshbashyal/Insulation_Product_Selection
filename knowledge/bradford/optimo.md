...
category: Batt
canonical_name: Bradford Optimo
material: Glasswool
...
### Within the Bradford Optimo family
...
| Requirement | Status for Bradford Optimo | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Optimo is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Turn off
power at main switchboard before entering subfloor space.
2. Measure joist
spacings (use 415mm batts for 450mm centres; 565mm batts for 600mm centres).
3. In new builds, fit Optimo Saddles across joists at max 500mm spacing before
laying flooring, then place batts on saddle feet from above.
4. For retrofit
beneath existing floors, push batts up tightly against underside of floorboards
ensuring no air gaps.
5. Secure retrofitted batts using Optimo Straps fixed to
joists at max 500mm intervals and swivelled 90 degrees to support batts.
6. Alternatively, use self-adhesive Optimo StayFast brackets (2 per side per batt)
fixed 300mm in from batt ends.
7. Trim batts 5mm wider than opening if joist
spacing is irregular to maintain a snug friction fit.
8. Take care not to block
subfloor ventilation openings.

**Manufacturer-stated limitations**

- Must be mechanically supported with Saddles, Straps, or
StayFast brackets to prevent gravity sagging over time.
- Do not cover
electrical subfloor wiring that may be susceptible to derating without checking
AS/NZS 3000.
- Do not block subfloor wall vents which are critical for moisture
dissipation.
...
| Thermal Resistance (R-Value) | R2.1,
R2.5 | AS/NZS 4859.1 |
| Thickness | R2.1: 75 mm; R2.5: 90 mm |  |
| Standard
Dimensions | 1160 mm length x 415 mm width (for 450mm joists) or 565
mm width (for 600mm joists) |  |
| Coverage Per
Pack | 415 mm: 3.85 m² (8 batts); 565 mm: 5.24 m² (8 batts) |  |
