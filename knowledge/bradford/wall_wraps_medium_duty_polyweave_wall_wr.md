---
id: bradford-wall-wraps-medium-duty-polyweave-wall-wr
family_id: BRADFORD_WALL_WRAPS_MEDIUM_DUTY_POLYWEAVE_WALL_WR
manufacturer: Bradford
category: Reflective
canonical_name: Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap
material: Reflective Membrane
...
This is the canonical internal description for the Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Reflects up to 97% of radiant heat, reducing summer cooling costs. Manufacturer-published features and benefits include: High-purity aluminium reflective facing; reflects up to 97% of radiant heat; lightweight and easy to install; provides vapour barrier when properly sealed; 50 Year Warranty backed by CSR; ACCC certified This family covers 3 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Reflective insulation product from Bradford.
- Material: Reflective Membrane.
...
### Within the Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap family

- Wall Wrap / Sarking

### Separate product families

Do not transfer claims from this family to other Bradford product families without their own current technical evidence. Where Bradford sells multiple product families within the Reflective category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Wall Wraps - Medium Duty Polyweave Wall Wrap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Fix Thermoseal Polyweave Wall Wrap to
exterior of studs starting from bottom plate.
2. Run sheets horizontally with
upper sheets overlapping lower sheets by minimum 150mm.
3. Ensure orientation
matches product design (foil facing cavity where reflective R-value is
desired).
4. Secure to timber framing using galvanized staples or clouts; use
self-drilling screws with washers for steel.
5. Fix at maximum 300mm centres to
studs and plates to prevent wind flap.
6. Seal joints with Bradford 493
reinforced aluminium foil tape for maximum vapour and air tightness.

**Manufacturer-stated limitations**

- Requires an air gap
(void) adjacent to the reflective face to deliver thermal R-value.
- Non-breathable vapour barrier; not recommended in cold climate zones
(zones 6, 7, 8) where Class 4 breathable wraps are mandated.
- Must be covered
by external cladding within manufacturer UV exposure limits.
...
| --- | --- | --- |
| Material | High-density woven polymer fabric (polyweave)
laminated to aluminium foil |  |
| Duty
Classification | Medium Duty | AS/NZS 4200.1 |
| Vapour Barrier Classification | Class 1 or 2 Vapour
Barrier (Low Vapour Permeance) | AS/NZS 4200.1 |
| Water Control Classification | Water Barrier | AS/NZS 4201.4 |
| Emittance (Reflective Face) | 0.05
(95% heat reflection) | AS/NZS 4201.5 |
| Roll
Dimensions (30m) | 1350 mm width x 30 m length (40.5 m² per roll) |  |
| Roll Dimensions (60m) | 1350 mm width
x 60 m length (81 m² per roll) |  |
| Flammability
Index | ≤ 5 (Low Flammability) | AS 1530.2 |
| Product Codes | 40483 (30m Inward), 15128 (60m
Inward), 125825 (30m XP), 124652 (60m XP) |  |
