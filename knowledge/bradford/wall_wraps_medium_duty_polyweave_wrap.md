---
id: bradford-wall-wraps-medium-duty-polyweave-wrap
family_id: BRADFORD_WALL_WRAPS_MEDIUM_DUTY_POLYWEAVE_WRAP
manufacturer: Bradford
category: Reflective
canonical_name: Bradford Wall Wraps - Medium Duty Polyweave Wrap
...
# Bradford Wall Wraps - Medium Duty Polyweave Wrap

## Purpose of this file

This is the canonical internal description for the Bradford Wall Wraps - Medium Duty Polyweave Wrap family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Wall Wraps - Medium Duty Polyweave Wrap family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Bradford Wall Wraps - Medium Duty Polyweave Wrap family
...
| Requirement | Status for Bradford Wall Wraps - Medium Duty Polyweave Wrap | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Wall Wraps - Medium Duty Polyweave Wrap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install horizontally on exterior wall studs starting from the
bottom sill plate.
2. Overlap upper layers over lower layers by at least 150mm to
ensure water shedding.
3. Fasten with broad-head galvanized nails or staples
at 300mm centres to studs and plates.
4. Ensure reflective surface faces the
designed air gap to achieve thermal rating.
5. Fix securely around window and
door openings before installing joinery.
6. Ensure a ventilated cavity exists
between the wrap and the external brick veneer or cladding.

**Manufacturer-stated limitations**

- Not suitable for cold
climate zones (zones 6, 7, 8) where non-perforated Class 4 spunbond membranes
are required by NCC 2022.
- Must not be used in roofs as sarking.
- Must be
covered within manufacturer UV exposure limits.
...
Barrier (under standard test conditions) | AS/NZS 4201.4 |
| Emittance (Reflective Face) | 0.05 (95% heat
reflection) | AS/NZS 4201.5 |
| Roll Dimensions
(30m) | 1350 mm width x 30 m length (40.5 m² per roll) |  |
| Roll Dimensions (60m) | 1350 mm width x 60 m
length (81 m² per roll) |  |
