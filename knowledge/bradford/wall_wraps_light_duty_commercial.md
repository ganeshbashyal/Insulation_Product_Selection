---
id: bradford-wall-wraps-light-duty-commercial
family_id: BRADFORD_WALL_WRAPS_LIGHT_DUTY_COMMERCIAL
manufacturer: Bradford
category: Reflective
canonical_name: Bradford Wall Wraps - Light Duty Commercial
...
This is the canonical internal description for the Bradford Wall Wraps - Light Duty Commercial family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Bradford Wall Wraps - Light Duty Commercial family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Part of the CSR family with 100+ years of Australian building solutions. Reflects up to 97% of radiant heat, reducing summer cooling costs. Manufacturer-published features and benefits include: High-purity aluminium reflective facing; reflects up to 97% of radiant heat; lightweight and easy to install; provides vapour barrier when properly sealed; 50 Year Warranty backed by CSR; ACCC certified This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Bradford Wall Wraps - Light Duty Commercial family
...
| Requirement | Status for Bradford Wall Wraps - Light Duty Commercial | Enquiry-bot action |
| --- | --- | --- |
...
> Bradford Wall Wraps - Light Duty Commercial is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Fix
Enviroseal CW to the outside of the commercial timber or steel wall frame with
printed face outward.
2. Fasten with broad-headed fasteners at maximum 300mm
centres to studs and plates.
3. Run sheets horizontally, starting from bottom
plate and working upward.
4. Ensure upper sheets overlap lower sheets by at
least 150mm along the printed lap guide.
5. Tape all horizontal and vertical
overlaps with Enviroseal HighTack Tape or specify CW-IT.
6. Ensure membrane is
separated from exterior cladding by a drained cavity.
7. Seal around windows,
door frames, and penetrations to complete the continuous weather barrier.

**Manufacturer-stated limitations**

- Not suitable for roofing applications (Light Duty
rating does not meet DtS roof traffic requirements).
- Do not leave exposed to
direct UV sunlight for longer than 60 days.
- Not for open-joint rainscreens
where >30% is exposed (use Black Label).
...
| Vapour Permeance | Class 4 Vapour
Permeable (high breathability) | AS/NZS 4200.1 |
| Water Control Classification | Water Barrier | AS/NZS 4201.4 |
| Air Control Classification | Air
Barrier | AS/NZS 4200.1 |
...
> 160 N, Lateral Direction > 140 N | AS/NZS 4200.1 |
