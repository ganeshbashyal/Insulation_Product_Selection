...
Quality insulation engineered for Australian conditions. Engineered to meet Australian building requirements. Manufacturer-published features and benefits include: High-performance membrane technology; provides effective vapour and moisture management; compatible with a wide range of substrates; excellent thermal performance for roof/ceiling applications This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Wrap insulation product from Ecowool.
- Material: Membrane.
...
- overlap joints as per manufacturer specifications.
- seal all laps and penetrations with compatible tape.
...
| Requirement | Status for Ecowool Wrap | Enquiry-bot action |
| --- | --- | --- |
...
> Ecowool Wrap is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Install
horizontally on external timber or steel studs starting from the bottom plate.
2. Fasten mechanically to framing members at maximum 300mm centres using
broad-head nails or staples.
3. Ensure upper layers overlap lower layers by at
least 150mm to shed water outward.
4. Vertical joints must overlap by at
least 150mm over a stud.
5. Seal all overlaps and penetrations with EcoSeal 201
Cloth Tape for airtight weather resistance.
6. Provide adequate drainage cavity
between ClimaWrap and exterior cladding (especially non-absorbent claddings like
steel).
7. Seal neatly around window and door openings prior to installing
joinery.
...
- Claddings must
provide a drained cavity; provision must be given for drainage of trapped
moisture behind steel cladding.
- Must not be left exposed to direct sunlight
beyond recommended UV exposure limits.
...
| --- | --- | --- |
| Material | Triple-layer spunbond non-woven polymer fabric with
vapour-permeable membrane core |  |
| Duty
Classification | Light Duty | AS/NZS 4200.1:2017 |
| Vapour Permeability | Class 4 Vapour Permeable (Vapour
Permeance: 3.967 µg/N·s |  |
| Water Control Classification | Water
Barrier | AS/NZS 4201.4 |
| Air Control
Classification | Air Barrier | AS/NZS 4200.1 |
| Nominal Mass per Unit Area | 145 g/m² |  |
| Nominal Thickness | 0.42 mm |  |
| Roll Dimensions (1500mm) | 1500 mm width x 30 m length
(45 m² per roll) |  |
| Roll Dimensions
(1370mm/1350mm) | 1370 mm / 1350 mm width x 30 m length (41.1 m² per
roll) |  |
