---
id: ecowool-ecoseal-tape
family_id: ECOWOOL_ECOSEAL_TAPE
manufacturer: Ecowool
category: Accessory
canonical_name: Ecowool Ecoseal Tape
material: Tape
...
# Ecowool Ecoseal Tape

## Purpose of this file

This is the canonical internal description for the Ecowool Ecoseal Tape family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Ecowool Ecoseal Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet Australian building requirements. Manufacturer-published features and benefits include: High-performance sealing and joining solution; maintains air and vapour barrier continuity; compatible with a range of insulation substrates This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Accessory insulation product from Ecowool.
- Material: Tape.
...
### Within the Ecowool Ecoseal Tape family

- Sealing Tape

### Separate product families

Do not transfer claims from this family to other Ecowool product families without their own current technical evidence. Where Ecowool sells multiple product families within the Accessory category or in other categories, each is a distinct family with its own grade table and evidence.
...
- apply with firm pressure for full contact.
- overlap joints as specified by manufacturer.
...
| Requirement | Status for Ecowool Ecoseal Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Ecowool Ecoseal Tape is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure building wrap surfaces are clean, dry, and free of dust,
grease, and moisture.
2. Align membrane lap with recommended overlap
(minimum 150mm or 50mm if taped per AS 4200.2).
3. Centre EcoSeal 201 Cloth Tape
evenly over the joint seam.
4. Press tape firmly along the entire length using
hand pressure or a squeegee to ensure 100% surface contact.
5. Smooth out any air
bubbles or wrinkles.
6. Tape around window flashings, penetrations, and frame
junctions to ensure airtightness.

**Manufacturer-stated limitations**

- Surfaces must be dry and clean
before application.
- Pressure-sensitive adhesive requires firm pressure to
achieve full bonding.
- Not designed for structural mechanical fastening.
...
| --- | --- | --- |
| Material | Polyethylene-coated cloth backing with
high-tack adhesive |  |
| Roll Dimensions | 48 mm width x 50 m length (2.4 m²) |  |
| Adhesive
Type | High-tack pressure-sensitive adhesive |  |
| Hand Tearable | Yes |  |
| Application | Bonding, sealing, and mending overlapped edges of
building wraps |  |
