---
id: ecowool-roll
family_id: ECOWOOL_ROLL
manufacturer: Ecowool
category: Roll
canonical_name: Ecowool Roll
material: Polyester
...
This is the canonical internal description for the Ecowool Roll family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Ecowool Roll family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| Requirement | Status for Ecowool Roll | Enquiry-bot action |
| --- | --- | --- |
...
> Ecowool Roll is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
