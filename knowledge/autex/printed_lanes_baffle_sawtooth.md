---
id: autex-printed-lanes-baffle-sawtooth
family_id: AUTEX_PRINTED_LANES_BAFFLE_SAWTOOTH
manufacturer: Autex
category: Batt
canonical_name: Autex Printed Lanes Baffle Sawtooth
material: Polyester
...
# Autex Printed Lanes Baffle Sawtooth

## Purpose of this file

This is the canonical internal description for the Autex Printed Lanes Baffle Sawtooth family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Printed Lanes Baffle Sawtooth family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Printed Lanes Baffle Sawtooth family
...
| Requirement | Status for Autex Printed Lanes Baffle Sawtooth | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Printed Lanes Baffle Sawtooth is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
