---
id: autex-acoustic-timber-acoustic-timber-panel
family_id: AUTEX_ACOUSTIC_TIMBER_ACOUSTIC_TIMBER_PANEL
manufacturer: Autex
category: Panel
canonical_name: Autex Acoustic Timber - Acoustic Timber Panel
material: Polyester
...
### Within the Autex Acoustic Timber - Acoustic Timber Panel family
...
| Requirement | Status for Autex Acoustic Timber - Acoustic Timber Panel | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Acoustic Timber - Acoustic Timber Panel is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
