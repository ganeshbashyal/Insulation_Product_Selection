---
id: autex-frontier-raft-beam
family_id: AUTEX_FRONTIER_RAFT_BEAM
manufacturer: Autex
category: Batt
canonical_name: Autex Frontier Raft - Beam
material: Polyester
...
### Within the Autex Frontier Raft - Beam family
...
| Requirement | Status for Autex Frontier Raft - Beam | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Frontier Raft - Beam is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
