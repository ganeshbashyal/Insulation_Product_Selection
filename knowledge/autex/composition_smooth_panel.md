---
id: autex-composition-smooth-panel
family_id: AUTEX_COMPOSITION_SMOOTH_PANEL
manufacturer: Autex
category: Panel
canonical_name: Autex Composition - Smooth Panel
material: Polyester
...
This is the canonical internal description for the Autex Composition - Smooth Panel family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Composition - Smooth Panel family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Composition - Smooth Panel family
...
| Requirement | Status for Autex Composition - Smooth Panel | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Composition - Smooth Panel is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
