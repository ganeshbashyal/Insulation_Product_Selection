---
id: autex-horizon-square
family_id: AUTEX_HORIZON_SQUARE
manufacturer: Autex
category: Panel
canonical_name: Autex Horizon - Square
material: Polyester
...
# Autex Horizon - Square

## Purpose of this file

This is the canonical internal description for the Autex Horizon - Square family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Horizon - Square family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Horizon - Square family
...
| Requirement | Status for Autex Horizon - Square | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Horizon - Square is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
