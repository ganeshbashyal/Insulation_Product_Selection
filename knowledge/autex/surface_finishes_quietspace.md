---
id: autex-surface-finishes-quietspace
family_id: AUTEX_SURFACE_FINISHES_QUIETSPACE
manufacturer: Autex
category: Panel
canonical_name: Autex Surface Finishes Quietspace
material: Polyester
...
# Autex Surface Finishes Quietspace

## Purpose of this file

This is the canonical internal description for the Autex Surface Finishes Quietspace family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Surface Finishes Quietspace family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Surface Finishes Quietspace family
...
| Requirement | Status for Autex Surface Finishes Quietspace | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Surface Finishes Quietspace is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Ensure wall or ceiling
substrate is flat, clean, dry, and dust-free.
2. Acclimatise panels in the
installation environment for at least 24 hours prior to fitting.
3. Plan stone or
texture pattern alignment across panels before applying adhesive.
4. Apply
recommended contact or high-grab MS polymer adhesive evenly across the panel
back.
5. Position panel onto substrate, butt joins tightly together, and roll
firmly with a pressure roller.
6. Maintain the protective spun-bond film over
panel face until all messy construction trades finish.
7. Trim perimeter panels
carefully from the face using a straight edge and sharp utility knife on the
offcut side.
...
- Do not expose to
concentrated heat sources exceeding 80°C.
- Recommended for non-contact areas as
printed surface may mark under heavy impact.
...
(NRC) | 25mm: 0.85 (Class C); 50mm: 1.00 (Class A); 75mm: 1.00 (Class
A); 100mm: 1.00 (Class A) | ISO 354 |
| Panel
Dimensions | 1220 mm x 2440 mm (custom lengths up to 3600 mm) |  |
| Thickness Options | 25 mm, 50 mm, 75
mm, 100 mm (tolerance +/- 6%) |  |
| Weight | 25mm: 2300 gsm; 50mm: 3800 gsm; 75mm: 4050 gsm; 100mm: 4300 gsm |  |
| Material Composition | 100% polyester
fibre (PET) printed with UV-curable ink |  |
| Recycled Content | Minimum 45% to 58% post-consumer recycled PET |  |
| Thermal Performance | 25mm: R0.6
(@ 15°C); 50mm: R1.4 (@ 15°C) |  |
| Fire Rating
(Australia) | Group 1, SMOGRArc < 100 m2/s2 | AS ISO 9705
- 2003 / AS 5637.1 |
| International Fire Rating | Group 1-S (ISO 9705:1993); Class A (ASTM E-84); 25mm BS EN 13501-1:2018 B - s2,
d0; 50mm B - s2, d2 | ISO 9705 / ASTM E-84 / BS EN 13501-1 |
