---
id: autex-surface-finishes-cube
family_id: AUTEX_SURFACE_FINISHES_CUBE
manufacturer: Autex
category: Panel
canonical_name: Autex Surface Finishes Cube
material: Polyester
...
# Autex Surface Finishes Cube

## Purpose of this file

This is the canonical internal description for the Autex Surface Finishes Cube family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Surface Finishes Cube family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Surface Finishes Cube family
...
| Requirement | Status for Autex Surface Finishes Cube | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Surface Finishes Cube is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
