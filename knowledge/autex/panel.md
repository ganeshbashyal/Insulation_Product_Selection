...
| Energy efficiency | 3/5 | Medium | Based on both thermal insulation (R-value) and acoustic performance (Rw/NRC); confirm per-SKU rating before quoting a thermal target. |
