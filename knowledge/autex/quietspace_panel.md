---
id: autex-quietspace-panel
family_id: AUTEX_QUIETSPACE_PANEL
manufacturer: Autex
category: Panel
canonical_name: Autex Quietspace Panel
material: Polyester
...
### Within the Autex Quietspace Panel family
...
| Requirement | Status for Autex Quietspace Panel | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Quietspace Panel is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
