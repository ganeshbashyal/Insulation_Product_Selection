---
id: autex-solid-colour-frontier-raft-beam
family_id: AUTEX_SOLID_COLOUR_FRONTIER_RAFT_BEAM
manufacturer: Autex
category: Batt
canonical_name: Autex Solid Colour Frontier Raft beam
material: Polyester
...
# Autex Solid Colour Frontier Raft beam

## Purpose of this file

This is the canonical internal description for the Autex Solid Colour Frontier Raft beam family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Solid Colour Frontier Raft beam family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Solid Colour Frontier Raft beam family
...
| Requirement | Status for Autex Solid Colour Frontier Raft beam | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Solid Colour Frontier Raft beam is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
