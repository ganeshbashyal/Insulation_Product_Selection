---
id: autex-vicinity-desk-screen-polka
family_id: AUTEX_VICINITY_DESK_SCREEN_POLKA
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Polka
material: Polyester
...
# Autex Vicinity - Desk Screen - Polka

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Polka family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Polka family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Polka family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Polka | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Polka is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
2. Slide Vicinity Clamps
into the routed slots on both screen sections.
3. Position the stepped panels
along the desk perimeter to achieve desired layout.
4. Tighten the clamp screws
from underneath the desk using an Allen key.
5. Ensure both stepped panels are
securely clamped and upright.
...
- Two-piece stepped
configuration requires arrangement planning.
...
| --- | --- | --- |
| Acoustic
Performance | 0.70 Sabins per unit
(125Hz: 0.20, 250Hz: 0.45, 500Hz: 0.65, 1000Hz: 0.75, 2000Hz: 1.00, 4000Hz: 1.10) | ISO 354 |
| Dimensions (Panel 1) | 772 mm
width x 576 mm height |  |
| Dimensions (Panel 2) | 380 mm width x 576 mm height |  |
| Thickness | 12 mm (+/- 6%) |  |
| Material Composition | 100% polyester fibre (PET) Cube panel;
clamp: 100% recycled PET / zinc |  |
| Recycled
Content | Minimum 80% post-consumer recycled PET |  |
