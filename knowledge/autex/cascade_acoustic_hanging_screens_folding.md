---
id: autex-cascade-acoustic-hanging-screens-folding
family_id: AUTEX_CASCADE_ACOUSTIC_HANGING_SCREENS_FOLDING
manufacturer: Autex
category: Panel
canonical_name: Autex Cascade Acoustic Hanging Screens - Folding
material: Polyester
...
# Autex Cascade Acoustic Hanging Screens - Folding

## Purpose of this file

This is the canonical internal description for the Autex Cascade Acoustic Hanging Screens - Folding family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Cascade Acoustic Hanging Screens - Folding family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Cascade Acoustic Hanging Screens - Folding family
...
| Requirement | Status for Autex Cascade Acoustic Hanging Screens - Folding | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Cascade Acoustic Hanging Screens - Folding is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
