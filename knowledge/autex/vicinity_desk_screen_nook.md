---
id: autex-vicinity-desk-screen-nook
family_id: AUTEX_VICINITY_DESK_SCREEN_NOOK
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Nook
material: Polyester
...
# Autex Vicinity - Desk Screen - Nook

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Nook family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Nook family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Nook family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Nook | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Nook is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Unpack the 3-piece Nook
screen set and verify all components.
2. Attach Vicinity Desk Clamps to
pre-routed sockets on rear and side panels.
3. Align the three panels around the
back and both sides of the desktop.
4. Tighten the clamp mounting bolts from
underneath the desk using an Allen key.
5. Ensure all corners fit neatly and the
enclosure stands rigidly around the workspace.

**Manufacturer-stated limitations**

- Indoor use only; avoid wet areas or direct liquid contact.
- Workstation desk
must accommodate side and rear clamps.
- Sold in pack quantities of 4 complete
screens.
