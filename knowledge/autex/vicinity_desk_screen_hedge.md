---
id: autex-vicinity-desk-screen-hedge
family_id: AUTEX_VICINITY_DESK_SCREEN_HEDGE
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Hedge
material: Polyester
...
### Within the Autex Vicinity - Desk Screen - Hedge family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Hedge | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Hedge is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Unpack Vicinity Hedge
screens and verify components.
2. Insert Vicinity Desk Clamps into the routed
notches along the bottom edge of the screen.
3. Position the screen squarely
along the back edge of the workstation.
4. Tighten the clamp screws from
underneath the desk using an Allen key until firmly locked.
5. Confirm the screen
is vertical, level, and securely positioned.

**Manufacturer-stated limitations**

- Indoor use only; avoid wet
areas or direct liquid contact.
- Desktop must provide adequate rear edge
clearance for clamp mechanism.
- Sold in minimum pack quantities of 4 screens.
...
| --- | --- | --- |
| Acoustic
Performance | 1600mm: 1.00 Sabin per unit; 1800mm: 1.10 Sabins per
unit
(125Hz: 0.35, 250Hz: 0.75, 500Hz: 1.00, 1000Hz: 1.20, 2000Hz: 1.55, 4000Hz: 1.75) | ISO 354 |
| Dimensions (1600mm) | 1550 mm
/ 1600 mm width x 600 mm height (sits ~400 mm above desk) |  |
| Dimensions (1800mm) | 1750 mm / 1800 mm width x 600 mm
height (sits ~400 mm above desk) |  |
| Thickness | 12 mm (+/- 6%) |  |
| Material
Composition | 100% polyester fibre (PET) Cube panel; clamp: 100%
recycled PET / zinc |  |
...
| International Fire Classification | Group 1-S (ISO 9705:1993); Class
A (ASTM E-84-15a: FS:0 - SD:45); BS EN 13501-1:2018 | ISO 9705 /
ASTM E-84 / BS EN 13501-1 |
| Water Vapour Sorption | 0.4% by weight after 4 days at 49°C, 95% RH | ASTM C1104 /
C1104M-13a |
| Microbial Resistance | Growth rating: 0
(No growth) | ASTM G21-15 |
