---
id: autex-cascade-acoustic-hanging-screens-expandi
family_id: AUTEX_CASCADE_ACOUSTIC_HANGING_SCREENS_EXPANDI
manufacturer: Autex
category: Panel
canonical_name: Autex Cascade Acoustic Hanging Screens - Expanding
material: Polyester
...
This is the canonical internal description for the Autex Cascade Acoustic Hanging Screens - Expanding family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Cascade Acoustic Hanging Screens - Expanding family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Cascade Acoustic Hanging Screens - Expanding family
...
| Requirement | Status for Autex Cascade Acoustic Hanging Screens - Expanding | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Cascade Acoustic Hanging Screens - Expanding is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
