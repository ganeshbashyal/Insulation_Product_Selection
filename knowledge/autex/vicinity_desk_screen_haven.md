---
id: autex-vicinity-desk-screen-haven
family_id: AUTEX_VICINITY_DESK_SCREEN_HAVEN
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Haven
material: Polyester
...
# Autex Vicinity - Desk Screen - Haven

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Haven family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Haven family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Haven family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Haven | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Haven is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Unpack Vicinity Haven screen pieces and layout around workstation perimeter.
2. Slide Vicinity Workstation Clamps into pre-routed slots in the screen.
3. Align
the wrapped corner treatment to wrap neatly around the desk edges.
4. Tighten
clamp screws from the underside of desktop using an Allen key.
5. Ensure screen
sits firmly upright, enclosing rear and side boundaries securely.

**Manufacturer-stated limitations**

- Indoor use only; avoid wet
areas or direct liquid contact.
- Requires compatible desk edge overhang for
clamp engagement.
- Ensure wrap-around screen width matches exact workstation
desk size.
...
| --- | --- | --- |
| Acoustic Performance | 1.55 Sabins per
unit
(125Hz: 0.50, 250Hz: 1.00, 500Hz: 1.40, 1000Hz: 1.65, 2000Hz: 2.10, 4000Hz: 2.35) | ISO 354 |
| Dimensions | 2400 mm W x 600
mm H flat (wrapped to suit 1600 mm or 1800 mm desks, ~400 mm above desk) |  |
| Thickness | 12 mm (+/- 6%) |  |
| Material Composition | 100% polyester
fibre (PET) Cube panel; clamp: 100% recycled PET / zinc |  |
| Recycled Content | Minimum 80% post-consumer recycled
PET |  |
| Fire Rating (Australia) | Group 1, SMOGRArc < 100 m2/s2 | AS ISO 9705 - 2003 /
AS 5637.1:2015 |
| International Fire Classification | Group 1-S (ISO 9705:1993); Class A (ASTM E-84-15a: FS:0 - SD:45); BS
EN 13501-1:2018 | ISO 9705 / ASTM E-84 / BS EN 13501-1 |
