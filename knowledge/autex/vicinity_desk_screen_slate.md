---
id: autex-vicinity-desk-screen-slate
family_id: AUTEX_VICINITY_DESK_SCREEN_SLATE
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Slate
material: Polyester
...
# Autex Vicinity - Desk Screen - Slate

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Slate family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Slate family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Specialists in sustainable polyester acoustic solutions. Safe to handle without gloves or masks - perfect for DIY installation. Made from recycled plastic bottles, it's the sustainable choice for modern buildings. Perfect for achieving maximum thermal performance in roof/ceiling applications. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet - dries out naturally; excellent thermal performance for roof/ceiling applications; helps meet NCC energy efficiency requirements; Made from recycled PET bottles; Safe to handle without protective equipment This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Batt insulation product from Autex.
- Material: Polyester.
...
### Within the Autex Vicinity - Desk Screen - Slate family

- Internal Wall | Ceiling | General Acoustic

### Separate product families

Do not transfer claims from this family to other Autex product families without their own current technical evidence. Where Autex sells multiple product families within the Batt category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Autex Vicinity - Desk Screen - Slate | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Slate is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Inspect the desk edge to confirm
thickness is compatible with Vicinity Workstation Clamps.
2. Position the clamps
along the desk edge at recommended spacing (typically 150-200mm in from outer
edges).
3. Tighten the clamp thumb-screws or hex bolts securely to the desk
underside without overtightening.
4. Insert the 12mm or 24mm Vicinity Slate
screen into the clamp jaws.
5. Ensure the screen sits level and is properly
seated down into the bottom of each clamp channel.
6. Tighten the screen
retaining screws on the clamp to firmly secure the acoustic screen in place.

**Manufacturer-stated limitations**

- Designed for interior desk-mounting only; not for
floor-standing or outdoor use.
- Non-structural screen; cannot support heavy
monitor arms or mounted shelving.
- Avoid direct exposure to liquids or
...
| --- | --- | --- |
| Acoustic Absorption (Slate 800mm) | 0.50 Sabins per unit
(125Hz: 0.15, 250Hz: 0.30, 500Hz: 0.40, 1000Hz: 0.50, 2000Hz: 0.65, 4000Hz: 0.75) | ISO 354 |
| Thickness | 12 mm (+/- 6%)
| 24 mm (+/- 6%) |  |
| Dimensions (Slate) | 800 mm width (standard) or custom widths from 600 mm to 2400 mm;
height typically 400 mm to 600 mm above desk |  |
| Material Composition | 100% polyester fibre (PET) |  |
| Recycled Content | Minimum 80% post-consumer recycled
PET |  |
| Fire Rating (Australia) | Group 1, SMOGRArc < 100 m2/s2 | AS ISO 9705 - 2003 /
AS 5637.1:2015 |
| International Fire Rating | Group 1-S (ISO 9705:1993); Class A (ASTM E-84-15a: FS:0 - SD:45); B - s2, d0
(BS EN 13501-1:2018) | ISO 9705 / ASTM E-84 / BS EN 13501-1 |
| Water Vapour Sorption | 0.4% by weight after 4 days
at 49°C, 95% RH | ASTM C1104 / C1104M-13a |
| Microbial Resistance | Growth rating: 0 (No growth) | ASTM G21-15 |
| VOC Emissions | < 0.092 mg/m3 (7
days) | CDPH Standard Method v1.2 |
