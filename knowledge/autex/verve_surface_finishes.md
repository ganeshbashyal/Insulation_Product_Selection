---
id: autex-verve-surface-finishes
family_id: AUTEX_VERVE_SURFACE_FINISHES
manufacturer: Autex
category: Panel
canonical_name: Autex Verve - Surface Finishes
material: Polyester
...
# Autex Verve - Surface Finishes

## Purpose of this file

This is the canonical internal description for the Autex Verve - Surface Finishes family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Verve - Surface Finishes family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Verve - Surface Finishes family
...
| Requirement | Status for Autex Verve - Surface Finishes | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Verve - Surface Finishes is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Confirm substrate is plumb, flat, and
dry.
2. Inspect stone or texture pattern alignment across all panels before
fitting.
3. Apply high-grab MS polymer adhesive evenly across panel back or use
SpinFix clips.
4. Position panel, butt edges tightly at pattern low points, and
press firmly across face.
5. Ensure seamless continuity of contoured profile
across adjacent panels.
6. Trim top and bottom edges carefully with a track saw
or fine-toothed blade.

**Manufacturer-stated limitations**

- Indoor
use only; avoid wet areas or direct water exposure.
- Pinstripe design is
available in 12mm only.
- Panels must be installed in uniform vertical
orientation.
...
| Panel
Dimensions | 1170 mm width x 2680 mm length (or 2700 mm length) |  |
| Thickness Options | 12 mm (6 mm edge)
| 21 mm (15 mm edge) |  |
...
(ISO 9705:1993); BS EN 13501-1:2018 B - s1, d0 | ISO 9705 / BS
EN 13501-1 |
| Water Vapour Sorption | 0.4% by weight
after 4 days at 49°C, 95% RH | ASTM C1104 / C1104M-13a |
| Microbial Resistance | Growth rating: 0 (No growth) | ASTM G21-15 |
| VOC Emissions | < 0.092
mg/m3 (7 days) | CDPH Standard Method v1.2 |
