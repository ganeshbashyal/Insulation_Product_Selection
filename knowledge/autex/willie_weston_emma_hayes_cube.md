---
id: autex-willie-weston-emma-hayes-cube
family_id: AUTEX_WILLIE_WESTON_EMMA_HAYES_CUBE
manufacturer: Autex
category: Panel
canonical_name: Autex Willie Weston / Emma Hayes Cube
material: Polyester
...
This is the canonical internal description for the Autex Willie Weston / Emma Hayes Cube family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Willie Weston / Emma Hayes Cube family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Specialists in sustainable polyester acoustic solutions. Safe to handle without gloves or masks. Made from recycled plastic bottles for sustainability. Perfect for maximum thermal performance in roof/ceiling applications. Manufacturer-published features and benefits include: 100% polyester - safe to handle without protective equipment; contains minimum 80% recycled PET plastic bottles; non-allergenic, non-irritant formulation; will not support mould or mildew growth; maintains performance when wet; excellent thermal performance for roof/ceiling applications; Made from recycled PET bottles; Safe to handle without PPE This family covers 6 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.

## Current manufacturer-supported facts

- Product type: Panel insulation product from Autex.
- Material: Polyester.
...
### Within the Autex Willie Weston / Emma Hayes Cube family
...
| Requirement | Status for Autex Willie Weston / Emma Hayes Cube | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Willie Weston / Emma Hayes Cube is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Confirm substrate is plumb, flat, clean,
dry, and dust-free.
2. Acclimatise printed panels in the installation environment
for at least 24 hours.
3. Inspect panel pattern repeat and ensure sequence
alignment across adjacent panels.
4. Handle panels with clean hands or white
gloves to prevent marks on the printed artwork.
5. For adhesive direct fix, apply
recommended high-grab MS polymer adhesive evenly across panel backing.
6. Alternatively, mount using Autex SpinFix clips or Peel and Stick backing.
7. Butt panel edges tightly together and apply firm, uniform roller pressure
across the entire face.
8. Trim perimeter panels carefully from the face using a
straight edge and sharp utility knife on the offcut side.

**Manufacturer-stated limitations**

- Indoor use only; avoid wet areas or direct
exposure to running water.
- Printed decorative surface can be scuffed by heavy
mechanical abrasion; install in low-to-medium contact zones.
- Panel layout must
follow manufacturer pattern guide to maintain artwork alignment.
...
| --- | --- | --- |
| Noise Reduction Coefficient (NRC) | 12mm: 0.45 (direct
fix), 0.70 (with 24mm air gap); 24mm: 0.70 (direct fix), 0.80 (with 24mm air
gap) | ISO 354 |
| Sound Absorption Class | Class D (direct fix); Class C (with 24mm air gap) | ISO 11654 |
| Panel Dimensions | 1220 mm x 2440 mm; 1220 mm x 2740
mm; custom lengths up to 3000 mm / 3600 mm |  |
| Thickness | 12 mm (+/- 6%); 24 mm (+/- 6%) |  |
| Material Composition | 100% polyester fibre (PET) printed
with UV-curable ink |  |
...
| International Fire Rating | Group 1-S (ISO 9705:1993); Class A (ASTM
E-84-15a: FS:0 - SD:45); 12mm B - s2, d0; 24mm B - s2, d2 (BS EN 13501-1:2018) | ISO 9705 / ASTM E-84 / BS EN 13501-1 |
| Water
Vapour Sorption | 0.4% by weight after 4 days at 49°C, 95% RH | ASTM C1104 / C1104M-13a |
