---
id: autex-composition-velour-roll
family_id: AUTEX_COMPOSITION_VELOUR_ROLL
manufacturer: Autex
category: Panel
canonical_name: Autex Composition - Velour Roll
material: Polyester
...
# Autex Composition - Velour Roll

## Purpose of this file

This is the canonical internal description for the Autex Composition - Velour Roll family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Composition - Velour Roll family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Composition - Velour Roll family
...
| Requirement | Status for Autex Composition - Velour Roll | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Composition - Velour Roll is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
