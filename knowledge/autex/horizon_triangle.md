---
id: autex-horizon-triangle
family_id: AUTEX_HORIZON_TRIANGLE
manufacturer: Autex
category: Panel
canonical_name: Autex Horizon - Triangle
material: Polyester
...
# Autex Horizon - Triangle

## Purpose of this file

This is the canonical internal description for the Autex Horizon - Triangle family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Horizon - Triangle family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Horizon - Triangle family
...
| Requirement | Status for Autex Horizon - Triangle | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Horizon - Triangle is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
