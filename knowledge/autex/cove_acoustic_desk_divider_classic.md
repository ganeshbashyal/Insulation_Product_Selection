---
id: autex-cove-acoustic-desk-divider-classic
family_id: AUTEX_COVE_ACOUSTIC_DESK_DIVIDER_CLASSIC
manufacturer: Autex
category: Batt
canonical_name: Autex Cove Acoustic Desk Divider - Classic
material: Polyester
...
# Autex Cove Acoustic Desk Divider - Classic

## Purpose of this file

This is the canonical internal description for the Autex Cove Acoustic Desk Divider - Classic family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Cove Acoustic Desk Divider - Classic family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Cove Acoustic Desk Divider - Classic family
...
| Requirement | Status for Autex Cove Acoustic Desk Divider - Classic | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Cove Acoustic Desk Divider - Classic is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
