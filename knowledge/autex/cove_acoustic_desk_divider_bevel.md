---
id: autex-cove-acoustic-desk-divider-bevel
family_id: AUTEX_COVE_ACOUSTIC_DESK_DIVIDER_BEVEL
manufacturer: Autex
category: Batt
canonical_name: Autex Cove Acoustic Desk Divider - Bevel
material: Polyester
...
official_datasheet_url: https://www.autexacoustics.com.au/technical-documents/
...
# Autex Cove Acoustic Desk Divider - Bevel

## Purpose of this file

This is the canonical internal description for the Autex Cove Acoustic Desk Divider - Bevel family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Cove Acoustic Desk Divider - Bevel family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| Rw 35 | acoustic_rw | Varies | 794 x 538 | 2 |
...
### Within the Autex Cove Acoustic Desk Divider - Bevel family
...
| Requirement | Status for Autex Cove Acoustic Desk Divider - Bevel | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Cove Acoustic Desk Divider - Bevel is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.autexacoustics.com.au/technical-documents/

Safety Data Sheet: https://insulvac.com.au/wp-content/uploads/2020/04/autex-material-safety-data-sheet-msds.pdf


> Datasheet link confirmed https://www.autexacoustics.com.au/technical-documents/
