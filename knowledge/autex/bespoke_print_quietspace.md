---
id: autex-bespoke-print-quietspace
family_id: AUTEX_BESPOKE_PRINT_QUIETSPACE
manufacturer: Autex
category: Panel
canonical_name: Autex Bespoke Print Quietspace
material: Polyester
...
This is the canonical internal description for the Autex Bespoke Print Quietspace family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Bespoke Print Quietspace family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Bespoke Print Quietspace family
...
| Requirement | Status for Autex Bespoke Print Quietspace | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Bespoke Print Quietspace is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
