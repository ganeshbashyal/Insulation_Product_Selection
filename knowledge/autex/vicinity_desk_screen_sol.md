---
id: autex-vicinity-desk-screen-sol
family_id: AUTEX_VICINITY_DESK_SCREEN_SOL
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Sol
material: Polyester
...
# Autex Vicinity - Desk Screen - Sol

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Sol family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Sol family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Sol family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Sol | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Sol is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Verify desktop thickness is compatible
with the clamp jaws.
2. Position Vicinity Workstation Clamps along the desk edge
at designated centres.
3. Tighten clamp screws beneath the desk to anchor clamps
firmly in position.
4. Slide the curved Sol acoustic panel into the clamp
receiver slots.
5. Check that the screen is seated fully down and sits plumb.
6. Tighten the screen retaining screws to lock the Sol screen firmly in place.

**Manufacturer-stated limitations**

- Designed for interior desk mounting only; not
suitable for exterior use.
- Curved profile has lower total surface area
compared to full rectangular screens.
- Cannot support mounted accessories or
heavy equipment.
...
| --- | --- | --- |
| Acoustic Absorption (Sol 600mm) | 0.30 Sabins per unit
(125Hz: 0.10, 250Hz: 0.20, 500Hz: 0.25, 1000Hz: 0.35, 2000Hz: 0.40, 4000Hz: 0.45) | ISO 354 |
| Thickness | 12 mm (+/- 6%)
| 24 mm (+/- 6%) |  |
| Dimensions (Sol) | 600 mm width (standard) or custom widths from 600 mm to 1800 mm; height
typically 400 mm to 600 mm above desk |  |
