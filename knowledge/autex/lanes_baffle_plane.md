---
id: autex-lanes-baffle-plane
family_id: AUTEX_LANES_BAFFLE_PLANE
manufacturer: Autex
category: Batt
canonical_name: Autex Lanes Baffle Plane
material: Polyester
...
# Autex Lanes Baffle Plane

## Purpose of this file

This is the canonical internal description for the Autex Lanes Baffle Plane family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Lanes Baffle Plane family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Lanes Baffle Plane family
...
| Requirement | Status for Autex Lanes Baffle Plane | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Lanes Baffle Plane is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
