---
id: autex-vicinity-desk-screen-den
family_id: AUTEX_VICINITY_DESK_SCREEN_DEN
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Den
material: Polyester
...
# Autex Vicinity - Desk Screen - Den

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Den family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Den family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Den family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Den | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Den is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Unpack Vicinity Den panels and inspect screen
components.
2. Slide Vicinity Workstation Clamps into pre-cut slots on the screen
base.
3. Position screen and side return wing assembly onto desk corner
perimeter.
4. Tighten clamp bolts from underside of desktop using an Allen key
until firmly locked.
5. Confirm screen is plumb and securely seated along both
back and side edges.

**Manufacturer-stated limitations**

- Indoor use only; avoid direct water exposure.
- Desk top must allow clamp
fixing without under-frame interference.
- Ensure screen return wings do not
obstruct user access or cable ports.
...
| --- | --- | --- |
| Acoustic Performance | 0.75
Sabins per unit
(125Hz: 0.25, 250Hz: 0.50, 500Hz: 0.70, 1000Hz: 0.85, 2000Hz: 1.05, 4000Hz: 1.20) | ISO 354 |
| Dimensions | To suit 1600 mm
or 1800 mm desks (main back ~1190 mm W x 600 mm H with return wing) |  |
| Thickness | 12 mm (+/- 6%) |  |
