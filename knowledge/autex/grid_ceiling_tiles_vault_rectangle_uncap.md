---
id: autex-grid-ceiling-tiles-vault-rectangle-uncap
family_id: AUTEX_GRID_CEILING_TILES_VAULT_RECTANGLE_UNCAP
manufacturer: Autex
category: Panel
canonical_name: Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped
material: Polyester
...
# Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped

## Purpose of this file

This is the canonical internal description for the Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped family
...
| Requirement | Status for Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
