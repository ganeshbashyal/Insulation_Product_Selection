---
id: autex-horizon-hexagon
family_id: AUTEX_HORIZON_HEXAGON
manufacturer: Autex
category: Panel
canonical_name: Autex Horizon - Hexagon
material: Polyester
...
# Autex Horizon - Hexagon

## Purpose of this file

This is the canonical internal description for the Autex Horizon - Hexagon family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Horizon - Hexagon family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Horizon - Hexagon family
...
| Requirement | Status for Autex Horizon - Hexagon | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Horizon - Hexagon is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
