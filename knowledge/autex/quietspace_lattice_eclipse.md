---
id: autex-quietspace-lattice-eclipse
family_id: AUTEX_QUIETSPACE_LATTICE_ECLIPSE
manufacturer: Autex
category: Panel
canonical_name: Autex Quietspace Lattice - Eclipse
material: Polyester
...
# Autex Quietspace Lattice - Eclipse

## Purpose of this file

This is the canonical internal description for the Autex Quietspace Lattice - Eclipse family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Quietspace Lattice - Eclipse family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Quietspace Lattice - Eclipse family
...
| Requirement | Status for Autex Quietspace Lattice - Eclipse | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Quietspace Lattice - Eclipse is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
