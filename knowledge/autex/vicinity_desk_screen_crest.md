---
id: autex-vicinity-desk-screen-crest
family_id: AUTEX_VICINITY_DESK_SCREEN_CREST
manufacturer: Autex
category: Batt
canonical_name: Autex Vicinity - Desk Screen - Crest
material: Polyester
...
# Autex Vicinity - Desk Screen - Crest

## Purpose of this file

This is the canonical internal description for the Autex Vicinity - Desk Screen - Crest family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Vicinity - Desk Screen - Crest family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Vicinity - Desk Screen - Crest family
...
| Requirement | Status for Autex Vicinity - Desk Screen - Crest | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Vicinity - Desk Screen - Crest is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Unpack Vicinity Crest panels and inspect
components.
2. Slide Vicinity Workstation Clamps into pre-cut sockets along the
bottom edge of the screen.
3. Position the screen assembly along the edge of the
desk at desired location.
4. Tighten the clamp mounting bolts from the underside
using an Allen key until firmly clamped to desktop.
5. Check screen is upright
and stable without over-tightening.

**Manufacturer-stated limitations**

- Indoor use only; avoid wet areas or direct liquid contact.
- Clamp requires a
solid desk edge with adequate overhang.
- Product has a directional grain;
...
| --- | --- | --- |
| Acoustic Performance | 0.70 Sabins per
unit
(125Hz: 0.20, 250Hz: 0.45, 500Hz: 0.60, 1000Hz: 0.75, 2000Hz: 0.95, 4000Hz: 1.05) | ISO 354 |
| Dimensions | 1190 mm width
x 600 mm height (to suit 1600 mm desks, sits ~400 mm above desk) |  |
| Thickness | 12 mm (+/- 6%) |  |
| Material Composition | 100% polyester fibre (PET) Cube
panel; clamp: 100% recycled PET / zinc |  |
| Recycled Content | Minimum 80% post-consumer recycled PET |  |
| Fire Rating (Australia) | Group 1,
SMOGRArc < 100 m2/s2 | AS ISO 9705 - 2003 / AS 5637.1:2015 |
| International Fire Classification | Group 1-S
(ISO 9705:1993); Class A (ASTM E-84-15a: FS:0 - SD:45); BS EN 13501-1:2018 | ISO 9705 / ASTM E-84 / BS EN 13501-1 |
| Water
