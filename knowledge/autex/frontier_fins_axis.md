---
id: autex-frontier-fins-axis
family_id: AUTEX_FRONTIER_FINS_AXIS
manufacturer: Autex
category: Batt
canonical_name: Autex Frontier Fins - Axis
material: Polyester
...
# Autex Frontier Fins - Axis

## Purpose of this file

This is the canonical internal description for the Autex Frontier Fins - Axis family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Frontier Fins - Axis family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Frontier Fins - Axis family
...
| Requirement | Status for Autex Frontier Fins - Axis | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Frontier Fins - Axis is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
