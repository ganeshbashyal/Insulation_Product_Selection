---
id: autex-frontier-fins-standard-kit
family_id: AUTEX_FRONTIER_FINS_STANDARD_KIT
manufacturer: Autex
category: Batt
canonical_name: Autex Frontier Fins - Standard Kit
material: Polyester
...
# Autex Frontier Fins - Standard Kit

## Purpose of this file

This is the canonical internal description for the Autex Frontier Fins - Standard Kit family (Batt category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Frontier Fins - Standard Kit family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| --- | --- | ---: | --- | ---: |
| Rw 35 | acoustic_rw | 12 | 2400 x 150 | 1 |
| Rw 35 | acoustic_rw | 24 | 2400 x 150 | 1 |
| Rw 35 | acoustic_rw | 12 | 2400 x 300 | 1 |
| Rw 35 | acoustic_rw | 24 | 2400 x 300 | 1 |
...
### Within the Autex Frontier Fins - Standard Kit family
...
| Requirement | Status for Autex Frontier Fins - Standard Kit | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Frontier Fins - Standard Kit is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
