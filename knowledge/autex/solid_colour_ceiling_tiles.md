---
id: autex-solid-colour-ceiling-tiles
family_id: AUTEX_SOLID_COLOUR_CEILING_TILES
manufacturer: Autex
category: Panel
canonical_name: Autex Solid Colour Ceiling Tiles
material: Polyester
...
This is the canonical internal description for the Autex Solid Colour Ceiling Tiles family (Panel category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Autex Solid Colour Ceiling Tiles family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Autex Solid Colour Ceiling Tiles family
...
| Requirement | Status for Autex Solid Colour Ceiling Tiles | Enquiry-bot action |
| --- | --- | --- |
...
> Autex Solid Colour Ceiling Tiles is a manufacturer-supported product family used for acoustic performance (Rw/NRC). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
