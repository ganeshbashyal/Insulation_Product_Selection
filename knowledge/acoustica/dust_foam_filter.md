---
id: acoustica-dust-foam-filter
family_id: ACOUSTICA_DUST_FOAM_FILTER
manufacturer: Acoustica
category: Accessory
canonical_name: Acoustica Dust foam filter
material: Accessory
...
official_datasheet_url: https://acoustica.com.au/technical-information/
official_sds_url: https://acoustica.com.au/
product_count: 1
rating_basis: thermal
---

# Acoustica Dust foam filter

## Purpose of this file

This is the canonical internal description for the Acoustica Dust foam filter family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Acoustica Dust foam filter family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Accessory insulation product from Acoustica.
- Material: Accessory.
...
### Within the Acoustica Dust foam filter family
...
| Requirement | Status for Acoustica Dust foam filter | Enquiry-bot action |
| --- | --- | --- |
...
> Acoustica Dust foam filter is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://acoustica.com.au/technical-information/

Safety Data Sheet: https://acoustica.com.au/


> Datasheet link confirmed https://acoustica.com.au/technical-information/
...
Source currently recorded: https://acoustica.com.au/technical-information/
