---
id: acoustica-angelstep
family_id: ACOUSTICA_ANGELSTEP
manufacturer: Acoustica
category: Underlay
canonical_name: Acoustica AngelStep
...
### Within the Acoustica AngelStep family

- Floor | Acoustic Floor

### Separate product families

Do not transfer claims from this family to other Acoustica product families without their own current technical evidence. Where Acoustica sells multiple product families within the Underlay category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Acoustica AngelStep | Enquiry-bot action |
| --- | --- | --- |
...
> Acoustica AngelStep is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
