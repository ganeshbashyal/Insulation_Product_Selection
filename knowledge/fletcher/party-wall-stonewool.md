...
| --- | --- | --- |
| Material | Bio-soluble stonewool (rock mineral wool)
fibres |  |
| Batt Dimensions | 1200 mm
length x 168 mm width x 100 mm thickness |  |
| Blanket Dimensions | 300 mm or 360 mm width x 50 mm / 75 mm thickness
x 4000 mm length |  |
...
| Required Installation Compression | Minimum 20% compression (leaving
zero voids) | NCC Part 9.3 |
| Product Codes | FLE000062-3 (Batts), FLE000064 (Blanket) |  |
