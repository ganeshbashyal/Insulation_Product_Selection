...
| --- | --- | --- |
| Material | Semi-rigid glasswool
board with Sisalation reflective foil laminate facing |  |
| Thermal Conductivity | 0.032 W/m·K at 23°C | ASTM C518 |
| Material R-values | R1.5 (50mm), R2.0
(65mm), R2.5 (80mm), R3.0 (95mm), R3.5 (110mm) | AS/NZS 4859.1 |
| Thicknesses | 50 mm, 65 mm, 80 mm, 95 mm, 110 mm |  |
| Board Dimensions | 1200 mm width
x 2400 mm length |  |
| Combustibility (Core) | Non-combustible | AS 1530.1 |
| Fire
Hazard Classification | Group 1 | AS 5637.1 / AS
ISO 9705 |
| Early Fire Hazard Indices | Ignitability: 0, Spread of Flame: 0, Heat Evolved: 0, Smoke Developed: 0-1 | AS/NZS 1530.3 |
| Acoustic Performance | High sound absorption under concrete slabs (NRC up to 1.00) | ISO 354 |
