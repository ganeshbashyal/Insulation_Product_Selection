---
id: ametalin-cavity-drainage-battens
family_id: AMETALIN_CAVITY_DRAINAGE_BATTENS
manufacturer: Ametalin
category: Accessory
canonical_name: Ametalin Cavity Drainage Battens
material: Accessory
...
# Ametalin Cavity Drainage Battens

## Purpose of this file

This is the canonical internal description for the Ametalin Cavity Drainage Battens family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Ametalin Cavity Drainage Battens family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Engineered to meet the demanding requirements of Australian building conditions. Manufacturer-published features and benefits include: Quality insulation product for Australian building conditions; designed to meet NCC energy efficiency requirements This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Ametalin Cavity Drainage Battens family
...
| Requirement | Status for Ametalin Cavity Drainage Battens | Enquiry-bot action |
| --- | --- | --- |
...
> Ametalin Cavity Drainage Battens is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
