---
id: ametalin-quick-tape-blue
family_id: AMETALIN_QUICK_TAPE_BLUE
manufacturer: Ametalin
category: Accessory
canonical_name: Ametalin Quick Tape Blue
...
# Ametalin Quick Tape Blue

## Purpose of this file

This is the canonical internal description for the Ametalin Quick Tape Blue family (Accessory category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Ametalin Quick Tape Blue family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
- Product type: Accessory insulation product from Ametalin.
- Material: Tape / Sealant.
...
| --- | --- | ---: | --- | ---: |
| R0.1 | thermal_r_value | Varies | 50000 x 48 | 1 |
...
### Within the Ametalin Quick Tape Blue family
...
| Requirement | Status for Ametalin Quick Tape Blue | Enquiry-bot action |
| --- | --- | --- |
...
> Ametalin Quick Tape Blue is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.ametalin.com/wp-content/uploads/PDFs/TDS/ThermalBreak-Technical-Data-Sheet_APM-45758-2.pdf

Safety Data Sheet: https://pricewiseinsulation.com.au/wp-content/uploads/2023/09/ametalin-thermalbreak-product-data-sheet_2023.pdf
...
```json
{
  ...
  "source_url": "https://www.ametalin.com/wp-content/uploads/PDFs/TDS/ThermalBreak-Technical-Data-Sheet_APM-45758-2.pdf"
}
```
...
| --- | --- | --- |
| Performance rating(s) | Manufacturer-published, not yet SKU-matched to current TDS | https://www.ametalin.com/wp-content/uploads/PDFs/TDS/ThermalBreak-Technical-Data-Sheet_APM-45758-2.pdf |
| Material composition | Manufacturer-claimed | https://www.ametalin.com/wp-content/uploads/PDFs/TDS/ThermalBreak-Technical-Data-Sheet_APM-45758-2.pdf |
| Fire performance | Not verified per SKU | Pending SDS/test report review |
| Installation guidance | Extracted from manufacturer spec text (see above) | https://www.ametalin.com/wp-content/uploads/PDFs/TDS/ThermalBreak-Technical-Data-Sheet_APM-45758-2.pdf |
