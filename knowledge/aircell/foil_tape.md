---
id: aircell-foil-tape
family_id: AIRCELL_FOIL_TAPE
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Foil Tape
...
This is the canonical internal description for the Aircell Foil Tape family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Foil Tape family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Aircell Foil Tape family
...
| Requirement | Status for Aircell Foil Tape | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Foil Tape is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://www.insulation.kingspan.com/au/en/products/insulation-tape0?tab=technicalInformation
