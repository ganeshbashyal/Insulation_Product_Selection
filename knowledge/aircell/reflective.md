---
id: aircell-reflective
family_id: AIRCELL_REFLECTIVE
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Reflective
...
This is the canonical internal description for the Aircell Reflective family. It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.
...
- The catalogue includes 23 unique SKU variant(s) in this family.
...
| --- | --- | ---: | --- | ---: |
| Not specified | unspecified | Varies | 22250 x 1350 | 4 |
| Not specified | unspecified | 55 | 22250 x 1350 | 3 |
| Not specified | unspecified | 70 | 22250 x 1350 | 2 |
| Not specified | unspecified | 90 | 22250 x 1350 | 2 |
...
| Not specified | unspecified | Varies | 5930 x 1350 | 1 |
...
Do not transfer claims from this family to other Aircell product families without their own current technical evidence. Where Aircell sells multiple categories (batt, board, reflective, pipe, wrap, panel, accessory), each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Aircell Reflective | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Reflective is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
The master product catalogue provides current commercial records for 23 SKUs, including internal SKU codes, dimensions, grade labels and stock. Commercial data does not validate technical performance; grade labels must be cross-checked against current manufacturer TDS per SKU before quoting.
