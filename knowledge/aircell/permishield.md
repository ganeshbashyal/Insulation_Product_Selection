---
id: aircell-permishield
family_id: AIRCELL_PERMISHIELD
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Permishield
...
official_datasheet_url: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permishield-xv-70-au-and-nz/kingspan-aircell-permishieldxv-product-datasheet-en-au.pdf
...
This is the canonical internal description for the Aircell Permishield family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.
...
### Within the Aircell Permishield family
...
| Requirement | Status for Aircell Permishield | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Permishield is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permishield-xv-70-au-and-nz/kingspan-aircell-permishieldxv-product-datasheet-en-au.pdf
...
> Datasheet link confirmed https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permishield-xv-70-au-and-nz/kingspan-aircell-permishieldxv-product-datasheet-en-au.pdf
