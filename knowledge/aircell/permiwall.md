---
id: aircell-permiwall
family_id: AIRCELL_PERMIWALL
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Permiwall
...
official_datasheet_url: https://www.insulation.kingspan.com/au/en/products/insulation
...
This is the canonical internal description for the Aircell Permiwall family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Permiwall family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Aircell Permiwall family
...
| Requirement | Status for Aircell Permiwall | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Permiwall is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://www.insulation.kingspan.com/au/en/products/insulation
...
> Datasheet link confirmed https://www.insulation.kingspan.com/au/en/products/insulation
