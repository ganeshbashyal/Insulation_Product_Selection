---
id: aircell-retroshield-handypack
family_id: AIRCELL_RETROSHIELD_HANDYPACK
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Retroshield Handypack
...
# Aircell Retroshield Handypack

## Purpose of this file

This is the canonical internal description for the Aircell Retroshield Handypack family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Retroshield Handypack family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Aircell Retroshield Handypack family
...
| Requirement | Status for Aircell Retroshield Handypack | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Retroshield Handypack is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
