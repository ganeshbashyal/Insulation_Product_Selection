---
id: aircell-insulwhite
family_id: AIRCELL_INSULWHITE
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Insulwhite
...
This is the canonical internal description for the Aircell Insulwhite family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Insulwhite family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Aircell Insulwhite family
...
| Requirement | Status for Aircell Insulwhite | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Insulwhite is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulwhite-au-and-nz/kingspan-aircell-insulwhite-product-datasheet-en-au.pdf
