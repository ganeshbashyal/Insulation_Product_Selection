---
id: aircell-insulshed
family_id: AIRCELL_INSULSHED
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Insulshed
...
official_datasheet_url: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulshed-50-au-and-nz/kingspan-aircell-insulshed-product-datasheet-en-au.pdf
...
This is the canonical internal description for the Aircell Insulshed family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Insulshed family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
### Within the Aircell Insulshed family
...
| Requirement | Status for Aircell Insulshed | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Insulshed is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulshed-50-au-and-nz/kingspan-aircell-insulshed-product-datasheet-en-au.pdf
...
> Datasheet link confirmed https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulshed-50-au-and-nz/kingspan-aircell-insulshed-product-datasheet-en-au.pdf
