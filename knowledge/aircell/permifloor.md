---
id: aircell-permifloor
family_id: AIRCELL_PERMIFLOOR
manufacturer: Aircell
category: Reflective
canonical_name: Aircell Permifloor
...
official_datasheet_url: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permifloor-au-and-nz/kingspan-aircell-permifloor-product-datasheet-en-au.pdf
...
This is the canonical internal description for the Aircell Permifloor family (Reflective category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Aircell Permifloor family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Quality insulation engineered for Australian conditions. Reflects up to 97% of radiant heat, dramatically reducing summer cooling costs while providing an effective vapour barrier. Rigid design makes installation fast and efficient - no sagging or falling out. Essential for achieving NCC compliance in floor applications. Manufacturer-published features and benefits include: High-purity aluminium reflective facing; reflects up to 97% of radiant heat; lightweight and easy to install; provides vapour barrier when properly sealed; rigid design prevents sagging between joists; reduces drafts and cold floors This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Aircell Permifloor family
...
| Requirement | Status for Aircell Permifloor | Enquiry-bot action |
| --- | --- | --- |
...
> Aircell Permifloor is a manufacturer-supported product family used for thermal and/or acoustic performance (rating not yet confirmed per SKU). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Technical Data Sheet: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permifloor-au-and-nz/kingspan-aircell-permifloor-product-datasheet-en-au.pdf
...
> Datasheet link confirmed https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-permifloor-au-and-nz/kingspan-aircell-permifloor-product-datasheet-en-au.pdf
