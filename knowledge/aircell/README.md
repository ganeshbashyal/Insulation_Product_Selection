...
Bot-facing knowledge for Aircell products. Each file represents a technical family, not an individual stock SKU.

## Family index

| Family ID | Product family | Evidence status |
| --- | --- | --- |
| `AIRCELL_REFLECTIVE` | Aircell Reflective | Initial documentation |
