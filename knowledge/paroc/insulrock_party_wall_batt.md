---
id: paroc-insulrock-party-wall-batt
family_id: PAROC_INSULROCK_PARTY_WALL_BATT
manufacturer: Paroc
category: Batt
canonical_name: Paroc InsulRock Party Wall Batt
...
| --- | --- | ---: | --- | ---: |
| R1.0 | thermal_r_value | 100 | 1200 x 168 | 1 |
...
### Within the Paroc InsulRock Party Wall Batt family
...
| Requirement | Status for Paroc InsulRock Party Wall Batt | Enquiry-bot action |
| --- | --- | --- |
...
> Paroc InsulRock Party Wall Batt is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
Source currently recorded: https://www.paroc.com/en
