...
This is the canonical internal description for the Kingspan K3 family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Kingspan K3 family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.
...
| Requirement | Status for Kingspan K3 | Enquiry-bot action |
| --- | --- | --- |
...
> Kingspan K3 is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Prepare level, well-compacted
sub-base blinding layer (sand or lean-mix concrete).
2. Lay damp-proof membrane
(DPM / 0.2mm polyethylene vapor barrier) over the blinding layer with 150mm
taped overlaps.
3. Lay Kooltherm K3 Floorboards tightly butted in a staggered
brick-bond pattern over the DPM.
4. For suspended floors, lay boards over flat
concrete slab surface.
5. Cut boards neatly around internal plumbing and service
penetrations with a fine-toothed hand saw.
6. Place a separating slip-sheet
(0.2mm polythene) over the boards with taped 150mm overlaps to prevent concrete
slurry ingress.
7. Place bar chairs and reinforcement mesh over the separating
layer, taking care not to puncture the insulation.
8. Pour concrete slab directly
over the assembly.

**Manufacturer-stated limitations**

- For concentrated industrial heavy forklift loads, specify
high-compressive XPS (e.g. GreenGuard GG500).
- Must be installed with a
continuous damp-proof membrane beneath.
- Protect boards from site traffic prior
to concrete pouring.
...
| --- | --- | --- |
| Thermal Conductivity (lambda) | 0.021 W/m·K (thicknesses
≥ 45mm), 0.023 W/m·K (thicknesses 25-44mm) | AS/NZS 4859.1 |
| Material R-values | R1.1 (25mm), R1.3 (30mm), R1.75
(40mm), R2.15 (50mm), R2.6 (60mm), R3.0 (70mm), R3.45 (80mm), R3.9 (90mm) | AS/NZS 4859.1 |
| Thickness Options | 25
mm, 30 mm, 40 mm, 50 mm, 60 mm, 70 mm, 80 mm, 90 mm |  |
| Board Dimensions | 2400 mm x 1200 mm (2.88 m²) |  |
| Compressive Strength | ≥ 150 kPa
at 10% deformation | AS 2498.3 |
