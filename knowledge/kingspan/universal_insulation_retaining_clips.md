---
id: kingspan-universal-insulation-retaining-clips
family_id: KINGSPAN_UNIVERSAL_INSULATION_RETAINING_CLIPS
manufacturer: Kingspan
category: Board
canonical_name: Kingspan Universal Insulation Retaining Clips
material: Phenolic
...
This is the canonical internal description for the Kingspan Universal Insulation Retaining Clips family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Kingspan Universal Insulation Retaining Clips family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Global leader in high-performance insulation solutions. Ultra-thin, ultra-efficient. Maximum thermal performance when space is at a premium. Manufacturer-published features and benefits include: Ultra-low thermal conductivity phenolic foam; highest thermal performance in thin profiles; fire-resistant with low smoke emission; dimensionally stable over wide temperature range; Global leader in high-performance insulation; zero ODP manufacturing This family covers 1 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Kingspan Universal Insulation Retaining Clips family
...
| Requirement | Status for Kingspan Universal Insulation Retaining Clips | Enquiry-bot action |
| --- | --- | --- |
...
> Kingspan Universal Insulation Retaining Clips is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Bed wall ties into inner
masonry leaf mortar joints at specified vertical and horizontal intervals.
2. Push Kooltherm K8 Cavity Board over the wall ties and position flat against the
inner leaf.
3. Slide Universal Insulation Retaining Clip over the protruding end
of each wall tie.
4. Push clip firmly along the tie until it presses tightly
against the outer face of the insulation board.
5. Ensure clip locks onto tie
notches, holding the board flat and immovable.
6. Maintain a minimum of 2 to 3
retaining clips per 1200x450mm board (at least one clip per tie).
7. Verify the
residual drainage cavity between the board and outer brick leaf remains
completely clear.

**Manufacturer-stated limitations**

- Designed for cavity wall ties; not suitable for direct masonry screw or nail
fixing.
- Must not be forced onto oversized ties exceeding clip aperture to
prevent cracking.
- Non-structural accessory; does not carry structural wall
loads.
...
| Insulation Compatibility | Rigid
boards (Kooltherm K8, PIR, XPS) and semi-rigid mineral wool slabs |  |
