...
This is the canonical internal description for the Kingspan K12 family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Kingspan K12 family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Global leader in high-performance insulation solutions. Ultra-thin, ultra-efficient. Maximum thermal performance when space is at a premium. Manufacturer-published features and benefits include: Ultra-low thermal conductivity phenolic foam; highest thermal performance in thin profiles; fire-resistant with low smoke emission; dimensionally stable over wide temperature range; Global leader in high-performance insulation; zero ODP manufacturing This family covers 8 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Kingspan K12 family
...
| Requirement | Status for Kingspan K12 | Enquiry-bot action |
| --- | --- | --- |
...
> Kingspan K12 is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
1. Cut boards to width to fit
tightly between framing studs or install continuously across framing face.
2. For
friction-fit between studs, cut boards 5mm wider than opening and push firmly
into cavity.
3. For continuous installation over framing, fasten with screws and
broad washers at 300mm perimeter centers.
4. For Low-Rise Wall Solution on
concrete/masonry, apply Kooltherm K12 Adhesive in vertical beads and press board
to wall.
5. Tape all board joints with 72mm reinforced aluminum foil tape to
maintain continuous vapor and thermal barrier.
6. Maintain minimum 20mm still air
cavity where reflective air-space R-value is calculated.

**Manufacturer-stated limitations**

- For
Class 2-9 buildings of Type A or B fire-resisting construction, a Performance
Solution is required.
- Must not be left exposed to direct weather without
protective wall wrap and cladding.
...
| Material R-values | R1.1 (25mm),
R1.3 (30mm), R1.75 (40mm), R2.15 (50mm), R2.6 (60mm), R3.0 (70mm), R3.45 (80mm),
R3.9 (90mm), R4.35 (100mm) | AS/NZS 4859.1 |
| Thickness Options | 25 mm, 30 mm, 40 mm, 50 mm, 60 mm, 70 mm, 80
mm, 90 mm, 100 mm |  |
| Board Dimensions | 2400 mm x 1200 mm (2.88 m²) |  |
| Compressive
Strength | ≥ 100 kPa at 10% deformation | AS 2498.3 |
| Facing Emittance | 0.03 - 0.05 | AS/NZS 4201.5 |
| Water Vapor Resistance | > 100
MN·s/g |  |
