# Kingspan product-family knowledge base

Bot-facing knowledge for Kingspan products. Each file represents a technical family, not an individual stock SKU.

## Family index

| Family ID | Product family | Evidence status |
| --- | --- | --- |
| `KINGSPAN_BOARD` | Kingspan Board | Initial documentation |
