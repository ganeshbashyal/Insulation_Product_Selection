---
id: kingspan-xps-strip-slap-edge-insulation
family_id: KINGSPAN_XPS_STRIP_SLAP_EDGE_INSULATION
manufacturer: Kingspan
category: Board
canonical_name: Kingspan XPS Strip Slap Edge Insulation
material: Phenolic
...
This is the canonical internal description for the Kingspan XPS Strip Slap Edge Insulation family (Board category). It aligns the terminology used by the enquiry bot, sales team and future Aircall CSV.

For the demonstration, the bot may recommend the **Kingspan XPS Strip Slap Edge Insulation family** when the customer's problem matches its documented applications. It must not choose a specific grade, calculate order quantity, or confirm thermal, acoustic, fire, NCC or BAL compliance for a project. Those decisions remain human-reviewed.

## Canonical description

Global leader in high-performance insulation solutions. Ultra-thin, ultra-efficient. Maximum thermal performance when space is at a premium. Rigid design makes installation fast and efficient. Manufacturer-published features and benefits include: Ultra-low thermal conductivity phenolic foam; highest thermal performance in thin profiles; fire-resistant with low smoke emission; dimensionally stable over wide temperature range; rigid design prevents sagging between joists; reduces drafts and cold floors; Global leader in high-performance insulation; zero ODP manufacturing This family covers 2 SKU variant(s) in the current catalogue. It is not a complete compliant building system on its own; project-specific claims about a finished construction must be confirmed by a human reviewer against a tested system that matches the proposed build-up.
...
### Within the Kingspan XPS Strip Slap Edge Insulation family

- Underfloor

### Separate product families

Do not transfer claims from this family to other Kingspan product families without their own current technical evidence. Where Kingspan sells multiple product families within the Board category or in other categories, each is a distinct family with its own grade table and evidence.
...
| Requirement | Status for Kingspan XPS Strip Slap Edge Insulation | Enquiry-bot action |
| --- | --- | --- |
...
> Kingspan XPS Strip Slap Edge Insulation is a manufacturer-supported product family used for thermal insulation (R-value). The right grade depends on the complete construction and project requirements. I can collect the details for our team to review.
...
> Datasheet link audited 2026-09-05: repointed to the verified manufacturer site. Exact product TDS deep link still to be sourced; legacy reference: https://www.archiclad.com.au/wp-content/uploads/2023/04/kingspan-greenguard-300-500-700-product-datasheet-en-au.pdf
...
1. Position GreenGuard XPS strips vertically against the inside face of perimeter
slab formwork prior to pouring concrete.
2. Ensure strips span the full depth of
the slab edge (typically 300mm height).
3. Butt strip ends tightly together and
seal joins with heavy-duty waterproof tape.
4. Secure strips to formwork with
temporary double-sided tape or mechanical pins.
5. Place damp-proof membrane
(DPM) under slab, turning it up behind the XPS strip.
6. Pour concrete slab
directly against the XPS strip, ensuring full consolidation without dislodging
panels.
7. Strip formwork after concrete curing; ensure exposed outer face of XPS
is protected by parging or flashing.

**Manufacturer-stated limitations**

- Exposed above-ground XPS must be protected from UV sunlight
using a parge coat, render, or metal flashing.
- Must not come into direct
contact with solvent-based waterproofing, coal tar, or petrol.
- Maximum service
temperature is 75°C.
...
| --- | --- | --- |
| Material | Rigid extruded polystyrene (XPS)
closed-cell foam |  |
| Compressive Strength (at 10%
deflection) | 350 kPa | AS 2498.3 |
| Thermal Conductivity (lambda) | 0.028 W/m·K at 10°C, 0.030 W/m·K
at 23°C | ASTM C518 |
| Thermal Resistance
(R-value) | R1.0 (40mm) | AS/NZS 4859.1 |
...
| Water Vapor
Permeance | Resistant to the passage of water vapor (< 0.05 µg/N·s) | ASTM E96 |
