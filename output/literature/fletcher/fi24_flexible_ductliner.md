...
> Insulation shall be FI24 Flexible Ductliner (hvac) by Fletcher, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://insulation.com.au/product/fi24-flexible-ductliner/.
