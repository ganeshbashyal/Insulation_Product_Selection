...
> Insulation shall be Polyester Solutions Wall Block - Baffle block Batts (batt) by Polyester Solutions, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.
