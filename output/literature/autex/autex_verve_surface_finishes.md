...
| --- | --- | --- |
| Verve Surface Finishes 12mm | 1170 mm x 2680 mm x 12 mm (6 mm edge) | Panel |
| Verve Surface Finishes 21mm | 1170 mm x 2680 mm x 21 mm (15 mm edge) | Panel |
...
> Insulation shall be Autex Verve - Surface Finishes (panel) by Autex, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.
