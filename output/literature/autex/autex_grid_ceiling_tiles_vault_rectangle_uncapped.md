...
> Insulation shall be Autex Grid Ceiling Tiles - Vault - Rectangle - Uncapped (panel) by Autex, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.
