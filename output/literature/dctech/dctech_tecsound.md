---
title: "DCTech Tecsound - Acoustic Barrier Insulation | DCTech"
description: "Tecsound is a high-density, polymer-based asphalt-free synthetic soundproofing membrane, which is visco-elastic and highly adaptable, providing good a"
keywords: "DCTech Tecsound, DCTech acoustic barrier, wall insulation, ceiling insulation, roof insulation, floor insulation, pipe insulation, duct insulation, insulation Australia, DCTech Australia"
...
Tecsound is a high-density, polymer-based asphalt-free synthetic soundproofing membrane, which is visco-elastic and highly adaptable, providing good acoustic insulation across different construction elements without increasing thickness. Engineered for airborne noise insulation in vertical partitions, ceilings, roofs, and machinery enclosures, it also dampens rain impact noise on metal roofs and impact sound in floating floors. Distributed in Australia by DCTech, it is available in standard, self-adhesive (SY), and composite felt (2FT) configurations.

## Key features

- High acoustic insulation without adding significant thickness.
- Visco-elastic damping material reducing structural resonance and vibration.
...
- High elongation capacity and adaptable to uneven surfaces.
- Damping of impact noise produced by atmospheric agents on metal roofs.
- Ideal for airborne noise reduction in lightweight partitions and ceilings.
...
> Insulation shall be DCTech Tecsound (acoustic barrier) by DCTech, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://dctech.com.au/wp-content/uploads/2018/09/DCT_Industrial_Insulation_Brochure.pdf.
