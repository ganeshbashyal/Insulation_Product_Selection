...
# NuWave Acoustic Floor Underlay

**Thermotec Acoustic underlay** — acoustic underlay insulation product.

NuWave Acoustic Floor Underlay is a acoustic underlay product family from Thermotec. Confirm the current published specification against the manufacturer datasheet before quoting.
...
| --- | --- | --- |
| Product type | Acoustic underlay | Manufacturer catalogue |
...
> Insulation shall be NuWave Acoustic Floor Underlay (acoustic underlay) by Thermotec, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://thermotec.com.au/products/carpet-underlay.
