---
title: "NuWave UV-treated Fence MLV - Outdoor acoustic barrier Insulation | Thermotec"
description: "NuWave UV-treated Fence MLV is a outdoor acoustic barrier insulation product family from Thermotec. View the catalogue range, applications and specifi"
keywords: "NuWave UV-treated Fence MLV, Thermotec outdoor acoustic barrier, acoustic insulation, R-value insulation, insulation Australia, Thermotec Australia"
...
**Thermotec Outdoor acoustic barrier** — outdoor acoustic barrier insulation product.

NuWave UV-treated Fence MLV is a outdoor acoustic barrier product family from Thermotec. Confirm the current published specification against the manufacturer datasheet before quoting.
...
| --- | --- | --- |
| Product type | Outdoor acoustic barrier | Manufacturer catalogue |
| Material | Mass Loaded Vinyl | Manufacturer catalogue |
| Applications | acoustic fence; outdoor barrier; plant enclosure | Manufacturer catalogue |
...
> Insulation shall be NuWave UV-treated Fence MLV (outdoor acoustic barrier) by Thermotec, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://thermotec.com.au/.
