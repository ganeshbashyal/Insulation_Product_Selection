...
# NuWrap 5 Acoustic Pipe Lagging
...
- BAL: not verified.
- Datasheet: https://thermotec.com.au/products/nuwrap-acoustic-lagging (link audited 2026-09-05; exact product TDS may still be pending).
- SDS: to be sourced.
...
> Insulation shall be NuWrap 5 Acoustic Pipe Lagging (acoustic lagging) by Thermotec, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://thermotec.com.au/products/nuwrap-acoustic-lagging.
