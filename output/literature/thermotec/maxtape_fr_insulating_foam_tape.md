...
# MaxTape FR Insulating Foam Tape
...
> Insulation shall be MaxTape FR Insulating Foam Tape (accessory) by Thermotec, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://thermotec.com.au/products/thermotec-maxflex-insulating-foam-tape.
