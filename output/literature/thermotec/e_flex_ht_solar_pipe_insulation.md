...
# E-Flex HT Solar Pipe Insulation
...
> Insulation shall be E-Flex HT Solar Pipe Insulation (high-temperature pipe) by Thermotec, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://thermotec.com.au/products/thermotec-e-flex-ht-solar-pipe-insulation.
