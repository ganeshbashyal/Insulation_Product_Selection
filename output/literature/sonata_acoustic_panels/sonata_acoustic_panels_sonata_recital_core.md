...
> Insulation shall be Sonata Acoustic Panels Sonata Recital Core (panel) by Sonata Acoustic Panels, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://sonataacousticpanels.com.au/.
- SRC-02 Safety data sheet: https://sonataacousticpanels.com.au/.
