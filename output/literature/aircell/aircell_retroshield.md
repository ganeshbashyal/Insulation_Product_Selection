...
| Variant | Thickness | Roll Width | Roll Length | Roll Area | Roll Weight | Roll Diameter | Material R-value |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard Roll | 7.0 mm | 1350 mm | 22.25 m | 30.0 m² | 11.0 kg | ~440 mm | R0.14 |
...
> Insulation shall be Aircell Retroshield (reflective) by Aircell, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.
