...
- BAL: not verified.
- Datasheet: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulwhite-au-and-nz/kingspan-aircell-insulwhite-product-datasheet-en-au.pdf (link audited 2026-09-05; exact product TDS may still be pending).
...
> Insulation shall be Aircell Insulwhite (reflective) by Aircell, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://xamyxyg7fn.filerobot.com/kingspan/kil/products/air-cell-insulwhite-au-and-nz/kingspan-aircell-insulwhite-product-datasheet-en-au.pdf.
