---
title: "Aircell Biscuits - Reflective Insulation | Aircell"
description: "Kingspan AIR-CELL Spacer Biscuits are manufactured from expanded black polyethylene material and are engineered to achieve and maintain adequate refle"
keywords: "Aircell Biscuits, Aircell reflective, wall insulation, insulation Australia, Aircell Australia"
...
Kingspan AIR-CELL Spacer Biscuits are manufactured from expanded black polyethylene material and are engineered to achieve and maintain adequate reflective air spaces between reflective insulation and adjacent materials. They are slit to allow effortless placement over wall ties, providing strong holding power with no long-term deterioration. Adhesive backed for ease of installation onto foil facings, they can be re-positioned to ensure proper alignment with the wall substrate.

## Key features

- Adhesive backed for ease of use on foil face.
- Can be re-positioned to allow alignment with substrate.
...
1. Confirm wall system type (masonry cavity vs framed cladding).
...
- Maximum continuous service temperature 85°C, intermittent 105°C.
- Avoid contact with sparks, open flame and hot tools.
- Non-load bearing accessory.

## Installation overview

1. In cavity brick walls, lay outer leaf of brickwork with wire wall ties in place.
...
> Insulation shall be Aircell Biscuits (reflective) by Aircell, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.
