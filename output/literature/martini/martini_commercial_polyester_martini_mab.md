...
> Insulation shall be Martini Commercial Polyester / Martini MAB (batt) by Martini, selected to suit the confirmed application and required rating. Exact product, thickness and compliance to be confirmed by the project reviewer against the current manufacturer TDS before ordering.

## Source register

- SRC-01 Manufacturer datasheet: https://martini.com.au/.
- SRC-02 Safety data sheet: https://martini.com.au/.
